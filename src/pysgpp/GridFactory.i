...
%newobject sg::base::Grid::createLinearClenshawCurtisGrid(size_t dim);
...
%newobject sg::base::Grid::createWaveletGrid(size_t dim);
%newobject sg::base::Grid::createWaveletTrapezoidBoundaryGrid(size_t dim);
%newobject sg::base::Grid::createModWaveletGrid(size_t dim);
%newobject sg::base::Grid::createBsplineGrid(size_t dim, size_t degree);
%newobject sg::base::Grid::createBsplineTrapezoidBoundaryGrid(size_t dim, size_t degree);
%newobject sg::base::Grid::createBsplineClenshawCurtisGrid(size_t dim, size_t degree);
...
public:
	...
	static Grid* createWaveletTrapezoidBoundaryGrid(size_t dim);
	static Grid* createModWaveletGrid(size_t dim);
	static Grid* createBsplineGrid(size_t dim, size_t degree);
	static Grid* createBsplineTrapezoidBoundaryGrid(size_t dim, size_t degree);
