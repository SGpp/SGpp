...
OperationMultipleEvalIterativeSPSSEModLinear::OperationMultipleEvalIterativeSPSSEModLinear(sg::base::GridStorage* storage, sg::base::DataMatrixSP* dataset) : sg::base::OperationMultipleEvalVectorizedSP(dataset)
{
...
OperationMultipleEvalIterativeSPSSEModLinear::~OperationMultipleEvalIterativeSPSSEModLinear()
{
	delete myTimer;
}

void OperationMultipleEvalIterativeSPSSEModLinear::rebuildLevelAndIndex()
{
	delete this->level_;
	delete this->index_;
...
double OperationMultipleEvalIterativeSPSSEModLinear::multTransposeVectorized(sg::base::DataVectorSP& source, sg::base::DataVectorSP& result)
{
...
double OperationMultipleEvalIterativeSPSSEModLinear::multVectorized(sg::base::DataVectorSP& alpha, sg::base::DataVectorSP& result)
{
