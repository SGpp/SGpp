...
#ifndef OPERATIONMULTIPLEEVALITERATIVESPAVXMODLINEAR_HPP
#define OPERATIONMULTIPLEEVALITERATIVESPAVXMODLINEAR_HPP
 ...
 */
class OperationMultipleEvalIterativeSPAVXModLinear : public sg::base::OperationMultipleEvalVectorizedSP
{
public:
	/**
	 ...
	 */
	OperationMultipleEvalIterativeSPAVXModLinear(sg::base::GridStorage* storage, sg::base::DataMatrixSP* dataset);

	/**
	 * Destructor
	 */
	virtual ~OperationMultipleEvalIterativeSPAVXModLinear();
...
#endif /* OPERATIONMULTIPLEEVALITERATIVESPAVXMODLINEAR_HPP */
