...
#ifndef OPERATIONMULTIPLEEVALITERATIVESSEMODLINEAR_HPP
#define OPERATIONMULTIPLEEVALITERATIVESSEMODLINEAR_HPP
 ...
 */
class OperationMultipleEvalIterativeSSEModLinear : public sg::base::OperationMultipleEvalVectorized
{
public:
	/**
	 ...
	 * Destructor
	 */
	virtual ~OperationMultipleEvalIterativeSSEModLinear();
...
#endif /* OPERATIONMULTIPLEEVALITERATIVESSEMODLINEAR_HPP */
