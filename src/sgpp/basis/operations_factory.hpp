...
namespace sg
{
  ...
  namespace GridOperationFactory
  {
     ...
     */
    static OperationMultipleEvalVectorized* createOperationMultipleEvalVectorized(Grid& grid, const std::string& VecType, DataMatrix* dataset)
    {
      ...
      if(strcmp(grid.getType(), "linear") == 0)
        {
          if (VecType == "SSE")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSSELinear(grid.getStorage(), dataset);
            }
          else if (VecType == "AVX")
            {
              return new sg::parallel::OperationMultipleEvalIterativeAVXLinear(grid.getStorage(), dataset);
            }
#ifdef USEOCL
          else if (VecType == "OCL")
            {
              return new sg::parallel::OperationMultipleEvalIterativeOCLLinear(grid.getStorage(), dataset);
            }
          else if (VecType == "HYBRID_SSE_OCL")
            {
              return new sg::parallel::OperationMultipleEvalIterativeHybridSSEOCLLinear(grid.getStorage(), dataset);
            }
#endif
#ifdef USEARBB
          else if (VecType == "ArBB")
            {
              return new sg::parallel::OperationMultipleEvalIterativeArBBLinear(grid.getStorage(), dataset);
            }
#endif
          else
            {
      ...
      else if(strcmp(grid.getType(), "modlinear") == 0)
        {
          if (VecType == "SSE")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSSEModLinear(grid.getStorage(), dataset);
            }
          else if (VecType == "AVX")
            {
              return new sg::parallel::OperationMultipleEvalIterativeAVXModLinear(grid.getStorage(), dataset);
            }
#ifdef USEOCL
          else if (VecType == "OCL")
            {
              return new sg::parallel::OperationMultipleEvalIterativeOCLModLinear(grid.getStorage(), dataset);
            }
          else if (VecType == "HYBRID_SSE_OCL")
            {
              return new sg::parallel::OperationMultipleEvalIterativeHybridSSEOCLModLinear(grid.getStorage(), dataset);
            }
#endif
          else
            {
     ...
     */
    static OperationMultipleEvalVectorizedSP* createOperationMultipleEvalVectorizedSP(Grid& grid, const std::string& VecType, DataMatrixSP* dataset)
    {
      if(strcmp(grid.getType(), "linear") == 0)
        {
          if (VecType == "SSE")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSPSSELinear(grid.getStorage(), dataset);
            }
          else if (VecType == "AVX")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSPAVXLinear(grid.getStorage(), dataset);
            }
#ifdef USEOCL
          else if (VecType == "OCL")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSPOCLLinear(grid.getStorage(), dataset);
            }
          else if (VecType == "HYBRID_SSE_OCL")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSPHybridSSEOCLLinear(grid.getStorage(), dataset);
            }
#endif
#ifdef USEARBB
          else if (VecType == "ArBB")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSPArBBLinear(grid.getStorage(), dataset);
            }
#endif
          else
            {
      ...
      else if(strcmp(grid.getType(), "modlinear") == 0)
        {
          if (VecType == "SSE")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSPSSEModLinear(grid.getStorage(), dataset);
            }
          else if (VecType == "AVX")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSPAVXModLinear(grid.getStorage(), dataset);
            }
#ifdef USEOCL
          else if (VecType == "OCL")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSPOCLModLinear(grid.getStorage(), dataset);
            }
          else if (VecType == "HYBRID_SSE_OCL")
            {
              return new sg::parallel::OperationMultipleEvalIterativeSPHybridSSEOCLModLinear(grid.getStorage(), dataset);
            }
#endif
          else
            {
