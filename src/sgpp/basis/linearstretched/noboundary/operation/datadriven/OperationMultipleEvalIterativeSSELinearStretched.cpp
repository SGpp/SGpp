...
OperationMultipleEvalIterativeSSELinearStretched::OperationMultipleEvalIterativeSSELinearStretched(GridStorage* storage, DataMatrix* dataset) : OperationMultipleEvalVectorized(dataset)
{
...
OperationMultipleEvalIterativeSSELinearStretched::~OperationMultipleEvalIterativeSSELinearStretched()
{
	delete myTimer;
}

void OperationMultipleEvalIterativeSSELinearStretched::rebuildLevelAndIndex()
{
	delete this->level_;
	delete this->index_;
...
double OperationMultipleEvalIterativeSSELinearStretched::multTransposeVectorized(DataVector& source, DataVector& result)
{
...
double OperationMultipleEvalIterativeSSELinearStretched::multVectorized(DataVector& alpha, DataVector& result)
{
