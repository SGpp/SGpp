...
OperationMultipleEvalIterativeOCLLinearStretched::OperationMultipleEvalIterativeOCLLinearStretched(GridStorage* storage, DataMatrix* dataset) : OperationMultipleEvalVectorized(dataset)
{
...
OperationMultipleEvalIterativeOCLLinearStretched::~OperationMultipleEvalIterativeOCLLinearStretched()
{
	delete myTimer;
	delete myOCLKernels;
}

void OperationMultipleEvalIterativeOCLLinearStretched::rebuildLevelAndIndex()
{
	delete this->level_;
	delete this->index_;
...
double OperationMultipleEvalIterativeOCLLinearStretched::multTransposeVectorized(DataVector& source, DataVector& result)
{
...
double OperationMultipleEvalIterativeOCLLinearStretched::multVectorized(DataVector& alpha, DataVector& result)
{
