...
#ifndef OPERATIONBITERATIVESPAVXLINEARSTRETCHED_HPP
#define OPERATIONBITERATIVESPAVXLINEARSTRETCHED_HPP
 ...
 */
class OperationMultipleEvalIterativeSPAVXLinearStretched : public OperationMultipleEvalVectorizedSP
{
public:
	/**
	 ...
	 */
	OperationMultipleEvalIterativeSPAVXLinearStretched(GridStorage* storage, DataMatrixSP* dataset);

	/**
	 * Destructor
	 */
	virtual ~OperationMultipleEvalIterativeSPAVXLinearStretched();
...
#endif /* OPERATIONBITERATIVESPAVXLINEARSTRETCHED_HPP */
