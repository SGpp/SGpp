...
OperationMultipleEvalIterativeSPAVXLinearStretched::OperationMultipleEvalIterativeSPAVXLinearStretched(GridStorage* storage, DataMatrixSP* dataset) : OperationMultipleEvalVectorizedSP(dataset)
{
...
OperationMultipleEvalIterativeSPAVXLinearStretched::~OperationMultipleEvalIterativeSPAVXLinearStretched()
{
	delete myTimer;
}

void OperationMultipleEvalIterativeSPAVXLinearStretched::rebuildLevelAndIndex()
{
	delete this->level_;
	delete this->index_;
...
double OperationMultipleEvalIterativeSPAVXLinearStretched::multTransposeVectorized(DataVectorSP& source, DataVectorSP& result)
{
...
double OperationMultipleEvalIterativeSPAVXLinearStretched::multVectorized(DataVectorSP& alpha, DataVectorSP& result)
{
