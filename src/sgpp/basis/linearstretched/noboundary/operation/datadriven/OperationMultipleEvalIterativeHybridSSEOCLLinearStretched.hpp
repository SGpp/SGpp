...
#ifndef OPERATIONMULTIPLEEVALITERATIVEHYBRIDSSEOCLLINEARSTRETCHED_HPP
#define OPERATIONMULTIPLEEVALITERATIVEHYBRIDSSEOCLLINEARSTRETCHED_HPP
 ...
 */
class OperationMultipleEvalIterativeHybridSSEOCLLinearStretched : public OperationMultipleEvalVectorized
{
public:
	/**
	 ...
	 */
	OperationMultipleEvalIterativeHybridSSEOCLLinearStretched(GridStorage* storage, DataMatrix* dataset);

	/**
	 * Destructor
	 */
	virtual ~OperationMultipleEvalIterativeHybridSSEOCLLinearStretched();
...
#endif /* OPERATIONMULTIPLEEVALITERATIVEHYBRIDSSEOCLLinearStretched_HPP */
