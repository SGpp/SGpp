...
#ifndef OPERATIONMULTIPLEEVALITERATIVESPARBBLINEARSTRETCHED_HPP
#define OPERATIONMULTIPLEEVALITERATIVESPARBBLINEARSTRETCHED_HPP

#include "operation/datadriven/OperationMultipleEvalVectorizedSP.hpp"
#include "basis/linearstretched/noboundary/operation/datadriven/ArBBKernels.hpp"
 ...
 */
class OperationMultipleEvalIterativeSPArBBLinearStretched : public OperationMultipleEvalVectorizedSP
{
public:
	/**
	 * Construtor of OperationBLinearStretchedSP
	 *
	 ...
	 */
	OperationMultipleEvalIterativeSPArBBLinearStretched(GridStorage* storage, DataMatrixSP* dataset);

	/**
	 * Destructor
	 */
	virtual ~OperationMultipleEvalIterativeSPArBBLinearStretched();
...
#endif /* OPERATIONMULTIPLEEVALITERATIVESPARBBLINEARSTRETCHED_HPP */
