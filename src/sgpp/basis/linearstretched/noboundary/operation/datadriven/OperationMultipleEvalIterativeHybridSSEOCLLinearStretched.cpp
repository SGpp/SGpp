...
OperationMultipleEvalIterativeHybridSSEOCLLinearStretched::OperationMultipleEvalIterativeHybridSSEOCLLinearStretched(GridStorage* storage, DataMatrix* dataset) : OperationMultipleEvalVectorized(dataset)
{
...
OperationMultipleEvalIterativeHybridSSEOCLLinearStretched::~OperationMultipleEvalIterativeHybridSSEOCLLinearStretched()
{
	delete myTimer;
	delete myOCLKernels;
}

void OperationMultipleEvalIterativeHybridSSEOCLLinearStretched::rebuildLevelAndIndex()
{
	delete this->level_;
	delete this->index_;
...
double OperationMultipleEvalIterativeHybridSSEOCLLinearStretched::multTransposeVectorized(DataVector& source, DataVector& result)
{
...
double OperationMultipleEvalIterativeHybridSSEOCLLinearStretched::multVectorized(DataVector& alpha, DataVector& result)
{
