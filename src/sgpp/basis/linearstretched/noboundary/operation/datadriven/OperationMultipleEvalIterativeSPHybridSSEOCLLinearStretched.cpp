...
OperationMultipleEvalIterativeSPHybridSSEOCLLinearStretched::OperationMultipleEvalIterativeSPHybridSSEOCLLinearStretched(GridStorage* storage, DataMatrixSP* dataset) : OperationMultipleEvalVectorizedSP(dataset)
{
...
OperationMultipleEvalIterativeSPHybridSSEOCLLinearStretched::~OperationMultipleEvalIterativeSPHybridSSEOCLLinearStretched()
{
	delete myTimer;
	delete myOCLKernels;
}

void OperationMultipleEvalIterativeSPHybridSSEOCLLinearStretched::rebuildLevelAndIndex()
{
	delete this->level_;
	delete this->index_;
...
double OperationMultipleEvalIterativeSPHybridSSEOCLLinearStretched::multTransposeVectorized(DataVectorSP& source, DataVectorSP& result)
{
...
double OperationMultipleEvalIterativeSPHybridSSEOCLLinearStretched::multVectorized(DataVectorSP& alpha, DataVectorSP& result)
{
