...
OperationMultipleEvalIterativeSPOCLLinearStretched::OperationMultipleEvalIterativeSPOCLLinearStretched(GridStorage* storage, DataMatrixSP* dataset) : OperationMultipleEvalVectorizedSP(dataset)
{
...
OperationMultipleEvalIterativeSPOCLLinearStretched::~OperationMultipleEvalIterativeSPOCLLinearStretched()
{
	delete myTimer;
	delete myOCLKernels;
}

void OperationMultipleEvalIterativeSPOCLLinearStretched::rebuildLevelAndIndex()
{
	delete this->level_;
	delete this->index_;
...
double OperationMultipleEvalIterativeSPOCLLinearStretched::multTransposeVectorized(DataVectorSP& source, DataVectorSP& result)
{
...
double OperationMultipleEvalIterativeSPOCLLinearStretched::multVectorized(DataVectorSP& alpha, DataVectorSP& result)
{
