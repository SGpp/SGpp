...
OperationMultipleEvalIterativeAVXLinearStretched::OperationMultipleEvalIterativeAVXLinearStretched(GridStorage* storage, DataMatrix* dataset) : OperationMultipleEvalVectorized(dataset)
{
...
OperationMultipleEvalIterativeAVXLinearStretched::~OperationMultipleEvalIterativeAVXLinearStretched()
{
	delete myTimer;
}

void OperationMultipleEvalIterativeAVXLinearStretched::rebuildLevelAndIndex()
{
	delete this->level_;
	delete this->index_;
...
double OperationMultipleEvalIterativeAVXLinearStretched::multTransposeVectorized(DataVector& source, DataVector& result)
{
...
double OperationMultipleEvalIterativeAVXLinearStretched::multVectorized(DataVector& alpha, DataVector& result)
{
