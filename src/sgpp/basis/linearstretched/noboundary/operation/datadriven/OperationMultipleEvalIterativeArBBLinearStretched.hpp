...
#ifndef OPERATIONMULTIPLEEVALITERATIVEARBBLINEARSTRETCHED_HPP
#define OPERATIONMULTIPLEEVALITERATIVEARBBLINEARSTRETCHED_HPP
 ...
 */
class OperationMultipleEvalIterativeArBBLinearStretched : public OperationMultipleEvalVectorized
{
public:
	/**
	 ...
	 */
	OperationMultipleEvalIterativeArBBLinearStretched(GridStorage* storage, DataMatrix* dataset);

	/**
	 * Destructor
	 */
	virtual ~OperationMultipleEvalIterativeArBBLinearStretched();
...
#endif /* OPERATIONMULTIPLEEVALITERATIVEARBBLinearStretched_HPP */
