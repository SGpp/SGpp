...
#ifndef OPERATIONMULTIPLEEVALITERATIVESPHYBRIDSSEOCLLINEARSTRETCHED_HPP
#define OPERATIONMULTIPLEEVALITERATIVESPHYBRIDSSEOCLLINEARSTRETCHED_HPP
 ...
 */
class OperationMultipleEvalIterativeSPHybridSSEOCLLinearStretched : public OperationMultipleEvalVectorizedSP
{
public:
	/**
	 ...
	 */
	OperationMultipleEvalIterativeSPHybridSSEOCLLinearStretched(GridStorage* storage, DataMatrixSP* dataset);

	/**
	 * Destructor
	 */
	virtual ~OperationMultipleEvalIterativeSPHybridSSEOCLLinearStretched();
...
#endif /* OPERATIONMULTIPLEEVALITERATIVESPHYBRIDSSEOCLLINEARSTRETCHED_HPP */
