...
#ifndef OPERATIONMULTIPLEEVALITERATIVEOCLLINEARSTRETCHED_HPP
#define OPERATIONMULTIPLEEVALITERATIVEOCLLINEARSTRETCHED_HPP
 ...
 */
class OperationMultipleEvalIterativeOCLLinearStretched : public OperationMultipleEvalVectorized
{
public:
	/**
	 ...
	 */
	OperationMultipleEvalIterativeOCLLinearStretched(GridStorage* storage, DataMatrix* dataset);

	/**
	 * Destructor
	 */
	virtual ~OperationMultipleEvalIterativeOCLLinearStretched();
...
#endif /* OPERATIONMULTIPLEEVALITERATIVEOCLLinearStretched_HPP */
