...
OperationMultipleEvalIterativeArBBLinearStretched::OperationMultipleEvalIterativeArBBLinearStretched(GridStorage* storage, DataMatrix* dataset) : OperationMultipleEvalVectorized(dataset)
{
...
OperationMultipleEvalIterativeArBBLinearStretched::~OperationMultipleEvalIterativeArBBLinearStretched()
{
	delete myTimer;
	delete myArBBKernels;
}

void OperationMultipleEvalIterativeArBBLinearStretched::rebuildLevelAndIndex()
{
	delete this->level_;
	delete this->index_;
...
double OperationMultipleEvalIterativeArBBLinearStretched::multVectorized(DataVector& alpha, DataVector& result)
{
...
double OperationMultipleEvalIterativeArBBLinearStretched::multTransposeVectorized(DataVector& source, DataVector& result)
{
