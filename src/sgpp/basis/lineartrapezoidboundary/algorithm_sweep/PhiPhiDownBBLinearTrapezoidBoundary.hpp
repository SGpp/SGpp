...
#ifndef PHIPHIDOWNBBLINEARTRAPEZOIDBOUNDARY_HPP
#define PHIPHIDOWNBBLINEARTRAPEZOIDBOUNDARY_HPP
 ...
 */
class PhiPhiDownBBLinearTrapezoidBoundary
{
protected:
...
public:
	 ...
	 */
	PhiPhiDownBBLinearTrapezoidBoundary(GridStorage* storage) : storage(storage), boundingBox(storage->getBoundingBox()), q(1.0), t(0.0)
	{
	}
	 ...
	 * Destructor
	 */
	~PhiPhiDownBBLinearTrapezoidBoundary()
	{
	}
...
#endif /* PHIPHIDOWNBBLINEARTRAPEZOIDBOUNDARY_HPP */
