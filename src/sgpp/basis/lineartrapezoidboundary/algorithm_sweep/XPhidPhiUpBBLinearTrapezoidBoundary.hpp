...
#ifndef XPHIDPHIUPBBLINEARTRAPEZOIDBOUNDARY_HPP
#define XPHIDPHIUPBBLINEARTRAPEZOIDBOUNDARY_HPP
 ...
 */
class XPhidPhiUpBBLinearTrapezoidBoundary
{
protected:
...
public:
	 ...
	 */
	XPhidPhiUpBBLinearTrapezoidBoundary(GridStorage* storage) : storage(storage), boundingBox(storage->getBoundingBox()), q(1.0), t(0.0)
	{
	}
	 ...
	 * Destructor
	 */
	~XPhidPhiUpBBLinearTrapezoidBoundary()
	{
	}
...
#endif /* XPHIDPHIUPBBLINEARTRAPEZOIDBOUNDARY_HPP */
