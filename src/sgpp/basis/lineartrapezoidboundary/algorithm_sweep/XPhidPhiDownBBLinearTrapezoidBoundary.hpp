...
#ifndef XPHIDPHIDOWNBBLINEARTRAPEZOIDBOUNDARY_HPP
#define XPHIDPHIDOWNBBLINEARTRAPEZOIDBOUNDARY_HPP
 ...
 */
class XPhidPhiDownBBLinearTrapezoidBoundary
{
protected:
...
public:
	 ...
	 */
	XPhidPhiDownBBLinearTrapezoidBoundary(GridStorage* storage) : storage(storage), boundingBox(storage->getBoundingBox()), q(1.0), t(0.0)
	{
	}
	 ...
	 * Destructor
	 */
	~XPhidPhiDownBBLinearTrapezoidBoundary()
	{
	}
...
#endif /* XPHIDPHIDOWNBBLINEARTRAPEZOIDBOUNDARY_HPP */
