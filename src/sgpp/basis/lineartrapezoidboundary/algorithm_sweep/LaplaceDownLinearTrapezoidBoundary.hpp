...
#ifndef LAPLACEDOWNLINEARTRAPEZOIDBOUNDARY_HPP
#define LAPLACEDOWNLINEARTRAPEZOIDBOUNDARY_HPP
 ...
 */
class LaplaceDownLinearTrapezoidBoundary
{
protected:
...
public:
	 ...
	 */
	LaplaceDownLinearTrapezoidBoundary(GridStorage* storage) : storage(storage)
	{
	}
	 ...
	 * Destructor
	 */
	~LaplaceDownLinearTrapezoidBoundary()
	{
	}
...
#endif /* LAPLACEDOWNLINEARTRAPEZOIDBOUNDARY_HPP */
