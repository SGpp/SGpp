...
#ifndef PHIPHIUPBBLINEARTRAPEZOIDBOUNDARY_HPP
#define PHIPHIUPBBLINEARTRAPEZOIDBOUNDARY_HPP
 ...
 */
class PhiPhiUpBBLinearTrapezoidBoundary
{
protected:
...
public:
	 ...
	 */
	PhiPhiUpBBLinearTrapezoidBoundary(GridStorage* storage) : storage(storage), boundingBox(storage->getBoundingBox()), q(1.0), t(0.0)
	{
	}
	 ...
	 * Destructor
	 */
	~PhiPhiUpBBLinearTrapezoidBoundary()
	{
	}
...
#endif /* PHIPHIUPBBLINEARTRAPEZOIDBOUNDARY_HPP */
