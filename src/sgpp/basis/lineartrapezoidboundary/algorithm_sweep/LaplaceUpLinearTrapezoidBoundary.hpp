...
#ifndef LAPLACEUPLINEARTRAPEZOIDBOUNDARY_HPP
#define LAPLACEUPLINEARTRAPEZOIDBOUNDARY_HPP
 ...
 */
class LaplaceUpLinearTrapezoidBoundary
{
protected:
...
public:
	 ...
	 */
	LaplaceUpLinearTrapezoidBoundary(GridStorage* storage) : storage(storage)
	{
	}
	 ...
	 * Destructor
	 */
	~LaplaceUpLinearTrapezoidBoundary()
	{
	}
...
#endif /* LAPLACEUPLINEARTRAPEZOIDBOUNDARY_HPP */
