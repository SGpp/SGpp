...
#ifndef OPERATIONTESTLINEARTRAPEZOIDBOUNDARY_HPP
#define OPERATIONTESTLINEARTRAPEZOIDBOUNDARY_HPP
 ...
 * @version $HEAD$
 */
class OperationTestLinearTrapezoidBoundary : public OperationTest
{
public:
	/**
	 * Constructor
	 ...
	 */
	OperationTestLinearTrapezoidBoundary(GridStorage* storage) : storage(storage) {}
...
#endif /* OPERATIONTESTLINEARTRAPEZOIDBOUNDARY_HPP */
