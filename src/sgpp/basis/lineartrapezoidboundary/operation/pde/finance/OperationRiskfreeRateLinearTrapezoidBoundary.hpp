...
#ifndef OPERATIONRISKFREERATELINEARTRAPEZOIDBOUNDARY_HPP
#define OPERATIONRISKFREERATELINEARTRAPEZOIDBOUNDARY_HPP
...
public:
	 ...
	 */
	OperationRiskfreeRateLinearTrapezoidBoundary(GridStorage* storage);

	/**
	 * Destructor
	 */
	virtual ~OperationRiskfreeRateLinearTrapezoidBoundary();
...
#endif /* OPERATIONRISKFREERATELINEARTRAPEZOIDBOUNDARY_HPP */
