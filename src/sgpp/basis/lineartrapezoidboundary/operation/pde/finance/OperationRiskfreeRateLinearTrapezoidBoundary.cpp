...
OperationRiskfreeRateLinearTrapezoidBoundary::OperationRiskfreeRateLinearTrapezoidBoundary(GridStorage* storage)
{
	this->storage = storage;
}

OperationRiskfreeRateLinearTrapezoidBoundary::~OperationRiskfreeRateLinearTrapezoidBoundary()
{
}
