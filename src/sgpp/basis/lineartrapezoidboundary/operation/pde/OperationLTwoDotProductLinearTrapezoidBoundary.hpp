...
#ifndef OPERATIONLTWODOTPRODUCTLINEARTRAPEZOIDBOUNDARY_HPP
#define OPERATIONLTWODOTPRODUCTLINEARTRAPEZOIDBOUNDARY_HPP
...
public:
	 ...
	 */
	OperationLTwoDotProductLinearTrapezoidBoundary(GridStorage* storage);

	/**
	 * Destructor
	 */
	virtual ~OperationLTwoDotProductLinearTrapezoidBoundary();
...
#endif /* OPERATIONLTWODOTPRODUCTLINEARTRAPEZOIDBOUNDARY_HPP */
