...
#ifndef LAPLACEDOWNLINEARBOUNDARY_HPP
#define LAPLACEDOWNLINEARBOUNDARY_HPP
 ...
 */
class LaplaceDownLinearBoundary
{
protected:
...
public:
	 ...
	 * Constructor
	 *
	 * @param storage the gird's GrisStorage object
	 */
	LaplaceDownLinearBoundary(GridStorage* storage) : storage(storage)
	{
	}
...
#endif /* LAPLACEDOWNLINEARBOUNDARY_HPP */
