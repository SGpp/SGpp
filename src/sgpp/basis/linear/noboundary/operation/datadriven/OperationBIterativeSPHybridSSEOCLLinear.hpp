...
#ifndef OPERATIONBITERATIVESPHYBRIDSSEOCLLINEAR_HPP
#define OPERATIONBITERATIVESPHYBRIDSSEOCLLINEAR_HPP
 ...
 */
class OperationBIterativeSPHybridSSEOCLLinear : public OperationBVectorizedSP
{
public:
	/**
	 ...
	 */
	OperationBIterativeSPHybridSSEOCLLinear(GridStorage* storage);

	/**
	 * Destructor
	 */
	virtual ~OperationBIterativeSPHybridSSEOCLLinear();
...
#endif /* OPERATIONBITERATIVESPHYBRIDSSEOCLLINEAR_HPP */
