...
#ifndef OPERATIONBITERATIVESSELINEAR_HPP
#define OPERATIONBITERATIVESSELINEAR_HPP
 ...
 */
class OperationBIterativeSSELinear : public OperationBVectorized
{
public:
	/**
	 ...
	 */
	OperationBIterativeSSELinear(GridStorage* storage);

	/**
	 * Destructor
	 */
	virtual ~OperationBIterativeSSELinear();
...
#endif /* OPERATIONBITERATIVESSELINEAR_HPP */
