...
#ifndef OPERATIONBITERATIVESPOCLLINEAR_HPP
 ...
 */
class OperationBIterativeSPOCLLinear : public OperationBVectorizedSP
{
public:
	/**
	 ...
	 */
	OperationBIterativeSPOCLLinear(GridStorage* storage);

	/**
	 * Destructor
	 */
	virtual ~OperationBIterativeSPOCLLinear();
...
#endif /* OPERATIONBITERATIVESPOCLLINEAR_HPP */
