 ...
 */
class OperationBIterativeSPAVXLinear : public OperationBVectorizedSP
{
public:
	/**
	 ...
	 */
	OperationBIterativeSPAVXLinear(GridStorage* storage);

	/**
	 * Destructor
	 */
	virtual ~OperationBIterativeSPAVXLinear();
