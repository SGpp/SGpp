...
#ifndef OPERATIONBITERATIVEHYBRIDSSEOCLLINEAR_HPP
#define OPERATIONBITERATIVEHYBRIDSSEOCLLINEAR_HPP
 ...
 */
class OperationBIterativeHybridSSEOCLLinear : public OperationBVectorized
{
public:
	/**
	 ...
	 */
	OperationBIterativeHybridSSEOCLLinear(GridStorage* storage);

	/**
	 * Destructor
	 */
	virtual ~OperationBIterativeHybridSSEOCLLinear();
...
#endif /* OPERATIONBITERATIVEHYBRIDSSEOCLLINEAR_HPP */
