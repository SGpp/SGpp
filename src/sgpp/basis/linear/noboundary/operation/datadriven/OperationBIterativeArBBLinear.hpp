...
#ifndef OPERATIONBITERATIVEARBBLINEAR_HPP
#define OPERATIONBITERATIVEARBBLINEAR_HPP
 ...
 */
class OperationBIterativeArBBLinear : public OperationBVectorized
{
public:
	/**
	 ...
	 */
	OperationBIterativeArBBLinear(GridStorage* storage);

	/**
	 * Destructor
	 */
	virtual ~OperationBIterativeArBBLinear();
...
#endif /* OPERATIONBITERATIVEARBBLINEAR_HPP */
