 ...
 */
class DPhidPhiDownBBLinearBoundary : public DPhidPhiDownBBLinear
{
public:
	/**
	 * Constructor
	 ...
	 */
	DPhidPhiDownBBLinearBoundary(GridStorage* storage) : DPhidPhiDownBBLinear(storage)
	{
	}
	 ...
	 * Destructor
	 */
	virtual ~DPhidPhiDownBBLinearBoundary()
	{
	}
