...
protected:
	...
	/// Eigenvectors of rho matrix
	sg::base::DataMatrix* eve_rhos;
	/// Eigenvalues of the rho matrix
	sg::base::DataVector* eva_rhos;
...
public:
	 ...
	 */
	BlackScholesPATParabolicPDESolverSystem(sg::base::Grid& SparseGrid, sg::base::DataVector& alpha, sg::base::DataVector& mu, sg::base::DataVector& sigma,
