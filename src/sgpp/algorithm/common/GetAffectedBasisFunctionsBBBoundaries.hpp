...
#ifndef GETAFFECTEDBASISFUNCTIONSBBBOUNDARIES_HPP
#define GETAFFECTEDBASISFUNCTIONSBBBOUNDARIES_HPP
 ...
 *
 * This version supports bounding boxes
 *
 * @todo (heinecke, nice) add graphical description
 */
template<class BASIS>
class GetAffectedBasisFunctionsBBBoundaries
{
public:
	GetAffectedBasisFunctionsBBBoundaries(GridStorage* storage) : storage(storage), BB(storage->getBoundingBox())
	{
	}

	~GetAffectedBasisFunctionsBBBoundaries() {}
...
#endif /* GETAFFECTEDBASISFUNCTIONSBBBOUNDARIES_HPP */
