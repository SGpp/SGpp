...
#include "combigrid/combigrid/CombiCombiGridKernel.hpp"
...
public:
    ...
    static void test1(){
    	...
    	levels[0] = 2; levels[1] = 6; levels[2] = 5;
    	std::vector<bool> hasBdrPoints(3,true);

    	std::vector<int> levels1(3,6);
    	levels1[0] = 4; levels1[1] = 6; levels1[2] = 5;
    ...
    static void test2(){
    	...
    	std::vector<int> levels1(3,6);
    	levels1[0] = 2; levels1[1] = 7; levels1[2] = 8;
    	std::vector<bool> hasBdrPoints1(3,false);

    	std::vector<int> levels2(3,6);
    	levels2[0] = 2; levels2[1] = 8; levels2[2] = 3;
