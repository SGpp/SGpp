...
public:
    ...
    static void test1(){
    	...
    	std::vector<int> minlevels(2); minlevels[0]=4; minlevels[1]=4;
    	std::vector<int> maxlevels(2); maxlevels[0]=6; maxlevels[1]=6;
    	...
    	std::vector<double> min(2); min[0] = -2; min[1] = 2;
    	std::vector<double> max(2); max[0] = 2;  max[1] = 5;
    	std::vector<int> levels(2,6);
    	double funcVal = 0.0 , gridVal = 0.0;

    	AbstractStretchingMaker* stretchingMaker = new AtanSpecialStretching(); //new UniformStretching(); //new AtanSpecialStretching();
    	...
    	coords[0] = min[0] + (max[0]-min[0])*1.0/3.0; coords[1] = min[1] + (max[1]-min[1])*1.0/3.0;
    	coords_tmp = coords; funcVal = testfunction2D( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.4001; coords[1] = min[1] + (max[1]-min[1])*1.0/3.0;
    	coords_tmp = coords; funcVal = testfunction2D( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*1.0/3.0; coords[1] = min[1] + (max[1]-min[1])*0.6001;
    	coords_tmp = coords; funcVal = testfunction2D( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.61001; coords[1] = min[1] + (max[1]-min[1])*0.72001;
    	coords_tmp = coords; funcVal = testfunction2D( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.730; coords[1] = min[1] + (max[1]-min[1])*0.67;
    	coords_tmp = coords; funcVal = testfunction2D( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.4999; coords[1] = min[1] + (max[1]-min[1])*0.495;
    	coords_tmp = coords; funcVal = testfunction2D( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.5999; coords[1] = min[1] + (max[1]-min[1])*0.7201;
    	coords_tmp = coords; funcVal = testfunction2D( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    ...
    static void test12(){
    	...
    	std::vector<double> min(2); min[0] = -4; min[1] = 3;
    	std::vector<double> max(2); max[0] = -2; max[1] = 5;
    	...
    	coords[0] = min[0] + (max[0]-min[0])*1.0/3.0; coords[1] = min[1] + (max[1]-min[1])*1.0/3.0;
    	coords_tmp = coords; funcVal = testfunction2D1( coords[0] , coords[1] );
    	...
    	coords[0] = min[0] + (max[0]-min[0])*0.1001; coords[1] = min[1] + (max[1]-min[1])*1.0/3.0;
    	coords_tmp = coords; funcVal = testfunction2D1( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal  , 1e-4 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(gridVal , funcVal  , 1e-4 , "" ); coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.9001; coords[1] = min[1] + (max[1]-min[1])*2.0/3.0;
    	coords_tmp = coords; funcVal = testfunction2D1( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal  , 1e-4 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(gridVal , funcVal  , 1e-4 , "" ); coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.0001; coords[1] = min[1] + (max[1]-min[1])*1.0/3.0;
    	coords_tmp = coords; funcVal = testfunction2D1( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal  , 1e-4 , "" );coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*1.0/3.0; coords[1] = min[1] + (max[1]-min[1])*0.0001;
    	coords_tmp = coords; funcVal = testfunction2D1( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal  , 1e-4 , "" );coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.00001; coords[1] = min[1] + (max[1]-min[1])*0.00001;
    	coords_tmp = coords; funcVal = testfunction2D1( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal  , 1e-4 , "" );coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*1.0; coords[1] = min[1] + (max[1]-min[1])*1.0;
    	coords_tmp = coords; funcVal = testfunction2D1( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal  , 1e-4 , "" );coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.999; coords[1] = min[1] + (max[1]-min[1])*0.95;
    	coords_tmp = coords; funcVal = testfunction2D1( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal  , 1e-4 , "" );coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.999; coords[1] = min[1] + (max[1]-min[1])*0.001;
    	coords_tmp = coords; funcVal = testfunction2D1( coords[0] , coords[1] );
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal  , 1e-4 , "" );coords_tmp = coords;
    ...
    static void test2(){
    	...
    	std::vector<double> min(3); min[0] = -1; min[1] = 0.1; min[2] = -0.3;
    	std::vector<double> max(3); max[0] = 0.1; max[1] = 0.3; max[2] = 0.8;
    	std::vector<int> levels_d(3,7);
    	double funcVal = 0.0 , gridVal = 0.0;
    	AbstractStretchingMaker* stretchingMaker = new TanStretching(0.3); //new UniformStretching(); //new TanStretching(0.7);
    	GridDomain* domain = new GridDomain( 3 , levels_d , min , max , (*stretchingMaker) );
    	...
    	coords[0] = min[0] + (max[0]-min[0])*1.0/3.0; coords[1] = min[1] + (max[1]-min[1])*1.0/3.0; coords[2] = min[2] + (max[2]-min[2])*1.0/3.0;
    	coords_tmp = coords; funcVal = testfunction3D( coords[0] , coords[1] , coords[2]);
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(  gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(  gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.1001; coords[1] = min[1] + (max[1]-min[1])*1.0/3.0; coords[2] = min[2] + (max[2]-min[2])*1.1/3.0;
    	coords_tmp = coords; funcVal = testfunction3D( coords[0] , coords[1] , coords[2]);
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(  gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(  gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*1.1/3.0; coords[1] = min[1] + (max[1]-min[1])*0.2301; coords[2] = min[2] + (max[2]-min[2])*0.3001;
    	coords_tmp = coords; funcVal = testfunction3D( coords[0] , coords[1] , coords[2]);
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(  gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(  gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	...
    	coords[0] = min[0] + (max[0]-min[0])*0.0; coords[1] = min[1] + (max[1]-min[1])*0.0; coords[2] = min[2] + (max[2]-min[2])*0.0;
    	coords_tmp = coords; funcVal = testfunction3D( coords[0] , coords[1] , coords[2]);
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(  gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(  gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	...
    	coords[0] = min[0] + (max[0]-min[0])*0.999; coords[1] = min[1] + (max[1]-min[1])*0.001; coords[2] = min[2] + (max[2]-min[2])*0.999;
    	coords_tmp = coords; funcVal = testfunction3D( coords[0] , coords[1] , coords[2]);
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(  gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL(  gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
    ...
    static void test21(){
    	...
    	std::vector<double> min(3); min[0] = 0.1; min[1] = 0.3; min[2] = -0.9;
    	std::vector<double> max(3); max[0] = 1.3; max[1] = 1.1; max[2] = -0.1;
    	std::vector<int> levels_d(3,9);
    	double funcVal = 0.0 , gridVal = 0.0;
    	AbstractStretchingMaker* stretchingMaker = new TanStretching(0.7); //new UniformStretching();
    	GridDomain* domain = new GridDomain( 3 , levels_d , min , max , (*stretchingMaker) );
    	...
    	coords[0] = min[0] + (max[0]-min[0])*1.0/3.0; coords[1] = min[1] + (max[1]-min[1])*2.0/3.0; coords[2] = min[2] + (max[2]-min[2])*1.6/3.0;
    	coords_tmp = coords; funcVal = testfunction3D1( coords[0] , coords[1] , coords[2]);
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-4 , "" );coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-4 , "" );coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*0.1001; coords[1] = min[1] + (max[1]-min[1])*1.0/3.0; coords[2] = min[2] + (max[2]-min[2])*1.0/3.0;
    	coords_tmp = coords; funcVal = testfunction3D1( coords[0] , coords[1] , coords[2]);
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-4 , "" );coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-4 , "" );coords_tmp = coords;

    	coords[0] = min[0] + (max[0]-min[0])*1.0/3.0; coords[1] = min[1] + (max[1]-min[1])*0.2101; coords[2] = min[2] + (max[2]-min[2])*0.2301;
    	coords_tmp = coords; funcVal = testfunction3D1( coords[0] , coords[1] , coords[2]);
    	gridVal = combigrid->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-4 , "" );coords_tmp = coords;
    	gridVal = combigrid1->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-4 , "" );coords_tmp = coords;
