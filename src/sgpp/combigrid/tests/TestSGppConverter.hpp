...
public:
    ...
    static void test1(){
    	...
    	alphas = new DataVector(gridstorageSGpp->size());
    	minAlpha = new DataVector(gridstorageSGpp->size());
    	maxAlpha = new DataVector(gridstorageSGpp->size());
    	...
    	maxMax = (*maxAlpha)[0]; minMin = (*minAlpha)[0]; minA = maxA = (*alphas)[0];
    	...
    	coords[0] = 1.0/3.0; coords[1] = 1.0/3.0;
    	COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) , testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
    	coords[0] = 0.0001; coords[1] = 1.0/3.0;
    	COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) , testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
    	coords[0] = 1.0/3.0; coords[1] = 0.0001;
    	COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) , testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
    	coords[0] = 0.00001; coords[1] = 0.00001;
    	COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) , testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
    	coords[0] = 1.0; coords[1] = 1.0;
    	COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) , testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
    	coords[0] = 0.999; coords[1] = 0.95;
    	COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) , testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
    	coords[0] = 0.999; coords[1] = 0.001;
    	COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) , testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
    ...
    static void test22(){
    	...
    	std::vector<int> levels( 3 , 9);
    	std::vector<int> levels_trunc( 3 , 3);
    	levels[0] = 8; levels[1] = 6; levels[2] = 8;
    	levels_trunc[0] = 1; levels_trunc[1] = 3; levels_trunc[2] = 1;
    	CombiSchemeBasis* combischeme = new S_CT( 3 , levels , levels_trunc );
