	...
	TestStretching(){;}
	   ...
	   static void test_all_cases() {
	    ...
	    static void test1(){
	    	...
	    	std::vector<double> min(2); min[0] = -1; min[1] = 2;
	    	std::vector<double> max(2); max[0] = 1;  max[1] = 3;
	    	std::vector<int> levels(2); levels[0] = 6; levels[1] = 7;
	    	...
	    	gridVal = fg->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
	    	gridVal = fg_wg->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
	    ...
	    static void test12(){
	    	...
	    	std::vector<double> min(2); min[0] = -3; min[1] = 2;
	    	std::vector<double> max(2); max[0] = 1;  max[1] = 4;
	    	std::vector<int> levels(2); levels[0] = 6; levels[1] = 7;
	    	double funcVal = 0.0 , gridVal = 0.0;
	    ...
	    static void test13(){
	    	...
	    	std::vector<double> min(2); min[0] = -2; min[1] = 1;
	    	std::vector<double> max(2); max[0] = 1;  max[1] = 3;
	    	std::vector<int> levels(2); levels[0] = 8; levels[1] = 7;
	    	double funcVal = 0.0 , gridVal = 0.0;
	    ...
	    static void test2(){
	    	...
	    	std::vector<double> min(3); min[0] = -1; min[1] = 3; min[2] = -2;
	    	std::vector<double> max(3); max[0] = 2; max[1] = 5; max[2] = 2;
	    	std::vector<int> levels(3,9);
	    	levels[0] = 7; levels[1] = 8; levels[2] = 9;
	    	double funcVal = 0.0 , gridVal = 0.0;
	    	...
	    	levels[1] = 7; levels[1] = 4; levels[2] = 7; hasBdrPoints[1] = false;
	    	FullGrid<double>* fg = new FullGrid<double>( 3 , levels , hasBdrPoints );
	    	levels[1] = 3; levels[1] = 6; levels[2] = 8;
	    	hasBdrPoints[0] = false; hasBdrPoints[1] = false; hasBdrPoints[2] = false;
	    	...
	    	coords[0] = min[0] + (max[0]-min[0])*0.0001; coords[1] = min[1] + (max[1]-min[1])*1.0/3.0; coords[2] = min[2] + (max[2]-min[2])*1.0/3.0;
	    	coords_tmp = coords; funcVal =  testfunction3D( coords[0] , coords[1] , coords[2] ) ;
	    	gridVal = fg->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
	    	gridVal = fg_wg->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;

	    	coords[0] = min[0] + (max[0]-min[0])*1.0/3.0; coords[1] = min[1] + (max[1]-min[1])*0.0001; coords[2] = min[2] + (max[2]-min[2])*0.0001;
	    	coords_tmp = coords; funcVal =  testfunction3D( coords[0] , coords[1] , coords[2] ) ;
	    	gridVal = fg->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
	    	gridVal = fg_wg->eval(coords_tmp); COMBIGRID_ERROR_TEST_EQUAL( gridVal , funcVal , 1e-10 , "" ); coords_tmp = coords;
