...
void S_CT::init( std::vector< int >& levels , std::vector< double >& ratio_ ,	std::vector< int >& l_user_ ) {
...
void S_CT::getTrapezoidsums(std::vector<int>& v , size_t dim , int sum , std::vector< double >& ratio_ ,	std::vector< int >& l_user_)
{
