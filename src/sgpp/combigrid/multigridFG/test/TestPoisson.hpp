...
public:
    ...
    static void test1(){
    	...
    	std::vector<double> min(1); min[0] = 0.0;
    	std::vector<double> max(1); max[0] = 1.0;
    	std::vector<double> sigma(1); sigma[0] = 1.0;
    	std::vector<int> levels(1); levels[0] = 7;
    	...
    	std::vector<double> coord(1); coord[0] = 0.5;
    ...
    static void test2(){
    	...
    	std::vector<double> coord(2); coord[0] = 1.1001; coord[1] = 1.1001;
    ...
    static void test3(){
    	...
    	std::vector<double> coord(3); coord[0] = 0.5; coord[1] = 0.5; coord[2] = 0.5;
    	double val = fg->eval(coord);
    ...
    static void test4(){
    	...
    	std::vector<double> min(4); min[0] = 0.0; min[1] = 0.0; min[2] = 0.0; min[3] = 0.0;
    	std::vector<double> max(4); max[0] = 1.0; max[1] = 1.0; max[2] = 1.0; max[3] = 1.0;
    	std::vector<double> sigma(4); sigma[0] = 1.0; sigma[1] = 1.0;  sigma[2] = 1.0; sigma[3] = 1.0;
    	std::vector<int> levels(4); levels[0] = 3; levels[1] = 3; levels[2] = 4; levels[3] = 3;
    	std::vector<int> levelsDom(4); levelsDom[0] = 7; levelsDom[1] = 7; levelsDom[2] = 7; levelsDom[3] = 7;
    	...
    	std::vector<double> coord(4); coord[0] = 0.5; coord[1] = 0.5; coord[2] = 0.5; coord[3] = 0.5;
    	double val = fg->eval(coord);
