...
public:
    ...
    static void test2_cross() {
       	std::vector<double> min(2); min[0] = 0.6; min[1] = 0.6;
        std::vector<double> max(2); max[0] = 1.4; max[1] = 1.4;
        std::vector<int> levels(2); levels[0] = 3; levels[1] = 4;
        int dim , nrPoints;
        double lambda;
    ...
    static void test2_cross_CG() {
       	std::vector<double> min(2); min[0] = 0.6; min[1] = 0.6;
        std::vector<double> max(2); max[0] = 1.4; max[1] = 1.4;
    	std::vector<int> minlevels(2); minlevels[0]=2; minlevels[1]=2;
    	std::vector<int> maxlevels(2); maxlevels[0]=4; maxlevels[1]=4;
        int dim , nrPoints;
        double lambda;
    ...
    static void test3(){
    	...
    	std::vector<double> min(3); min[0] = 0.9; min[1] = 0.9; min[2] = 0.9;
    	std::vector<double> max(3); max[0] = 1.1; max[1] = 1.1; max[2] = 1.1;
    	std::vector<int> levels(3); levels[0] = 2; levels[1] = 4; levels[2] = 3;
    	...
    	double tmp;
    	// test the unkowns
    	tmp = fg->eval( globalC1 ); COMBIGRID_ERROR_TEST_EQUAL( tmp , 3.0 , 1e-6 , "" );
    	tmp = fg->eval( globalC2 ); COMBIGRID_ERROR_TEST_EQUAL( tmp , 2.91 , 1e-6 , "" );
    ...
    static void test31(){
    	...
    	double tmp;
    	// test the unkowns
    	tmp = fg->eval( globalC1 ); COMBIGRID_ERROR_TEST_EQUAL( tmp , 0.1 , 1e-1 , "" );
