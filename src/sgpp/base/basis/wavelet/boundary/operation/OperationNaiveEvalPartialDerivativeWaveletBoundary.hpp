...
#ifndef SGPP_BASE_BASIS_WAVELETBOUNDARY_NOBOUNDARY_OPERATION_OPERATIONNAIVEEVALPARTIALDERIVATIVEWAVELETBOUNDARY_HPP
#define SGPP_BASE_BASIS_WAVELETBOUNDARY_NOBOUNDARY_OPERATION_OPERATIONNAIVEEVALPARTIALDERIVATIVEWAVELETBOUNDARY_HPP
