...
#ifndef SGPP_BASE_BASIS_WAVELET_NOBOUNDARY_OPERATION_OPERATIONNAIVEEVALHESSIANWAVELET_HPP
#define SGPP_BASE_BASIS_WAVELET_NOBOUNDARY_OPERATION_OPERATIONNAIVEEVALHESSIANWAVELET_HPP
