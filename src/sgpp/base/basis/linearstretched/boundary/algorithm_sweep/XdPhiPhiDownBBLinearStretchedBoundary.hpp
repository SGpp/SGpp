...
#ifndef XDPHIPHIDOWNBBLINEARSTRETCHEDBOUNDARY_HPP
#define XDPHIPHIDOWNBBLINEARSTRETCHEDBOUNDARY_HPP
 ...
 */
class XdPhiPhiDownBBLinearStretchedBoundary : public XdPhiPhiDownBBLinearStretched
{
public:
	/**
	 * Constructor
	 ...
	 */
	XdPhiPhiDownBBLinearStretchedBoundary(sg::base::GridStorage* storage);

	/**
	 * Destructor
	 */
	virtual ~XdPhiPhiDownBBLinearStretchedBoundary();
...
#endif /* XDPHIPHIDOWNBBLINEARSTRETCHEDBOUNDARY_HPP */
