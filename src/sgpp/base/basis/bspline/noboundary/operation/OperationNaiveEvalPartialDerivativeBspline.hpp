...
#ifndef SGPP_BASE_BASIS_BSPLINE_NOBOUNDARY_OPERATION_OPERATIONEVALPARTIALDERIVATIVEBSPLINE_HPP
#define SGPP_BASE_BASIS_BSPLINE_NOBOUNDARY_OPERATION_OPERATIONEVALPARTIALDERIVATIVEBSPLINE_HPP
  ...
  namespace base {
    ...
    class OperationNaiveEvalPartialDerivativeBspline :
      ...
      public:
         ...
         */
        OperationNaiveEvalPartialDerivativeBspline(GridStorage* storage, size_t degree) :
         ...
         * Virtual destructor.
         */
        virtual ~OperationNaiveEvalPartialDerivativeBspline() {
        }
