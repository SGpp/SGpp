...
#ifndef SGPP_BASE_BASIS_BSPLINE_MODIFIED_MODIFIEDBSPLINEBASIS_HPP
#define SGPP_BASE_BASIS_BSPLINE_MODIFIED_MODIFIEDBSPLINEBASIS_HPP
  ...
  namespace base {
    ...
    class ModBsplineBasis {
      ...
      public:
         ...
         * Default constructor.
         */
        ModBsplineBasis() : bspline_basis(BsplineBasis<LT, IT>()) {
        }
         ...
         */
        ModBsplineBasis(size_t degree) : bspline_basis(BsplineBasis<LT, IT>(degree)) {
        }
        ...
        inline double eval(LT l, IT i, double x) {
          ...
          if (i == 1) {
            return modifiedBSpline(x * hinv_dbl, bspline_basis.getDegree());
          } else {
        ...
        inline double evalDx(LT l, IT i, double x) {
          ...
          if (i == 1) {
            return dx_factor * modifiedBSplineDx(x * hinv_dbl, bspline_basis.getDegree());
          } else {
        ...
        inline double evalDxDx(LT l, IT i, double x) {
          ...
          if (i == 1) {
            return dx_factor*dx_factor * modifiedBSplineDxDx(x * hinv_dbl, bspline_basis.getDegree());
          } else {
