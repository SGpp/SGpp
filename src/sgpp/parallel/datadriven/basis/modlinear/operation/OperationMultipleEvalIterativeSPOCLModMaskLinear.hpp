...
#ifndef OPERATIONMULTIPLEEVALITERATIVESPOCLMODMASKLINEAR_HPP
#define OPERATIONMULTIPLEEVALITERATIVESPOCLMODMASKLINEAR_HPP
...
namespace sg {
  ...
  namespace parallel {
     ...
     */
    class OperationMultipleEvalIterativeSPOCLModMaskLinear : public sg::parallel::OperationMultipleEvalVectorizedSP {
      public:
        /**
         ...
         */
        OperationMultipleEvalIterativeSPOCLModMaskLinear(base::GridStorage* storage, base::DataMatrixSP* dataset);

        /**
         * Destructor
         */
        virtual ~OperationMultipleEvalIterativeSPOCLModMaskLinear();
...
#endif /* OPERATIONMULTIPLEEVALITERATIVESPOCLMODMASKLINEAR_HPP */
