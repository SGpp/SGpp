...
#ifndef OPERATIONMULTIPLEEVALITERATIVESPHYBRIDX86SIMDOCLMODMASKLINEAR_HPP
#define OPERATIONMULTIPLEEVALITERATIVESPHYBRIDX86SIMDOCLMODMASKLINEAR_HPP
...
namespace sg {
  namespace parallel {
    ...
    /**
     * This class implements OperationMultipleEvalSP for a grids with linear basis ansatzfunctions with extrapolation towards boundaries.
     *
     ...
     */
    class OperationMultipleEvalIterativeSPHybridX86SimdOCLModMaskLinear : public sg::parallel::OperationMultipleEvalVectorizedSP {
      public:
        /**
         * Construtor of OperationMultipleEvalIterativeSPHybridX86SimdOCLModMaskLinear
         *
         ...
         */
        OperationMultipleEvalIterativeSPHybridX86SimdOCLModMaskLinear(sg::base::GridStorage* storage, sg::base::DataMatrixSP* dataset);

        /**
         * Destructor
         */
        virtual ~OperationMultipleEvalIterativeSPHybridX86SimdOCLModMaskLinear();
...
#endif /* OPERATIONMULTIPLEEVALITERATIVESPHYBRIDX86SIMDOCLMODMASKLINEAR_HPP */
