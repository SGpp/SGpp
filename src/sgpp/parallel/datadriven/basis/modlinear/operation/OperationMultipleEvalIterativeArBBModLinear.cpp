...
OperationMultipleEvalIterativeArBBModLinear::OperationMultipleEvalIterativeArBBModLinear(sg::base::GridStorage* storage, sg::base::DataMatrix* dataset) : sg::base::OperationMultipleEvalVectorized(dataset)
{
