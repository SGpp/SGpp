      ...
      private:
        virtual std::string generateSourceMult(size_t dims, size_t local_workgroup_size) {
          ...
          for (size_t d = 0; d < dims; d++) {
            ...
            stream_program_src << "			abs = as_" << getType<real_type>::asString() << "(as_" << getType<real_type>::intAsString() << "(index_calc) | as_" << getType<real_type>::intAsString() << "(locMask[(k*" << dims << ")+" << d << "]));" << std::endl;
          ...
          for (size_t d = 0; d < dims; d++) {
            ...
            stream_program_src << "		abs = as_" << getType<real_type>::asString() << "(as_" << getType<real_type>::intAsString() << "(index_calc) | as_" << getType<real_type>::intAsString() << "(ptrMask[(m*" << dims << ")+" << d << "]));" << std::endl;
        ...
        virtual std::string generateSourceMultTrans(size_t dims, size_t local_workgroup_size) {
          ...
          for (size_t d = 0; d < dims; d++) {
            ...
            stream_program_src << "	" << getType<real_type>::asString() << " mask_" << d << " = ptrMask[(globalIdx*" << dims << ")+" << d << "];" << std::endl;
            stream_program_src << "	" << getType<real_type>::asString() << " offset_" << d << " = ptrOffset[(globalIdx*" << dims << ")+" << d << "];" << std::endl;
          }
          ...
          for (size_t d = 0; d < dims; d++) {
            ...
            stream_program_src << "			abs = as_" << getType<real_type>::asString() << "(as_" << getType<real_type>::intAsString() << "(index_calc) | as_" << getType<real_type>::intAsString() << "(mask_" << d << "));" << std::endl;
