...
namespace sg {
  namespace parallel {
    ...
    double OperationMultipleEvalIterativeHybridX86SimdOCLLinear::multTransposeVectorized(sg::base::DataVector& source, sg::base::DataVector& result) {
      ...
      if (this->dataset_->getNcols() % 128 != 0 || source_size != this->dataset_->getNcols()) {
        ...
        if (tid == 0) {
          ...
          for (size_t j = myStart; j < myEnd; j++) {
            ...
            for (size_t i = 0; i < source_size; i += 8) {
              ...
              for (size_t d = 0; d < dims; d++) {
                __m128d eval_0 = _mm_load_pd(&(ptrData[(d * source_size) + i + 0]));
          ...
          for (size_t j = myStart; j < myEnd; j++) {
            ...
            for (size_t i = 0; i < source_size; i += 16) {
              ...
              for (size_t d = 0; d < dims; d++) {
                __m256d eval_0 = _mm256_load_pd(&(ptrData[(d * source_size) + i + 0]));
    ...
    double OperationMultipleEvalIterativeHybridX86SimdOCLLinear::multVectorized(sg::base::DataVector& alpha, sg::base::DataVector& result) {
      ...
      if (this->dataset_->getNcols() % 128 != 0 || result_size != this->dataset_->getNcols()) {
        ...
        if (tid == 0) {
          ...
          for (size_t i = myStart; i < myEnd; i += 8) {
            ...
            for (size_t j = 0; j < storageSize; j++) {
              ...
              for (size_t d = 0; d < dims; d++) {
                __m128d eval_0 = _mm_load_pd(&(ptrData[(d * result_size) + i + 0]));
          ...
          for (size_t i = myStart; i < myEnd; i += 16) {
            ...
            for (size_t j = 0; j < storageSize; j++) {
              ...
              for (size_t d = 0; d < dims; d++) {
                __m256d eval_0 = _mm256_load_pd(&(ptrTransData[(d * result_size) + i + 0]));
                __m256d eval_1 = _mm256_load_pd(&(ptrTransData[(d * result_size) + i + 4]));
                __m256d eval_2 = _mm256_load_pd(&(ptrTransData[(d * result_size) + i + 8]));
                __m256d eval_3 = _mm256_load_pd(&(ptrTransData[(d * result_size) + i + 12]));;
