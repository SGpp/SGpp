...
#ifndef LEARNERADMMMIX_HPP
#define LEARNERADMMMIX_HPP
...
namespace sg {
  namespace parallel {
    class LearnerAdmmMix : public LearnerAdmm {
      ...
      public:
         ...
         * @param verbose
         */
        LearnerAdmmMix(const sg::base::RegularGridConfiguration& GridConfig, sg::datadriven::LearnerRegularizationType& regularization, const bool isRegression, const bool isVerbose = true, SolutionType method = Cholesky)
          : LearnerAdmm(GridConfig, regularization, isRegression, isVerbose, method) {};

        LearnerAdmmMix(sg::datadriven::LearnerRegularizationType& regularization, const bool isRegression, const bool isVerbose = true, SolutionType method = Cholesky)
         ...
         */
        LearnerAdmmMix(std::string tGridFilename, std::string tAlphaFilename, sg::datadriven::LearnerRegularizationType& regularization, const bool isRegression, const bool isVerbose, SolutionType method = Cholesky)
