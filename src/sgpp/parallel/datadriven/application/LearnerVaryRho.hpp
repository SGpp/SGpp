...
#ifndef LEARNERBLOCKJACOBI_HPP
#define LEARNERBLOCKJACOBI_HPP
...
namespace sg {
  namespace parallel {
    ...
    class LearnerVaryRho : public LearnerAdmm {
      public:
        /**
         * Constructor
         *
         ...
         * @param verbose
         */
        LearnerVaryRho(const sg::base::RegularGridConfiguration& GridConfig, sg::datadriven::LearnerRegularizationType& regularization, const bool isRegression, const bool isVerbose = true, SolutionType method = Cholesky)
          : LearnerAdmm(GridConfig, regularization, isRegression, isVerbose, method) {};

        LearnerVaryRho(sg::datadriven::LearnerRegularizationType& regularization, const bool isRegression, const bool isVerbose = true, SolutionType method = Cholesky)
         ...
         */
        LearnerVaryRho(std::string tGridFilename, std::string tAlphaFilename, sg::datadriven::LearnerRegularizationType& regularization, const bool isRegression, const bool isVerbose, SolutionType method = Cholesky)
      ...
      protected:
        virtual void createFactorizedSystem(sg::base::DataMatrix& trainDataset, double lambda, bool verbose = false);

    };
  }
}

#endif /* LEARNERBLOCKJACOBI_HPP */
