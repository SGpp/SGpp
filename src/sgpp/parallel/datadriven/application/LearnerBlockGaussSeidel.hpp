...
namespace sg {
  namespace parallel {
    ...
    class LearnerBlockGaussSeidel : public LearnerAdmm {
      public:
        /**
         * Constructor
         *
         ...
         * @param verbose
         */
        LearnerBlockGaussSeidel(const sg::base::RegularGridConfiguration& GridConfig, sg::datadriven::LearnerRegularizationType& regularization, const bool isRegression, const bool isVerbose = true, SolutionType method = Cholesky)
          : LearnerAdmm(GridConfig, regularization, isRegression, isVerbose, method) {};

        LearnerBlockGaussSeidel(sg::datadriven::LearnerRegularizationType& regularization, const bool isRegression, const bool isVerbose = true, SolutionType method = Cholesky)
         ...
         */
        LearnerBlockGaussSeidel(std::string tGridFilename, std::string tAlphaFilename, sg::datadriven::LearnerRegularizationType& regularization, const bool isRegression, const bool isVerbose, SolutionType method = Cholesky)
