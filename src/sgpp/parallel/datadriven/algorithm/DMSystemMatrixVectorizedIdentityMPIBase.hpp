	  ...
	  offset_(NULL)
{
	...
	virtual void rebuildLevelAndIndex(){
		LevelIndexMaskOffsetHelper::rebuild<kernelType, DMSystemMatrixVectorizedIdentityMPIBase<kernelType> >(this);
	...
	friend struct LevelIndexMaskOffsetHelper::rebuild<kernelType, DMSystemMatrixVectorizedIdentityMPIBase<kernelType> >;
};
