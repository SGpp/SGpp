...
namespace datadriven
{
  ...
  double OperationTestModWavelet::testWithCharacteristicNumber(sg::base::DataVector& alpha, sg::base::DataMatrix& data, sg::base::DataVector& classes, sg::base::DataVector& charaNumbers, base::DataMatrix& ROC_curve)
  {
    base::ModifiedWaveletBasis<unsigned int, unsigned int> base;
