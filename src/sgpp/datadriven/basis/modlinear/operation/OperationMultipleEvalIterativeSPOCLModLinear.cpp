...
namespace parallel
{
  ...
  OperationMultipleEvalIterativeSPOCLModLinear::OperationMultipleEvalIterativeSPOCLModLinear(base::GridStorage* storage, base::DataMatrixSP* dataset) : base::OperationMultipleEvalVectorizedSP(dataset)
  {
