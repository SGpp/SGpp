...
#include "../../OperationMultipleEvalSubspace/accelerator/X86AcceleratorParameters.hpp"
#include "../../OperationMultipleEvalSubspace/accelerator/X86AcceleratorSubspaceNode.hpp"
#include "../../OperationMultipleEvalSubspace/accelerator/X86AcceleratorSubspaceNodeMIC.hpp"
...
class X86Accelerator: public FastKernelBase {
private:
    ...
    vector<X86AcceleratorSubspaceNode> allSubspaceNodes;
    vector<X86AcceleratorSubspaceNodeMIC> allSubspaceNodesMic;
    vector<double> allSurplussesMic;
    vector<uint32_t> allHInverseMic;
    ...
    void listMultInner(size_t dim, const double * const datasetPtr, sg::base::DataVector &alpha, size_t dataIndexBase,
            size_t end_index_data, X86AcceleratorSubspaceNodeMIC &subspace, double *levelArrayContinuous,
            size_t validIndicesCount, size_t *validIndices, size_t *levelIndices,
            double *evalIndexValuesAll,
            uint32_t *intermediatesAll,
            uint32_t *hInverse
...
#include "../../OperationMultipleEvalSubspace/accelerator/X86Accelerator_calculateIndexAccelerator.hpp"

    static const KernelType kernelType = Standard;

    X86Accelerator(GridStorage* storage, DataMatrix* dataset, size_t dim);
    ...
    size_t getAlignment() {
        return X86ACCELERATOR_PARALLEL_DATA_POINTS;
    }
};
