...
void X86Perfect::uncachedMultInner(size_t dim, const double * const datasetPtr, sg::base::DataVector &alpha,
        size_t dataIndexBase, size_t end_index_data, X86PerfectSubspaceNode &subspace, size_t validIndicesCount,
        size_t *validIndices, size_t *levelIndices, size_t *nextIterationToRecalcReferences, double *evalIndexValuesAll,
        uint32_t *intermediatesAll) {

    double *levelArrayContinuous = subspace.subspaceArray;
