...
#ifndef SGPP_OPT_GRID_WAVELETTRAPEZOIDBOUNDARYGRID_HPP
#define SGPP_OPT_GRID_WAVELETTRAPEZOIDBOUNDARYGRID_HPP
 ...
 */
class WaveletTrapezoidBoundaryGrid : public base::Grid
{
public:
    /**
     * Constructor.
