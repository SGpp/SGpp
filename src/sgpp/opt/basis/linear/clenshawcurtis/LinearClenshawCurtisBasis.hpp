...
#ifndef SGPP_OPT_BASIS_LINEAR_CLENSHAWCURTIS_LINEARCLENSHAWCURTISBASIS_HPP
#define SGPP_OPT_BASIS_LINEAR_CLENSHAWCURTIS_LINEARCLENSHAWCURTISBASIS_HPP
...
public:
     ...
     */
    LinearClenshawCurtisBasis(const tools::CosineTable *cosine_table = NULL) :
