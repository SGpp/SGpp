...
namespace sg {
  namespace opt {
    ...
    void OperationMultipleHierarchisationBsplineClenshawCurtis::doHierarchisation(
    ...
    void OperationMultipleHierarchisationBsplineClenshawCurtis::doDehierarchisation(
      ...
      base::OperationNaiveEvalBsplineClenshawCurtis op_eval(storage, grid.getDegree(), grid.getCosineTable());
