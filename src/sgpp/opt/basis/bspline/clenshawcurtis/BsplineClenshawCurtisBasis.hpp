...
#ifndef SGPP_OPT_BASIS_BSPLINE_CLENSHAWCURTIS_BSPLINECLENSHAWCURTISBASIS_HPP
#define SGPP_OPT_BASIS_BSPLINE_CLENSHAWCURTIS_BSPLINECLENSHAWCURTISBASIS_HPP
...
public:
     ...
     */
    BsplineClenshawCurtisBasis(size_t degree, const tools::CosineTable *cosine_table = NULL) :
