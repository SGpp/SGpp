...
#ifndef SGPP_OPT_BASIS_BSPLINE_BOUNDARY_OPERATION_OPERATIONEVALHESSIANBSPLINEBOUNDARY_HPP
#define SGPP_OPT_BASIS_BSPLINE_BOUNDARY_OPERATION_OPERATIONEVALHESSIANBSPLINEBOUNDARY_HPP
...
public:
     ...
     */
    OperationEvalHessianBsplineBoundary(base::GridStorage *storage, size_t degree) :
