...
#ifndef SGPP_OPT_BASIS_BSPLINE_BOUNDARY_OPERATION_OPERATIONEVALGRADIENTBSPLINEBOUNDARY_HPP
#define SGPP_OPT_BASIS_BSPLINE_BOUNDARY_OPERATION_OPERATIONEVALGRADIENTBSPLINEBOUNDARY_HPP
...
public:
     ...
     */
    OperationEvalGradientBsplineBoundary(base::GridStorage *storage, size_t degree) :
