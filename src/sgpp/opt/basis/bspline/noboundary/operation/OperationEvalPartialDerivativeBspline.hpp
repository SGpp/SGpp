...
#ifndef SGPP_OPT_BASIS_BSPLINE_NOBOUNDARY_OPERATION_OPERATIONEVALPARTIALDERIVATIVEBSPLINE_HPP
#define SGPP_OPT_BASIS_BSPLINE_NOBOUNDARY_OPERATION_OPERATIONEVALPARTIALDERIVATIVEBSPLINE_HPP
 ...
 */
class OperationEvalPartialDerivativeBspline :
...
public:
     ...
     */
    OperationEvalPartialDerivativeBspline(base::GridStorage *storage, size_t degree) :
     ...
     * Virtual destructor.
     */
    virtual ~OperationEvalPartialDerivativeBspline()
    {
    }
