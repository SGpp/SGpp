...
#ifndef SGPP_OPT_BASIS_NOBOUNDARY_OPERATION_OPERATIONEVALHESSIANBSPLINE_HPP
#define SGPP_OPT_BASIS_NOBOUNDARY_OPERATION_OPERATIONEVALHESSIANBSPLINE_HPP
...
public:
     ...
     */
    OperationEvalHessianBspline(base::GridStorage *storage, size_t degree) :
