...
#ifndef SGPP_OPT_BASIS_WAVELET_BOUNDARY_OPERATION_OPERATIONEVALHESSIANBOUNDARYWAVELET_HPP
#define SGPP_OPT_BASIS_WAVELET_BOUNDARY_OPERATION_OPERATIONEVALHESSIANBOUNDARYWAVELET_HPP
...
public:
     ...
     */
    OperationEvalHessianWaveletBoundary(base::GridStorage *storage) : storage(storage)
    {
    }
