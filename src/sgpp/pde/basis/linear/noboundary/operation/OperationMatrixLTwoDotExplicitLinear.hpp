...
namespace sg {
  namespace pde {
     ...
     */
    class OperationMatrixLTwoDotExplicitLinear: public sg::base::OperationMatrix {
      public:
        /**
         ...
         */
        OperationMatrixLTwoDotExplicitLinear(sg::base::DataMatrix* m, sg::base::Grid* grid);
        /**
         ...
         * @param grid the sparse grid
         */
        OperationMatrixLTwoDotExplicitLinear(sg::base::Grid* grid);
