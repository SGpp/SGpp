		...
		double riskfree, size_t timeSt, double dt, size_t CGIt, double CGeps, std::string Solver, std::string coordsType)
{
	...
	// Todo: Should we use dim as the number of assets, or dim as the number of dimensions of the PDE?
	// If the latter, we need to read e.g. 2 boundaries for one asset
