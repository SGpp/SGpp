...
# @li <code>adapt_points</code>: <i>Number of points in one refinement iteration</i> - @link RegressorSpecificationDescriptor.withAdaptPoints() <code>.withSpecification().withAdaptPoints(100)</code> @endlink
# @li <code>adapt_rate</code>: <i>Percentage of points from all refinable points in one refinement iteration</i> - @link RegressorSpecificationDescriptor.withAdaptRate() <code>.withSpecification().withAdaptRate(0.05)</code> @endlink
...
# @li <code>adapt_threshold</code>: @link bin.learner.TrainingSpecification.TrainingSpecification.setAdaptThreshold() <i>refinement threshold</i> @endlink - @link RegressorSpecificationDescriptor.withAdaptThreshold() .withSpecification().withAdaptThreshold(0.003) @endlink
...
# @li <code>zeh</code>: <i>Specifies the action to do</i> - @link RegressorSpecificationDescriptor.withIdentityOperator() .withSpecification().withIdentityOperator()@endlink or @link RegressorSpecificationDescriptor.withLaplaceOperator() .withSpecification().withLaplaceOperator()@endlink
...
# @li <code>lambda</code>: <i>Lambda</i> - @link RegressorSpecificationDescriptor.withLambda() .withSpecification().withLambda(0.00001)@endlink
