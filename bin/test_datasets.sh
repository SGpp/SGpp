...
do
	...
	do
		...
		# test DR5, mod linear
		../bin/ClassifyBenchmark ../input/DR5_nowarnings_less05_train.arff ../input/DR5_nowarnings_less05_test.arff 1 ${PREC} modlinear 5 0.00001 150 0.0001 7 0.0 150 150 0.0001 ${VEC} 2>&1 | tee ../log/${RESPRE}_DR5_${VEC}_modlinear_${PREC}.log
