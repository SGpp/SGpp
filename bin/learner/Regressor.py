...
class Regressor(Learner):
    ...
    def evalError(self, data, alpha):
        ...
        self.specification.getBOperator().mult(alpha, data.getPoints(), self.error)
        ...
        self.specification.getBOperator().multTranspose(self.error, data.getPoints(), self.errors)
