...
#ifndef SCRAMBLEDSOBOLSAMPLEGENERATOR_HPP_
#define SCRAMBLEDSOBOLSAMPLEGENERATOR_HPP_
 ...
 */
class ScrambledSobolSampleGenerator : public SampleGenerator {
 public:
  /**
  ...
  * @return void
  */
  ScrambledSobolSampleGenerator(size_t dimensions,
                                std::uint64_t seed = std::mt19937_64::default_seed);

  /**
   * default destructor
   */
  virtual ~ScrambledSobolSampleGenerator();
  ...
  *
  */
  size_t i4_bit_hi1(std::uint64_t n);
  ...
  */
  size_t i4_bit_lo0(std::uint64_t n);
  ...
  *      @return void.
  */
  void getSample(base::DataVector& sample);

 private:
  /**
  * @brief Method returns a permutation of base! possibilities by selecting random partners
  *
  ...
  */
  void scramble(base::DataVector& value);
  ...
  */
  ...
  //
  std::uniform_int_distribution<std::uint64_t> uniformIntDist;
};
}  // namespace quadrature
}  // namespace sgpp

#endif /* SCRAMBLEDSOBOLSAMPLEGENERATOR_HPP_ */
