...
def createFileName(gridType, model, refineType, maxPoints, maxLevel, degree, objFunc):
    if refineType == 'regular':
        saveName = '{}_{}{}_{}{}.pkl'.format(objFunc.getName(), refineType, maxLevel, gridType, degree)
    elif refineType == 'mc':
        saveName = '{}_mc_{}.pkl'.format(objFunc.getName(), maxPoints)
    elif refineType == 'surplus':
        saveName = '{}_{}{}_{}{}.pkl'.format(objFunc.getName(), refineType, maxPoints, gridType, degree)
    return saveName


def saveData(data, gridType, model, refineType, maxPoints, maxLevel, degree, objFunc):
    directory = os.path.join('/home/rehmemk/git/SGpp/MR_Python/Extended/data/', model, objFunc.getName())
    if not os.path.exists(directory):
        os.makedirs(directory)
       
    saveName = createFileName(gridType, model, refineType, maxPoints, maxLevel, degree, objFunc)
