...
def run(par, n):
    ...
    domain.set_quantity('elevation',
                        filename='/home/rehmemk/git/SGpp/MR_Python/Extended/ANUGA/bathymetry.pts',
                        alpha=0.02)
    ...
    data = np.loadtxt('/home/rehmemk/git/SGpp/MR_Python/Extended/ANUGA/boundary_wave_original.txt', skiprows=1)
    t = data[:, 0]
    y = data[:, 1]
    ...
    # write data
    data[:, 1] = ynew.copy()
#     f_handle = file('/home/rehmemk/git/SGpp/MR_Python/Extended/ANUGA/boundary_wave_input.txt', 'a')
#     np.savetxt(f_handle, data)
#     f_handle.close()
    import scipy
    wave_function = scipy.interpolate.interp1d(t, ynew, kind='zero', fill_value='extrapolate')
