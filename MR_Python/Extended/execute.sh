...
# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=0 --gridType=nak --degree=135 --refineType=surplus --minPoints=1 --maxPoints=1000 --numSteps=7 --numRefine=100
# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=1 --gridType=nak --degree=135 --refineType=surplus --minPoints=1 --maxPoints=1000 --numSteps=7 --numRefine=100
# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=2 --gridType=nak --degree=135 --refineType=surplus --minPoints=1 --maxPoints=1000 --numSteps=7 --numRefine=100
# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=3 --gridType=nak --degree=135 --refineType=surplus --minPoints=1 --maxPoints=1000 --numSteps=7 --numRefine=100
# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=4 --gridType=nak --degree=135 --refineType=surplus --minPoints=1 --maxPoints=1000 --numSteps=7 --numRefine=100
# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=5 --gridType=nak --degree=135 --refineType=surplus --minPoints=1 --maxPoints=1000 --numSteps=7 --numRefine=100

# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=0 --gridType=nak --degree=135 --refineType=regular --maxLevel=10
# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=1 --gridType=nak --degree=135 --refineType=regular --maxLevel=10
# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=2 --gridType=nak --degree=135 --refineType=regular --maxLevel=10
# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=3 --gridType=nak --degree=135 --refineType=regular --maxLevel=10
# time python2.7 comparingBSplines.py --model='monomial' --dim=1 --scalarModelParameter=4 --gridType=nak --degree=135 --refineType=regular --maxLevel=10
