...
#ifndef OPERATIONHESTONDLINEARBOUNDARY_HPP
#define OPERATIONHESTONDLINEARBOUNDARY_HPP
...
namespace SGPP {
  namespace finance {
    ...
    /**
     * Implements the Heston D-Operation (corresponds to operator D in Master's thesis), that is needed
     * the solve the multidimensional Heston
     * equation.
     *
     * @version $HEAD$
     */
    class OperationHestonDLinearBoundary : public SGPP::pde::UpDownOneOpDim {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationHestonDLinearBoundary(SGPP::base::GridStorage* storage, SGPP::base::DataVector& coef);

        /**
         * Destructor
         */
        virtual ~OperationHestonDLinearBoundary();
      ...
      protected:
        ...
        /**
         * down-Gradient step in dimension <i>dim</i> applies the x dphi dphi operation
         * in one dimension
         *
        ...
        /**
         * up-Gradient step in dimension <i>dim</i> applies the x dphi dphi operation
         * in one dimension
         *
         * @param alpha the coefficients of the gridpoints
         * @param result vector with the result of this operation
...
#endif /* OPERATIONHESTONDLINEARBOUNDARY_HPP */