...
OperationHestonFLinearBoundary::OperationHestonFLinearBoundary(SGPP::base::GridStorage* storage,
...
void OperationHestonFLinearBoundary::up(SGPP::base::DataVector& alpha,
...
void OperationHestonFLinearBoundary::down(SGPP::base::DataVector& alpha,
                                          SGPP::base::DataVector& result, size_t dim) {
  // phi * phi
...
void OperationHestonFLinearBoundary::upOpDim(SGPP::base::DataVector& alpha,
                                             SGPP::base::DataVector& result, size_t dim) {
  // dphi * phi
...
void OperationHestonFLinearBoundary::downOpDim(SGPP::base::DataVector& alpha,
                                               SGPP::base::DataVector& result, size_t dim) {
  // dphi * phi
