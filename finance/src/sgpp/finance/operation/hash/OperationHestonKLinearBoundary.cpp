...
void OperationHestonKLinearBoundary::downOpDimThree(SGPP::base::DataVector&
...
void OperationHestonKLinearBoundary::downOpDimFour(SGPP::base::DataVector&
    alpha, SGPP::base::DataVector& result, size_t dim) {
  // sqrtX phi phi
  SqrtXPhiPhiDownBBLinearBoundary func(this->storage);
  SGPP::base::sweep<SqrtXPhiPhiDownBBLinearBoundary> s(func, this->storage);
...
// Doubles
void OperationHestonKLinearBoundary::downOpDimOneAndOpDimTwo(
...
void OperationHestonKLinearBoundary::upOpDimOneAndOpDimTwo(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
void OperationHestonKLinearBoundary::downOpDimOneAndOpDimThree(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
void OperationHestonKLinearBoundary::upOpDimOneAndOpDimThree(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
void OperationHestonKLinearBoundary::downOpDimOneAndOpDimFour(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
void OperationHestonKLinearBoundary::upOpDimOneAndOpDimFour(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
void OperationHestonKLinearBoundary::downOpDimTwoAndOpDimThree(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
void OperationHestonKLinearBoundary::upOpDimTwoAndOpDimThree(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
void OperationHestonKLinearBoundary::downOpDimTwoAndOpDimFour(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
void OperationHestonKLinearBoundary::upOpDimTwoAndOpDimFour(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
void OperationHestonKLinearBoundary::downOpDimThreeAndOpDimFour(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
void OperationHestonKLinearBoundary::upOpDimThreeAndOpDimFour(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {}
