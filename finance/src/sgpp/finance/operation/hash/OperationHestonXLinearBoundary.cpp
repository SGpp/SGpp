...
void OperationHestonXLinearBoundary::downOpDimOne(SGPP::base::DataVector& alpha,
  ...
  SGPP::base::sweep<SGPP::finance::XdPhiPhiDownBBLinearBoundary> s(func,
      this->storage);
...
void OperationHestonXLinearBoundary::upOpDimOneAndOpDimTwo(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {
}

void OperationHestonXLinearBoundary::downOpDimOneAndOpDimTwo(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {
}
