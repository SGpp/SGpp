...
namespace SGPP {
  namespace finance {
     ...
     * @version $HEAD$
     */
    class OperationDeltaLinearStretched : public SGPP::pde::UpDownOneOpDim {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationDeltaLinearStretched(SGPP::base::GridStorage* storage, SGPP::base::DataVector& coef);

        /**
         * Destructor
         */
        virtual ~OperationDeltaLinearStretched();
...
#endif /* OPERATIONDELTALINEARSTRETCHED_HPP */