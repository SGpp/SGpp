 ...
 *
 */
class OperationHestonDLinear : public SGPP::pde::UpDownOneOpDim {
 public:
  /**
   * Constructor
   *
   ...
   */
  OperationHestonDLinear(SGPP::base::GridStorage* storage, SGPP::base::DataVector& coef);

  /**
   * Destructor
   */
  virtual ~OperationHestonDLinear();
...
#endif /* OPERATIONHESTONDLINEAR_HPP */
