...
void OperationHestonXLinear::mult(SGPP::base::DataVector& alpha,
...
void OperationHestonXLinear::up(SGPP::base::DataVector& alpha,
...
void OperationHestonXLinear::down(SGPP::base::DataVector& alpha,
                                  SGPP::base::DataVector& result, size_t dim) {
  // phi * phi
...
void OperationHestonXLinear::upOpDimOneAndOpDimTwo(SGPP::base::DataVector&
    alpha, SGPP::base::DataVector& result, size_t dim) {
}

void OperationHestonXLinear::downOpDimOneAndOpDimTwo(SGPP::base::DataVector&
    alpha, SGPP::base::DataVector& result, size_t dim) {
}
