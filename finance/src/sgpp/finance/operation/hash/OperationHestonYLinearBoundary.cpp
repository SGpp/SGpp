...
void OperationHestonYLinearBoundary::upOpDimOne(SGPP::base::DataVector& alpha,
  ...
  SGPP::base::sweep<SGPP::finance::SqXdPhidPhiUpBBLinearBoundary> s(func,
      this->storage);
...
void OperationHestonYLinearBoundary::downOpDimOne(SGPP::base::DataVector& alpha,
  ...
  SGPP::base::sweep<SGPP::finance::SqXdPhidPhiDownBBLinearBoundary> s(func,
      this->storage);
...
void OperationHestonYLinearBoundary::upOpDimOneAndOpDimTwo(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {
}

void OperationHestonYLinearBoundary::downOpDimOneAndOpDimTwo(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result, size_t dim) {
}
