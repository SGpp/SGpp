 ...
 *
 */
class OperationHestonBLinearBoundary : public SGPP::pde::UpDownTwoOpDims {
 public:
  /**
   * Constructor
   *
   ...
   */
  OperationHestonBLinearBoundary(SGPP::base::GridStorage* storage, SGPP::base::DataMatrix& coef);
 ...
 protected:
  ...
  /**
   * Does nothing (this situation doesn't occur in the Heston PDEs). Implemented only so that this
