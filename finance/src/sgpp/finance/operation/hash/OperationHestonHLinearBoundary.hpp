...
#ifndef OPERATIONHESTONHLINEARBOUNDARY_HPP
#define OPERATIONHESTONHLINEARBOUNDARY_HPP
...
namespace SGPP {
  namespace finance {
     ...
     * @version $HEAD$
     */
    class OperationHestonHLinearBoundary : public SGPP::pde::UpDownTwoOpDims {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationHestonHLinearBoundary(SGPP::base::GridStorage* storage, SGPP::base::DataMatrix& coef);

        /**
         * Destructor
         */
        virtual ~OperationHestonHLinearBoundary();
...
#endif /* OPERATIONHESTONHLINEARBOUNDARY_HPP */