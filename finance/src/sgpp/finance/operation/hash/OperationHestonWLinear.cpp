...
void OperationHestonWLinear::mult(SGPP::base::DataVector& alpha,
...
void OperationHestonWLinear::up(SGPP::base::DataVector& alpha,
...
void OperationHestonWLinear::down(SGPP::base::DataVector& alpha,
                                  SGPP::base::DataVector& result, size_t dim) {
  // phi * phi
...
void OperationHestonWLinear::upOpDimOneAndOpDimTwo(SGPP::base::DataVector&
    alpha, SGPP::base::DataVector& result, size_t dim) {
}

void OperationHestonWLinear::downOpDimOneAndOpDimTwo(SGPP::base::DataVector&
    alpha, SGPP::base::DataVector& result, size_t dim) {
}
