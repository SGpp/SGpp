...
namespace SGPP {
  namespace finance {
     ...
     *
     */
    class OperationHestonYLinearBoundary : public SGPP::pde::UpDownTwoOpDims {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationHestonYLinearBoundary(SGPP::base::GridStorage* storage, SGPP::base::DataMatrix& coef);

        /**
         * Destructor
         */
        virtual ~OperationHestonYLinearBoundary();
...
#endif /* OPERATIONHESTONYLINEARBOUNDARY_HPP */