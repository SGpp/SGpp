...
base::OperationMatrix* createOperationGamma(base::Grid& grid,
    base::DataMatrix& coef) {
  ...
  if (grid.getType() == base::GridType::Linear) {
    ...
    return new finance::OperationGammaLinearStretchedBoundary(grid.getStorage(),
           coef);
  }
...
base::OperationMatrix* createOperationGammaLog(base::Grid& grid,
    base::DataMatrix& coef) {
  ...
  if (grid.getType() == base::GridType::Linear) {
    ...
    return new finance::OperationGammaLogLinearStretchedBoundary(grid.getStorage(),
           coef);
  }
...
base::OperationMatrix* createOperationDelta(base::Grid& grid,
    base::DataVector& coef) {
  ...
  if (grid.getType() == base::GridType::Linear) {
    ...
    return new finance::OperationDeltaLinearStretchedBoundary(grid.getStorage(),
           coef);
  }
...
base::OperationMatrix* createOperationDeltaLog(base::Grid& grid,
    base::DataVector& coef) {
  ...
  if (grid.getType() == base::GridType::Linear) {
    ...
    return new finance::OperationDeltaLogLinearStretchedBoundary(grid.getStorage(),
           coef);
  } else if (grid.getType() == base::GridType::LinearL0Boundary
             || grid.getType() == base::GridType::LinearBoundary ) {
...
base::OperationMatrix* createOperationHestonBLog(base::Grid& grid,
    base::DataMatrix& coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonCLog(base::Grid& grid,
    base::DataMatrix& coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonDLog(base::Grid& grid,
    base::DataVector& coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonELog(base::Grid& grid,
    base::DataVector& coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonFLog(base::Grid& grid,
    base::DataVector& coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonGLog(base::Grid& grid,
    base::DataVector& coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonHLog(base::Grid& grid,
    base::DataMatrix& coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonKLog(base::Grid& grid,
    float_t**** * coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonX(base::Grid& grid,
    base::DataMatrix& coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonY(base::Grid& grid,
    base::DataMatrix& coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonW(base::Grid& grid,
    base::DataMatrix& coef) {
  if (grid.getType() == base::GridType::Linear) {
...
base::OperationMatrix* createOperationHestonZ(base::Grid& grid,
    base::DataVector& coef) {
  if (grid.getType() == base::GridType::Linear) {
