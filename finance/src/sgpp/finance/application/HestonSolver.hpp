...
class HestonSolver : public SGPP::pde::ParabolicPDESolver {
 ...
 public:
  ...
  virtual void setStochasticData(SGPP::base::DataVector& thetas_arg,
                                 SGPP::base::DataVector& kappas_arg, SGPP::base::DataVector& volvols_arg,
   ...
   */
  virtual float_t evalOption(std::vector<float_t>& eval_point,
   ...
   */
  void EvaluateHestonExactSurface(SGPP::base::DataVector& alpha,
                                  float_t maturity);
   ...
   * @param maturity the option maturity
   */
  void EvaluateHestonExactSurfacePut(SGPP::base::DataVector& alpha,
                                     float_t maturity);
   ...
   */
  void EvaluateHestonExact1d(SGPP::base::DataVector& alpha,
                             SGPP::base::Grid* grid1d, SGPP::base::BoundingBox* boundingBox1d,
                             float_t maturity, float_t v);
   ...
   * @return option price
   */
  float_t EvaluateHestonPriceExact(float_t S, float_t v, float_t xi,
   ...
   * @return option price
   */
  float_t EvaluateHestonPriceExactPut(float_t S, float_t v, float_t xi,
                                      float_t theta, float_t kappa, float_t rho, float_t r, float_t T, float_t K);
   ...
   */
  float_t GaussLobattoIntStep(float_t a, float_t b, float_t fa, float_t fb,
                              size_t& neval, size_t maxeval, float_t acc, float_t xi, float_t theta,
                              float_t kappa, float_t rho, float_t r, float_t T, float_t K, float_t S,
                              float_t v, int type);
   ...
   */
  float_t GaussLobattoInt(float_t a, float_t b, float_t abstol, size_t maxeval,
   ...
   */
  void CompareHestonSolutionToExact(SGPP::base::DataVector* solution,
                                    SGPP::base::DataVector* exact, std::string filename, size_t PointsPerDimension);
   ...
   */
  float_t EvalSinglePoint1Asset(float_t s, float_t v,
                                SGPP::base::DataVector& alphaVec);
