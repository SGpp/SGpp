...
namespace SGPP {
  namespace finance {
    ...
    void BlackScholesSolver::getGridNormalDistribution(DataVector& alpha, std::vector<float_t>& norm_mu, std::vector<float_t>& norm_sigma) {
    ...
    void BlackScholesSolver::refineInitialGridWithPayoff(DataVector& alpha, float_t strike, std::string payoffType, float_t dStrikeDistance) {
    ...
    void BlackScholesSolver::refineInitialGridWithPayoffToMaxLevel(DataVector& alpha, float_t strike, std::string payoffType, float_t dStrikeDistance, SGPP::base::GridIndex::level_type maxLevel) {
      size_t nRefinements = 0;
    ...
    void BlackScholesSolver::setStochasticData(DataVector& mus, DataVector& sigmas, DataMatrix& rhos, float_t r) {
    ...
    void BlackScholesSolver::solveExplicitEuler(size_t numTimesteps, float_t timestepsize, size_t maxCGIterations, float_t epsilonCG, DataVector& alpha, bool verbose, bool generateAnimation, size_t numEvalsAnimation) {
    ...
    void BlackScholesSolver::solveImplicitEuler(size_t numTimesteps, float_t timestepsize, size_t maxCGIterations, float_t epsilonCG, DataVector& alpha, bool verbose, bool generateAnimation, size_t numEvalsAnimation) {
      if (this->bGridConstructed && this->bStochasticDataAlloc) {
    ...
    void BlackScholesSolver::solveCrankNicolson(size_t numTimesteps, float_t timestepsize, size_t maxCGIterations, float_t epsilonCG, DataVector& alpha, size_t NumImEul) {
      if (this->bGridConstructed && this->bStochasticDataAlloc) {
        SLESolver* myCG = NULL;
        OperationParabolicPDESolverSystem* myBSSystem = NULL;
    ...
    void BlackScholesSolver::solveAdamsBashforth(size_t numTimesteps, float_t timestepsize, size_t maxCGIterations, float_t epsilonCG, DataVector& alpha, bool verbose) {
    ...
    void BlackScholesSolver::solveSC(std::string Solver, size_t numTimesteps, float_t timestepsize, size_t maxCGIterations, float_t epsilonCG, DataVector& alpha, bool verbose) {
      std::string tmp;
    ...
    void BlackScholesSolver::solveSCAC(size_t numTimesteps, float_t timestepsize, float_t epsilon, size_t maxCGIterations, float_t epsilonCG, DataVector& alpha, bool verbose) {
      ODESolver* myODESolver = new VarTimestep("AdBasC", "CrNic", numTimesteps, timestepsize, epsilon, myScreen, -1);
      BlackScholesSolver::solveX(numTimesteps, timestepsize, maxCGIterations, epsilonCG, alpha, verbose, myODESolver, "CrNic");
      delete myODESolver;
    }

    void BlackScholesSolver::solveSCH(size_t numTimesteps, float_t timestepsize, float_t epsilon, size_t maxCGIterations, float_t epsilonCG, DataVector& alpha, bool verbose) {
      ODESolver* myODESolver = new StepsizeControlH("CrNic", numTimesteps, timestepsize, epsilon, myScreen, 0.9);
      BlackScholesSolver::solveX(numTimesteps, timestepsize, maxCGIterations, epsilonCG, alpha, verbose, myODESolver, "CrNic");
      delete myODESolver;
    }

    void BlackScholesSolver::solveSCBDF(size_t numTimesteps, float_t timestepsize, float_t epsilon, size_t maxCGIterations, float_t epsilonCG, DataVector& alpha, bool verbose) {
    ...
    void BlackScholesSolver::solveSCEJ(size_t numTimesteps, float_t timestepsize, float_t epsilon, float_t myAlpha, size_t maxCGIterations, float_t epsilonCG, DataVector& alpha, bool verbose) {
    ...
    void BlackScholesSolver::solveX(size_t numTimesteps, float_t timestepsize, size_t maxCGIterations, float_t epsilonCG, DataVector& alpha, bool verbose, void* myODESolverV, std::string Solver) {
    ...
    void BlackScholesSolver::initGridWithPayoff(DataVector& alpha, float_t strike, std::string payoffType) {
      this->dStrike = strike;
      this->payoffType = payoffType;
    ...
    float_t BlackScholesSolver::getAnalyticSolution1D(float_t stock, bool isCall, float_t t, float_t vola, float_t r, float_t strike) {
    ...
    void BlackScholesSolver::solve1DAnalytic(std::vector< std::pair<float_t, float_t> >& premiums, float_t minStock, float_t maxStock, float_t StockInc, float_t strike, float_t t, bool isCall) {
    ...
    void BlackScholesSolver::print1DAnalytic(std::vector< std::pair<float_t, float_t> >& premiums, std::string tfilename) {
    ...
    void BlackScholesSolver::getAnalyticAlpha1D(DataVector& alpha_analytic, float_t strike, float_t t, std::string payoffType, bool hierarchized) {
      float_t coord;
    ...
    void BlackScholesSolver::evaluate1DAnalyticCuboid(SGPP::base::DataVector& AnalyticOptionPrices, SGPP::base::DataMatrix& EvaluationPoints, float_t strike, float_t vola, float_t r, float_t t, bool isCall) {
    ...
    void BlackScholesSolver::setEnableCoarseningData(std::string adaptSolveMode, std::string refineMode, SGPP::base::GridIndex::level_type refineMaxLevel, int numCoarsenPoints, float_t coarsenThreshold, float_t refineThreshold) {
    ...
    void BlackScholesSolver::printPayoffInterpolationError2D(DataVector& alpha, std::string tFilename, size_t numTestpoints, float_t strike) {
      if (this->useLogTransform == false) {
        if (this->bGridConstructed) {
    ...
    size_t BlackScholesSolver::getGridPointsAtMoney(std::string payoffType, float_t strike, float_t eps) {
      size_t nPoints = 0;
    ...
    void BlackScholesSolver::initCartesianGridWithPayoff(DataVector& alpha, float_t strike, std::string payoffType) {
      float_t tmp;
    ...
    void BlackScholesSolver::initLogTransformedGridWithPayoff(DataVector& alpha, float_t strike, std::string payoffType) {
      float_t tmp;
    ...
    void BlackScholesSolver::initPATTransformedGridWithPayoff(DataVector& alpha, float_t strike, std::string payoffType) {
      float_t tmp;
    ...
    float_t BlackScholesSolver::evalOption(std::vector<float_t>& eval_point, SGPP::base::DataVector& alpha) {
    ...
    void BlackScholesSolver::storeInnerRHS(DataVector& alpha, std::string tFilename, float_t timestepsize) {
      if (this->bGridConstructed) {
    ...
    void BlackScholesSolver::storeInnerSolution(DataVector& alpha, size_t numTimesteps, float_t timestepsize, size_t maxCGIterations, float_t epsilonCG, std::string tFilename) {
      if (this->bGridConstructed) {
