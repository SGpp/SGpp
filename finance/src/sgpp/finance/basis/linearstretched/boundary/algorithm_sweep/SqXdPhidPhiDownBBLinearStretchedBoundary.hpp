 ...
 */
class SqXdPhidPhiDownBBLinearStretchedBoundary : public
  SqXdPhidPhiDownBBLinearStretched {
 public:
  /**
   * Constructor
   *
   ...
   */
  SqXdPhidPhiDownBBLinearStretchedBoundary(SGPP::base::GridStorage* storage);
