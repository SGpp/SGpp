...
namespace SGPP {
  namespace finance {
    ...
    SqXdPhidPhiDownBBLinearStretchedBoundary::SqXdPhidPhiDownBBLinearStretchedBoundary(SGPP::base::GridStorage* storage) : SqXdPhidPhiDownBBLinearStretched(storage) {
    }
