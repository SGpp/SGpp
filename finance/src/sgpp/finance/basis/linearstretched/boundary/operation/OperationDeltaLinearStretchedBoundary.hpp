...
namespace SGPP {
  namespace finance {
     ...
     * @version $HEAD$
     */
    class OperationDeltaLinearStretchedBoundary: public SGPP::pde::UpDownOneOpDim {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationDeltaLinearStretchedBoundary(SGPP::base::GridStorage* storage, SGPP::base::DataVector& coef);
