...
namespace SGPP {
  namespace finance {
    ...
    void XPhidPhiUpBBLinearStretched::rec(SGPP::base::DataVector& source, SGPP::base::DataVector& result, grid_iterator& index, size_t dim, float_t& fl, float_t& fr) {
      ...
      float_t c = -1.0 / 6.0 * (posc + posl + posr);
