...
#ifndef PHIDPHIUPBBLINEARSTRETCHED_HPP
#define PHIDPHIUPBBLINEARSTRETCHED_HPP
 ...
 */
class PhidPhiUpBBLinearStretched {
 protected:
 ...
 public:
   ...
   */
  explicit PhidPhiUpBBLinearStretched(SGPP::base::GridStorage* storage);

  /**
   * Destructor
   */
  virtual ~PhidPhiUpBBLinearStretched();
