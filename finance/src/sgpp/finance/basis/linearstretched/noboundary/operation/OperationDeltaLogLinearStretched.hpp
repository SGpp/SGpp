...
#ifndef OPERATIONDELTALOGLINEARSTRETCHED_HPP
#define OPERATIONDELTALOGLINEARSTRETCHED_HPP
...
namespace sg {
  namespace finance {
     ...
     * @version $HEAD$
     */
    class OperationDeltaLogLinearStretched: public sg::pde::UpDownOneOpDim {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationDeltaLogLinearStretched(sg::base::GridStorage* storage, sg::base::DataVector& coef);

        /**
         * Destructor
         */
        virtual ~OperationDeltaLogLinearStretched();
...
#endif /* OPERATIONDELTALOGLINEARSTRETCHED_HPP */
