...
#ifndef OPERATIONHESTONFLINEARBOUNDARY_HPP
#define OPERATIONHESTONFLINEARBOUNDARY_HPP
...
namespace sg {
  namespace finance {
    ...
    /**
     * Implements the Heston F-Operation (corresponds to operator F in Master's thesis), that is needed
     * the solve the multidimensional Heston
     * equation.
     *
     * @version $HEAD$
     */
    class OperationHestonFLinearBoundary: public sg::pde::UpDownOneOpDim {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationHestonFLinearBoundary(sg::base::GridStorage* storage, sg::base::DataVector& coef);
...
#endif /* OPERATIONHESTONFLINEARBOUNDARY_HPP */
