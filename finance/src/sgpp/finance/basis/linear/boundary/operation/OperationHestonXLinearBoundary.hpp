...
#ifndef OPERATIONHESTONXLINEARBOUNDARY_HPP
#define OPERATIONHESTONXLINEARBOUNDARY_HPP
...
namespace SGPP {
  namespace finance {
     ...
     * @version $HEAD$
     */
    class OperationHestonXLinearBoundary : public SGPP::pde::UpDownTwoOpDims {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationHestonXLinearBoundary(SGPP::base::GridStorage* storage, SGPP::base::DataMatrix& coef);

        /**
         * Destructor
         */
        virtual ~OperationHestonXLinearBoundary();
...
#endif /* OPERATIONHESTONXLINEARBOUNDARY_HPP */