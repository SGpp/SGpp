...
#ifndef OPERATIONHESTONELINEARBOUNDARY_HPP
#define OPERATIONHESTONELINEARBOUNDARY_HPP
...
namespace SGPP {
  namespace finance {
    ...
    /**
     * Implements the Heston E-Operation (corresponds to operator E in Master's thesis), that is needed
     * the solve the multidimensional Heston
     * equation.
     *
     * @version $HEAD$
     */
    class OperationHestonELinearBoundary : public SGPP::pde::UpDownOneOpDim {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationHestonELinearBoundary(SGPP::base::GridStorage* storage, SGPP::base::DataVector& coef);
...
#endif /* OPERATIONHESTONELINEARBOUNDARY_HPP */