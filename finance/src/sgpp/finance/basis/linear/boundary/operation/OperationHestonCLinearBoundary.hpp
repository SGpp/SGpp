...
#ifndef OPERATIONHESTONCLINEARBOUNDARY_HPP
#define OPERATIONHESTONCLINEARBOUNDARY_HPP
...
namespace SGPP {
  namespace finance {
     ...
     * @version $HEAD$
     */
    class OperationHestonCLinearBoundary : public SGPP::pde::UpDownTwoOpDims {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationHestonCLinearBoundary(SGPP::base::GridStorage* storage, SGPP::base::DataMatrix& coef);

        /**
         * Destructor
         */
        virtual ~OperationHestonCLinearBoundary();
      ...
      protected:
        ...
        /**
         * This method does nothing (this situation doesn't come up in Heston's PDEs). Only required to make the class complete.
         *
         * @param alpha the coefficients of the gridpoints
         * @param result vector with the result of this operation
         * @param dim the dimension in that down-Gradient is applied
...
#endif /* OPERATIONHESTONCLINEARBOUNDARY_HPP */