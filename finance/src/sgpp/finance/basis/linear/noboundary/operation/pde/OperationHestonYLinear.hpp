...
#ifndef OPERATIONHESTONYLINEAR_HPP
#define OPERATIONHESTONYLINEAR_HPP
...
namespace SGPP {
  namespace finance {
    ...
    /**
     * Implements the Heston Y-Operation (corresponds to operator Y in Master's thesis), that is needed
     * the solve the multidimensional Heston
     * equation, on grids with fix Dirichlet-0-Boundaries.
     *
     * @version $HEAD$
     */
    class OperationHestonYLinear : public SGPP::pde::UpDownTwoOpDims {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationHestonYLinear(SGPP::base::GridStorage* storage, SGPP::base::DataMatrix& coef);

        /**
         * Destructor
         */
        virtual ~OperationHestonYLinear();
      ...
      protected:
        ...
        /**
         * down-Gradient step in dimension <i>dim</i> applies the sqX dphi dphi operation
         * in one dimension
         *
        ...
        /**
         * up-Gradient step in dimension <i>dim</i> applies the sqX dphi dphi operation
         * in one dimension
         *
         * @param alpha the coefficients of the gridpoints
         * @param result vector with the result of this operation
...
#endif /* OPERATIONHESTONYLINEAR_HPP */
