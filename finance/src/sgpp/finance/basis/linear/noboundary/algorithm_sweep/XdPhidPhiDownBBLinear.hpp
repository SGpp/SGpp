...
#ifndef XDPHIDPHIDOWNBBLINEAR_HPP
#define XDPHIDPHIDOWNBBLINEAR_HPP
...
class XdPhidPhiDownBBLinear {
 ...
 public:
   ...
   */
  explicit XdPhidPhiDownBBLinear(sgpp::base::GridStorage* storage);

  /**
   * Destructor
   */
  virtual ~XdPhidPhiDownBBLinear();
...
#endif /* XDPHIDPHIDOWNBBLINEAR_HPP */
