...
SqrtXPhiPhiDownBBLinear::SqrtXPhiPhiDownBBLinear(SGPP::base::GridStorage*
    storage) : storage(storage), boundingBox(storage->getBoundingBox()) {
}
...
void SqrtXPhiPhiDownBBLinear::rec(SGPP::base::DataVector& source,
  ...
  float_t diagResultTemp = e * iCu * hCu - 3 * e * iSq * hCu + 3 * e * i * hCu +
                           7 * d * iSq * hCu - c * iCu * hCu
                           - 3 * c * iSq * hCu - 3 * c * i * hCu - e * hCu - c * hCu;
  diagResultTemp = (-16.0 / 105.0) * (1.0 / (hSq)) * diagResultTemp;

  float_t downResultTemp = 2 * c * hCu * a + 5 * c * hCu * b + 4 * d * iCu * hCu *
                           b - 7 * d * iSq * hCu * b -
                           4 * d * iCu * hCu * a - 8 * e * hCu * a * i - 6 * e * hCu * b * i - 2 * e *
                           iCu * hCu * b +
                           6 * e * iSq * hCu * b + 2 * e * iCu * hCu * a + e * iSq * hCu * a + 5 * e *
                           hCu * a + 2 * e * hCu * b +
                           6 * c * hCu * a * i - 2 * c * iCu * hCu * b + c * iSq * hCu * b +
                           6 * c * iSq * hCu * a + 2 * c * iCu * hCu * a + 8 * c * i * hCu * b - 7 * d *
                           iSq * hCu * a;
...
void SqrtXPhiPhiDownBBLinear::recBB(SGPP::base::DataVector& source,
                                    SGPP::base::DataVector& result, grid_iterator& index, size_t dim, float_t fl,
  ...
  float_t diagResultTemp = e * iCu * hCu * qCu - 3 * e * iSq * hCu * qCu + 3 * e *
                           i * hCu * qCu
                           - 3 * e * tSq * q * h + 3 * e * t * qSq * hSq + 7 * d * tSq * q * h + 7 * d *
                           iSq * hCu * qCu
                           - c * iCu * hCu * qCu - 3 * c * iSq * hCu * qCu - 3 * c * i * hCu * qCu
                           - 3 * c * tSq * q * h - 3 * c * t * qSq * hSq + 3 * e * iSq * hSq * qSq * t
                           + 3 * e * i * h * q * tSq - 6 * e * i * hSq * qSq * t + 14 * d * t * qSq * hSq *
                           i
                           - 3 * c * iSq * hSq * qSq * t - 3 * c * i * h * q * tSq - 6 * c * i * hSq *
                           qSq * t
                           + e * tCu - c * tCu - e * qCu * hCu - c * qCu * hCu;

  diagResultTemp = (-16.0 / 105.0) * (1.0 / (qSq * hSq)) * diagResultTemp;

  float_t downResultTemp = 2 * c * qCu * hCu * a + 5 * c * qCu * hCu * b - 14 *
                           d * i * hSq * qSq * a * t
                           + 6 * c * a * tSq * i * h * q - 6 * c * b * tSq * i * h * q + 6 * c * iSq *
                           hSq * qSq * a * t
                           + 12 * c * i * hSq * qSq * a * t - 6 * c * iSq * hSq * qSq * b * t + 2 * c * i *
                           hSq * qSq * b * t
                           + 2 * e * a * tCu - 2 * e * b * tCu + 4 * d * b * tCu - 4 * d * a * tCu
                           + 4 * d * iCu * hCu * qCu * b - 7 * d * iSq * hCu * qCu * b - 4 * d * iCu *
                           hCu * qCu * a - 7 * d * tSq * b * q * h
                           - 8 * e * qCu * hCu * a * i - 8 * e * qSq * hSq * a * t - 6 * e * qCu * hCu *
                           b * i
                           - 6 * e * qSq * hSq * b * t + 6 * e * b * tSq * q * h + e * a * tSq * q * h
                           - 2 * e * iCu * hCu * qCu * b + 6 * e * iSq * hCu * qCu * b + 2 * e * iCu *
                           hCu * qCu * a
                           + e * iSq * hCu * qCu * a + 5 * e * qCu * hCu * a + 2 * e * qCu * hCu * b
                           - 14 * d * i * hSq * qSq * b * t + 6 * e * iSq * hSq * qSq * a * t + 6 * e * i *
                           h * q * a * tSq
                           + 2 * e * i * hSq * qSq * a * t - 6 * e * iSq * hSq * qSq * b * t - 6 * e * i *
                           h * q * b * tSq
                           + 12 * e * i * hSq * qSq * b * t + 12 * d * iSq * hSq * qSq * b * t + 12 * d *
                           i * h * q * b * tSq
                           - 12 * d * iSq * hSq * qSq * a * t - 12 * d * i * h * q * a * tSq + 2 * c * a *
                           tCu - 2 * c * b * tCu
                           + 6 * c * a * tSq * q * h + c * b * tSq * q * h + 6 * c * qCu * hCu * a * i
                           + 6 * c * qSq * hSq * a * t - 2 * c * iCu * hCu * qCu * b + c * iSq * hCu *
                           qCu * b
                           + 6 * c * iSq * hCu * qCu * a + 2 * c * iCu * hCu * qCu * a + 8 * c * t * b *
                           qSq * hSq
                           + 8 * c * i * hCu * qCu * b - 7 * d * iSq * hCu * qCu * a - 7 * d * tSq * a *
                           q * h;
