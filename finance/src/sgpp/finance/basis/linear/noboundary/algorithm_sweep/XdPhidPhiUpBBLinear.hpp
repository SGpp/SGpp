...
#ifndef XDPHIDPHIUPBBLINEAR_HPP
#define XDPHIDPHIUPBBLINEAR_HPP
...
class XdPhidPhiUpBBLinear {
 ...
 public:
   ...
   */
  explicit XdPhidPhiUpBBLinear(sgpp::base::GridStorage* storage);

  /**
   * Destructor
   */
  virtual ~XdPhidPhiUpBBLinear();
