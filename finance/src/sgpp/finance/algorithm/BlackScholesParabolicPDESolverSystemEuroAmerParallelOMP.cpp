...
namespace SGPP {
  namespace finance {
    ...
    BlackScholesParabolicPDESolverSystemEuroAmerParallelOMP::BlackScholesParabolicPDESolverSystemEuroAmerParallelOMP(SGPP::base::Grid& SparseGrid, SGPP::base::DataVector& alpha, SGPP::base::DataVector& mu,
    ...
    void BlackScholesParabolicPDESolverSystemEuroAmerParallelOMP::applyLOperatorInner(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      result.setAll(0.0);
    ...
    void BlackScholesParabolicPDESolverSystemEuroAmerParallelOMP::applyLOperatorComplete(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      result.setAll(0.0);
    ...
    void BlackScholesParabolicPDESolverSystemEuroAmerParallelOMP::applyMassMatrixInner(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
    ...
    void BlackScholesParabolicPDESolverSystemEuroAmerParallelOMP::applyMassMatrixComplete(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      SGPP::base::DataVector temp(alpha.getSize());
    ...
    void BlackScholesParabolicPDESolverSystemEuroAmerParallelOMP::mult(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
