...
void writeHelp() {
  ...
  mySStream << "                  xi_i theta_i kappa_i rho(Si,S1) rho(Si,v1) ... rho(Si,Si) rho(Si,vi) ... rho(Si,SM) rho(Si,vM)" << std::endl;
  mySStream << "                  					 rho(vi,S1) rho(vi,v1) ... rho(vi,Si) rho(vi,vi) ... rho(vi,SM) rho(vi,vM)" << std::endl;
  ...
  mySStream << "	dim: the number of assets (half the number of dimensions of Sparse Grid)" << std::endl;
  ...
  mySStream << "cart 2 5 " << "bound.data stoch.data 1.0 std_euro_call " << "0.05 " << "1.0 " << "0.01 ImEul " << "400 " << "0.000001" << std::endl;
  mySStream << std::endl;
