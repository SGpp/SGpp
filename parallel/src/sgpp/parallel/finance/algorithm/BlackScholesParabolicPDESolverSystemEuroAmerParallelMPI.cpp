...
namespace SGPP {
  namespace parallel {
    ...
    BlackScholesParabolicPDESolverSystemEuroAmerParallelMPI::BlackScholesParabolicPDESolverSystemEuroAmerParallelMPI(SGPP::base::Grid& SparseGrid, SGPP::base::DataVector& alpha, SGPP::base::DataVector& mu,
        SGPP::base::DataVector& sigma, SGPP::base::DataMatrix& rho, double r, double TimestepSize, std::string OperationMode, double dStrike, std::string option_type,
        bool bLogTransform, bool useCoarsen, double coarsenThreshold, std::string adaptSolveMode,
        int numCoarsenPoints, double refineThreshold, std::string refineMode, SGPP::base::GridIndex::level_type refineMaxLevel) : BlackScholesParabolicPDESolverSystemEuroAmer(SparseGrid, alpha, mu, sigma, rho,
    ...
    void BlackScholesParabolicPDESolverSystemEuroAmerParallelMPI::applyLOperatorInner(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      result.setAll(0.0);
    ...
    void BlackScholesParabolicPDESolverSystemEuroAmerParallelMPI::applyLOperatorComplete(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      result.setAll(0.0);
    ...
    void BlackScholesParabolicPDESolverSystemEuroAmerParallelMPI::applyMassMatrixInner(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
    ...
    void BlackScholesParabolicPDESolverSystemEuroAmerParallelMPI::applyMassMatrixComplete(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      SGPP::base::DataVector temp(alpha.getSize());
      result.setAll(0.0);
      size_t nDims = this->InnerGrid->getStorage()->getAlgorithmicDimensions().size();
      size_t jobs = (((nDims * nDims) + 3 * nDims) / 2) + 2;
    ...
    void BlackScholesParabolicPDESolverSystemEuroAmerParallelMPI::mult(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
