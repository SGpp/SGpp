...
namespace SGPP {
  namespace parallel {
     ...
     */
    class BlackScholesParabolicPDESolverSystemEuroAmerParallelMPI : public SGPP::finance::BlackScholesParabolicPDESolverSystemEuroAmer {
      protected:
      ...
      public:
         ...
         */
        BlackScholesParabolicPDESolverSystemEuroAmerParallelMPI(SGPP::base::Grid& SparseGrid, SGPP::base::DataVector& alpha, SGPP::base::DataVector& mu, SGPP::base::DataVector& sigma,
