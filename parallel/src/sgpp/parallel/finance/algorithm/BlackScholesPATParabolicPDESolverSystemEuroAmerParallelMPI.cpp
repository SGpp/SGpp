...
namespace SGPP {
  namespace parallel {
    ...
    BlackScholesPATParabolicPDESolverSystemEuroAmerParallelMPI::BlackScholesPATParabolicPDESolverSystemEuroAmerParallelMPI(SGPP::base::Grid& SparseGrid, SGPP::base::DataVector& alpha, SGPP::base::DataVector& lambda,
    ...
    void BlackScholesPATParabolicPDESolverSystemEuroAmerParallelMPI::applyLOperatorInner(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      result.setAll(0.0);
    ...
    void BlackScholesPATParabolicPDESolverSystemEuroAmerParallelMPI::applyLOperatorComplete(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      result.setAll(0.0);
    ...
    void BlackScholesPATParabolicPDESolverSystemEuroAmerParallelMPI::applyMassMatrixInner(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
    ...
    void BlackScholesPATParabolicPDESolverSystemEuroAmerParallelMPI::applyMassMatrixComplete(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      SGPP::base::DataVector temp(alpha.getSize());
      result.setAll(0.0);
      size_t nDims = this->InnerGrid->getStorage()->getAlgorithmicDimensions().size();
    ...
    void BlackScholesPATParabolicPDESolverSystemEuroAmerParallelMPI::mult(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
