 ...
 */
class BlackScholesPATParabolicPDESolverSystemEuroAmerParallelMPI : public
  SGPP::finance::BlackScholesPATParabolicPDESolverSystemEuroAmer {
 protected:
 ...
 public:
  ...
  BlackScholesPATParabolicPDESolverSystemEuroAmerParallelMPI(
    ...
    bool useCoarsen = false, double coarsenThreshold = 0.0,
