...
size_t TwoPartitionAutoTuning::getProblemSize() { return _problemSize; }
...
void TwoPartitionAutoTuning::doTune() {
  ...
  std::cout << "AUTOTUNING-PARTITION-SIZES (" << std::setw(8) << _problemSize
            ...
            << " Time1: " << _timePartition1 << " Size1: " << std::setw(8) << getPartition1Size()
            << std::setprecision(1) << "("
            << 100.0 * static_cast<double>(getPartition1Size()) / static_cast<double>(_problemSize)
            << "%); ";
  std::cout << " Time2: " << std::setprecision(3) << _timePartition2 << " Size2: " << std::setw(8)
            << _problemSize - getPartition1Size() << std::setprecision(1) << " ("
            << 100.0 * static_cast<double>(_problemSize - getPartition1Size()) /
