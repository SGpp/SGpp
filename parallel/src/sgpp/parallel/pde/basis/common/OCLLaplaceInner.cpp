  ...
  namespace parallel {
    namespace oclpdekernels {
      ...
      std::string InnerGradientFunction() {
        ...
        stream_program_src << "ulong doGrad = (ulong)((i_level == j_level) && (i_index == j_index));	"  << std::endl;
      ...
      Timing PrintGFLOPSLaplaceInner() {
        ...
        if (!isFirstTimeLaplaceInner) {
          std::cout << "Overall Runtime of AllReduceLaplaceInner: " << LaplaceInnerAllReduceTime << std::endl;
