...
namespace SGPP {
  namespace parallel {
    namespace oclpdekernels {
      ...
      extern cl_mem d_ptrLevelIndexLevelintconBound[NUMDEVS]; // constant memory buffer holding all three components
      ...
      extern REAL* ptrLevelIndexLevelintBound;  // for the constant memory buffer holding all three components
