...
namespace SGPP {
  namespace parallel {
    ...
    OperationLaplaceVectorizedLinearBoundary::OperationLaplaceVectorizedLinearBoundary(SGPP::base::GridStorage* storage)
      :
      storage(storage),
      level_(NULL),
      level_int_(NULL),
    ...
    OperationLaplaceVectorizedLinearBoundary::OperationLaplaceVectorizedLinearBoundary(SGPP::base::GridStorage* storage, SGPP::base::DataVector& lambda)
      :
      storage(storage),
      level_(NULL),
      level_int_(NULL),
...
#pragma prefetch
    ...
    void OperationLaplaceVectorizedLinearBoundary::mult(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      result.setAll(0.0);
