...
namespace sg {
  namespace parallel {
     ...
     * @version $HEAD$
     */
    class OperationLTwoDotProductVectorizedLinearBoundary: public sg::base::OperationMatrix {
      private:
      ...
      public:
         ...
         */
        OperationLTwoDotProductVectorizedLinearBoundary(sg::base::GridStorage* storage);
