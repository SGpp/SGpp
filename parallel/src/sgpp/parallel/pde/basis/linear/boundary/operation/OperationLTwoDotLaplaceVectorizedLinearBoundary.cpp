...
namespace SGPP {
  namespace parallel {
    ...
    OperationLTwoDotLaplaceVectorizedLinearBoundary::OperationLTwoDotLaplaceVectorizedLinearBoundary(SGPP::base::GridStorage* storage)
      :
      storage(storage),
      level_(NULL),
      level_int_(NULL),
    ...
    OperationLTwoDotLaplaceVectorizedLinearBoundary::OperationLTwoDotLaplaceVectorizedLinearBoundary(SGPP::base::GridStorage* storage, SGPP::base::DataVector& lambda)
      :
      storage(storage),
      level_(NULL),
      level_int_(NULL),
    ...
    void OperationLTwoDotLaplaceVectorizedLinearBoundary::mult_dirichlet(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
...
#pragma prefetch
    ...
    void OperationLTwoDotLaplaceVectorizedLinearBoundary::mult(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
      result.setAll(0.0);
