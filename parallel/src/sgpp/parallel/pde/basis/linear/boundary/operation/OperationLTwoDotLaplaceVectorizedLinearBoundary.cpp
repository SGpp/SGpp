...
#endif
{
  std::cout << "IN CONSTRUCTOR: OperationLTwoDotLaplaceVectorizedLinearBoundary"
            << std::endl;
  init_constants();
  init_grid_storage();
...
double OperationLTwoDotLaplaceVectorizedLinearBoundary::gradient_dirichlet(
...
double OperationLTwoDotLaplaceVectorizedLinearBoundary::l2dot_dirichlet(
  size_t i, size_t j, size_t dim) {
...
void OperationLTwoDotLaplaceVectorizedLinearBoundary::mult(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
  result.setAll(0.0);
