...
void HeatEquationParabolicPDESolverSystemParallelMPI::coarsenAndRefine(
  bool isLastTimestep) {
}
...
void HeatEquationParabolicPDESolverSystemParallelMPI::mult(
  SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
...
HeatEquationParabolicPDESolverSystemParallelMPI::generateRHS() {
  // distribute the current grid coefficients
