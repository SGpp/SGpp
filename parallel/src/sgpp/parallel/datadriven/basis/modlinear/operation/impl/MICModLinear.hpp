  ...
  static inline void multImpl(
    ...
    for (size_t i = start_index_data; i < end_index_data;
      ...
      for (size_t j = start_index_grid; j < end_index_grid; j++) {
        __m512d support_0 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                              _MM_BROADCAST_1X8, _MM_HINT_NONE);
        __m512d support_1 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                              _MM_BROADCAST_1X8, _MM_HINT_NONE);
        __m512d support_2 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                              _MM_BROADCAST_1X8, _MM_HINT_NONE);
#if  ( MIC_UNROLLING_WIDTH >  24 )
        __m512d support_3 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                              _MM_BROADCAST_1X8, _MM_HINT_NONE);
#endif
#if  ( MIC_UNROLLING_WIDTH >  32 )
        __m512d support_4 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                              _MM_BROADCAST_1X8, _MM_HINT_NONE);
        __m512d support_5 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                              _MM_BROADCAST_1X8, _MM_HINT_NONE);
#endif
#if  ( MIC_UNROLLING_WIDTH >  48 )
        __m512d support_6 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                              _MM_BROADCAST_1X8, _MM_HINT_NONE);
        __m512d support_7 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                              _MM_BROADCAST_1X8, _MM_HINT_NONE);
#endif
#if  ( MIC_UNROLLING_WIDTH >  64 )
        __m512d support_8 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                              _MM_BROADCAST_1X8, _MM_HINT_NONE);
#endif
#if  ( MIC_UNROLLING_WIDTH >  72 )
        __m512d support_9 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                              _MM_BROADCAST_1X8, _MM_HINT_NONE);
#endif
#if  ( MIC_UNROLLING_WIDTH >  80 )
        __m512d support_10 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                               _MM_BROADCAST_1X8, _MM_HINT_NONE);
        __m512d support_11 = _mm512_extload_pd(&(ptrAlpha[j]), _MM_UPCONV_PD_NONE,
                                               _MM_BROADCAST_1X8, _MM_HINT_NONE);
#endif
        ...
        for (size_t d = 0; d < dims - 1; d++) {
          ...
          // all other basis functions
            ...
            eval_0 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                         _mm512_castpd_si512(eval_0)));
            eval_1 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                         _mm512_castpd_si512(eval_1)));
            eval_2 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                         _mm512_castpd_si512(eval_2)));
#if  ( MIC_UNROLLING_WIDTH >  24 )
            eval_3 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                         _mm512_castpd_si512(eval_3)));
#endif
#if  ( MIC_UNROLLING_WIDTH >  32 )
            eval_4 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                         _mm512_castpd_si512(eval_4)));
            eval_5 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                         _mm512_castpd_si512(eval_5)));
#endif
#if  ( MIC_UNROLLING_WIDTH >  48 )
            eval_6 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                         _mm512_castpd_si512(eval_6)));
            eval_7 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                         _mm512_castpd_si512(eval_7)));
#endif
#if  ( MIC_UNROLLING_WIDTH >  64 )
            eval_8 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                         _mm512_castpd_si512(eval_8)));
#endif
#if  ( MIC_UNROLLING_WIDTH >  72 )
            eval_9 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                         _mm512_castpd_si512(eval_9)));
#endif
#if  ( MIC_UNROLLING_WIDTH >  80 )
            eval_10 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
                                          _mm512_castpd_si512(eval_10)));
            eval_11 = _mm512_castsi512_pd(_mm512_and_epi64( abs2MaskLRBni,
