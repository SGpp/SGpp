...
void arbb_multTrans(const arbb::dense< arbb::array<fp_Type, 10>, 1 >& Data,
  ...
  struct local {
    static void evalGridPointTrans(const arbb::dense< arbb::array<fp_Type, 10>, 1 >&
                                   Data, const arbb::array<fp_Type, 10>& Level,
                                   const arbb::array<fp_Type, 10>& Index, const arbb::dense<fp_Type>& source,
                                   fp_Type& result) {
      result = 0.0;
...
double ArBBKernels10D::multTransArBB(double* ptrSource, double* ptrData,
  ...
  try {
    ...
    arbb::call(&(arbb_multTrans<arbb::f64>))(ArBB_Data_10D, ArBB_Level_10D,
        ArBB_Index_10D, ArBB_source, ArBB_result);
...
double ArBBKernels10D::multArBB(double* ptrAlpha, double* ptrData,
  ...
  try {
    ...
    arbb::call(&(arbb_mult<arbb::f64>))(ArBB_Data_10D, ArBB_Level_10D,
                                        ArBB_Index_10D, ArBB_alpha, ArBB_result);
  } catch (const std::exception& e) {
    std::cout << "Error using Intel ArBB: " << e.what() << std::endl;
  }
...
double ArBBKernels10D::multTransSPArBB(float* ptrSource, float* ptrData,
  ...
  try {
    ...
    arbb::call(&(arbb_multTrans<arbb::f32>))(ArBB_DataSP_10D, ArBB_LevelSP_10D,
        ArBB_IndexSP_10D, ArBB_source, ArBB_result);
  } catch (const std::exception& e) {
    std::cout << "Error using Intel ArBB: " << e.what() << std::endl;
  }
...
double ArBBKernels10D::multSPArBB(float* ptrAlpha, float* ptrData,
  ...
  try {
    ...
    arbb::call(&(arbb_mult<arbb::f32>))(ArBB_DataSP_10D, ArBB_LevelSP_10D,
                                        ArBB_IndexSP_10D, ArBB_alpha, ArBB_result);
  } catch (const std::exception& e) {
    std::cout << "Error using Intel ArBB: " << e.what() << std::endl;
  }
