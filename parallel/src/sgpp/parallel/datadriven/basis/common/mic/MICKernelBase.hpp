...
#if (MIC_UNROLLING_WIDTH != 24) && (MIC_UNROLLING_WIDTH != 32) && (MIC_UNROLLING_WIDTH != 48) && \
    (MIC_UNROLLING_WIDTH != 64) && (MIC_UNROLLING_WIDTH != 72) && (MIC_UNROLLING_WIDTH != 80) && \
...
#if (MIC_UNROLLING_WIDTH_SP != 48) && (MIC_UNROLLING_WIDTH_SP != 64) &&   \
    (MIC_UNROLLING_WIDTH_SP != 96) && (MIC_UNROLLING_WIDTH_SP != 128) &&  \
    (MIC_UNROLLING_WIDTH_SP != 144) && (MIC_UNROLLING_WIDTH_SP != 160) && \
...
class MICKernelBase {
 public:
  ...
  static inline size_t getChunkDataPoints() { return MIC_UNROLLING_WIDTH; }
};

class SPMICKernelBase {
 public:
  static inline size_t getChunkGridPoints() { return 24; }
