    ...
    signal(&(finished[d]))
        {
          ...
          #pragma omp parallel // this parallel section is run on mic, using the hardwarethreads available there
          {
            ...
            MICImplementation::multImpl(mic::ptrLevel, mic::ptrIndex, mic::ptrMask,
    ...
    if (tid == 0) {
      ...
      for (size_t d = 0; d < mic::number_mic_devices;
        ...
        PartitioningTool::getPartitionSegment(start_index_grid, end_index_grid_mic,
                                              mic::number_mic_devices, d, &(start_indexes_grid_micdev[d]),
    ...
    signal(&(finished[d]))
        {
          ...
          #pragma omp parallel // this parallel section is run on mic, using the hardwarethreads available there
          {
            ...
            MICImplementation::multTransposeImpl(mic::ptrLevel, mic::ptrIndex, mic::ptrMask,
                                                 mic::ptrOffset, mic::ptrData, mic::ptrDataMic, mic::ptrAlphaMic,
