  ...
  static inline void multTransposeImpl(double* ptrLevel, double* ptrIndex,
    ...
    for (size_t i = start_index_data; i < end_index_data; i += getChunkDataPoints()) {
      ...
      for (size_t d = 0; d < dims; d++) {
        ...
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 0]),
                     _MM_HINT_T0);
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 8]),
                     _MM_HINT_T0);
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 16]),
                     _MM_HINT_T0);
...
#if (MIC_UNROLLING_WIDTH > 24)
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 24]),
                     _MM_HINT_T0);
#endif
#if (MIC_UNROLLING_WIDTH > 32)
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 32]),
                     _MM_HINT_T0);
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 40]),
                     _MM_HINT_T0);
#endif
        __m512d one = _mm512_set_1to8_pd(1.0);
        __m512d zero = _mm512_set_1to8_pd(0.0);
...
#endif
#if (MIC_UNROLLING_WIDTH > 48)
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 48]),
                     _MM_HINT_T0);
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 56]),
                     _MM_HINT_T0);
#endif
#if (MIC_UNROLLING_WIDTH > 64)
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 64]),
                     _MM_HINT_T0);
#endif
...
#if (MIC_UNROLLING_WIDTH > 72)
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 72]),
                     _MM_HINT_T0);
#endif
#if (MIC_UNROLLING_WIDTH > 80)
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 80]),
                     _MM_HINT_T0);
        _mm_prefetch((const char*)&(ptrData[(d * sourceSize) + i + MIC_UNROLLING_WIDTH + 88]),
                     _MM_HINT_T0);
