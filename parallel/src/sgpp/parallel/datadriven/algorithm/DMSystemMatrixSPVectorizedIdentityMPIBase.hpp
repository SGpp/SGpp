...
class DMSystemMatrixSPVectorizedIdentityMPIBase : public
 ...
 public:
  DMSystemMatrixSPVectorizedIdentityMPIBase(SGPP::base::Grid& SparseGrid,
    ...
    this->numPatchedTrainingInstances_ =
      SGPP::parallel::DMVectorizationPaddingAssistant::padDataset(*(this->dataset_),
          vecMode_);
    std::cout << "Padding Dataset to " << numPatchedTrainingInstances_ <<
              " Instances. " << std::endl;
    this->tempData = new SGPP::base::DataVectorSP(
      this->numPatchedTrainingInstances_);
  ...
  virtual void rebuildLevelAndIndex() {
    LevelIndexMaskOffsetHelperSP::rebuild<KernelImplementation::kernelType, DMSystemMatrixSPVectorizedIdentityMPIBase<KernelImplementation> >
    (this);
