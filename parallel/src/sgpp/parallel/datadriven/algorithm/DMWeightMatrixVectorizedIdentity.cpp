...
DMWeightMatrixVectorizedIdentity::DMWeightMatrixVectorizedIdentity(
  ...
  this->B = SGPP::op_factory::createOperationMultipleEvalVectorized(SparseGrid,
...
void DMWeightMatrixVectorizedIdentity::generateb(SGPP::base::DataVector&
...
void DMWeightMatrixVectorizedIdentity::getTimers(double& timeMult,
