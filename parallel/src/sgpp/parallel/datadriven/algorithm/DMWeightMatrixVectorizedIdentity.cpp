...
void DMWeightMatrixVectorizedIdentity::rebuildLevelAndIndex() { this->B->rebuildLevelAndIndex(); }
...
void DMWeightMatrixVectorizedIdentity::getTimers(double& timeMult, double& computeMult,
