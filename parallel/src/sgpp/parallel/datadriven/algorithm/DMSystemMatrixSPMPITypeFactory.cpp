...
datadriven::DMSystemMatrixBaseSP*
DMSystemMatrixSPMPITypeFactory::createDMSystemMatrixMPITypeSP(base::Grid& grid,
    base::DataMatrixSP& trainDataset, float lambda, VectorizationType vecType,
    MPIType mpiType) {
  ...
  switch (mpiType) {
    case MPIAllreduce:
      ...
      result = new
      SGPP::parallel::DMSystemMatrixSPVectorizedIdentityAllreduce<KernelImplementation>
      (
    ...
    case MPIAlltoallv:
      ...
      result = new SGPP::parallel::DMSystemMatrixSPVectorizedIdentityMPI(grid,
    ...
    case MPIAsync:
      ...
      result = new
      SGPP::parallel::DMSystemMatrixSPVectorizedIdentityAsyncMPI<KernelImplementation>
      (
        grid, trainDataset, lambda, vecType);
      break;
    ...
    case MPITrueAsync:
      ...
      result = new
      SGPP::parallel::DMSystemMatrixSPVectorizedIdentityTrueAsyncMPI<KernelImplementation>
      (
        grid, trainDataset, lambda, vecType);
      break;
    ...
    case MPIOnesided:
      ...
      result = new
      SGPP::parallel::DMSystemMatrixSPVectorizedIdentityOnesidedMPI<KernelImplementation>
      (
        grid, trainDataset, lambda, vecType);
      break;
    ...
    case MPIBigdata:
      ...
      result = new
      SGPP::parallel::DMSystemMatrixSPVectorizedIdentityBigdataAllreduce<KernelImplementation>
      (
        grid, trainDataset, lambda, vecType);
      break;
    ...
    case MPINone:
      ...
      result = new SGPP::parallel::DMSystemMatrixSPVectorizedIdentity(grid,
          trainDataset, lambda, vecType);
      break;
...
datadriven::DMSystemMatrixBaseSP*
DMSystemMatrixSPMPITypeFactory::getDMSystemMatrixSP(base::Grid& grid,
    base::DataMatrixSP& trainDataset, float lambda, VectorizationType vecType,
    MPIType mpiType) {
  ...
  if (strcmp(grid.getType(), "linear") == 0
    ...
    if (vecType == parallel::X86SIMD) {
      ...
      return new SGPP::parallel::DMSystemMatrixSPVectorizedIdentityMPI(grid,
             trainDataset, lambda, vecType);
    }
