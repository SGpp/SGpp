...
class DMSystemMatrixSPVectorizedIdentityTrueAsyncMPI : public
 ...
 public:
  ...
  virtual void mult(SGPP::base::DataVectorSP& alpha,
    ...
    myGlobalMPIComm->IrecvFromAllSP(ptrTemp, 1, _mpi_data_sizes, _mpi_data_offsets,
  ...
  virtual void generateb(SGPP::base::DataVectorSP& classes,
    ...
    this->computeTimeMultTrans_ += this->myTimer_->stop();
    SGPP::parallel::myGlobalMPIComm->dataVectorSPAllToAll(b, _mpi_grid_offsets,
        _mpi_grid_sizes);
    this->completeTimeMultTrans_ += this->myTimer_->stop();
  }
