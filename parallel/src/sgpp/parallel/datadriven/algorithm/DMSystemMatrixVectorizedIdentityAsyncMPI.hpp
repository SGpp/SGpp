...
class DMSystemMatrixVectorizedIdentityAsyncMPI : public
 ...
 public:
  ...
  virtual void mult(SGPP::base::DataVector& alpha,
    ...
    SGPP::parallel::myGlobalMPIComm->IrecvFromAll(ptrTemp, _chunkCountPerProcData,
    ...
    SGPP::parallel::myGlobalMPIComm->IrecvFromAll(ptrResult, _chunkCountPerProcGrid,
        _mpi_grid_sizes, _mpi_grid_offsets, tagsGrid, gridRecvReqs);
  ...
  virtual void generateb(SGPP::base::DataVector& classes,
    ...
    SGPP::parallel::myGlobalMPIComm->IrecvFromAll(ptrB, _chunkCountPerProcGrid,
    ...
    #pragma omp parallel
    {
      ...
      for (size_t chunkIndex = myGridChunkStart; chunkIndex < myGridChunkEnd;
        ...
        #pragma omp master // the non-sending processes can already continue with execution
        {
          myGlobalMPIComm->IsendToAll(&ptrB[start], _mpi_grid_sizes[chunkIndex],
