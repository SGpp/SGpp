...
DMSystemMatrixVectorizedIdentityMPI::DMSystemMatrixVectorizedIdentityMPI(
  ...
  this->B_ = SGPP::op_factory::createOperationMultipleEvalVectorized(m_grid,
...
void DMSystemMatrixVectorizedIdentityMPI::generateb(SGPP::base::DataVector&
...
void DMSystemMatrixVectorizedIdentityMPI::multVec(base::DataVector& alpha,
  ...
  SGPP::parallel::myGlobalMPIComm->dataVectorAllToAll(result, _mpi_data_offsets,
      _mpi_data_sizes);
...
void DMSystemMatrixVectorizedIdentityMPI::multTransposeVec(
  ...
  SGPP::parallel::myGlobalMPIComm->dataVectorAllToAll(result, _mpi_grid_offsets,
      _mpi_grid_sizes);
