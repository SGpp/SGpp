...
namespace SGPP {
  namespace parallel {
    ...
    class DMSystemMatrixVectorizedIdentityTrueAsyncMPI : public SGPP::parallel::DMSystemMatrixVectorizedIdentityMPIBase<KernelImplementation> {
      private:
      ...
      public:
         ...
         */
        DMSystemMatrixVectorizedIdentityTrueAsyncMPI(SGPP::base::Grid& SparseGrid, SGPP::base::DataMatrix& trainData, double lambda, VectorizationType vecMode)
          ...
          SGPP::parallel::PartitioningTool::calcDistribution(this->numPatchedTrainingInstances_, mpi_size, _mpi_data_sizes, _mpi_data_offsets, SGPP::parallel::DMVectorizationPaddingAssistant::getVecWidth(this->vecMode_));
        ...
        virtual void mult(SGPP::base::DataVector& alpha, SGPP::base::DataVector& result) {
          ...
          #pragma omp parallel
          {
            ...
            #pragma omp master
            {
              SGPP::parallel::myGlobalMPIComm->IsendToAll(&ptrTemp[dataProcessChunkStart], _mpi_data_sizes[mpi_myrank],
        ...
        virtual void generateb(SGPP::base::DataVector& classes, SGPP::base::DataVector& b) {
          ...
          this->computeTimeMultTrans_ += this->myTimer_->stop();
          SGPP::parallel::myGlobalMPIComm->dataVectorAllToAll(b, _mpi_grid_offsets, _mpi_grid_sizes);
          this->completeTimeMultTrans_ += this->myTimer_->stop();
        }
