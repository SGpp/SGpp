...
LearnerVectorizedIdentity::LearnerVectorizedIdentity(const VectorizationType
    vecType, const bool isRegression, const bool verbose)
  : SGPP::datadriven::LearnerBase(isRegression, verbose), vecType_(vecType),
    mpiType_(MPINone) {
}

LearnerVectorizedIdentity::LearnerVectorizedIdentity(const VectorizationType
    vecType, const MPIType mpiType, const bool isRegression, const bool verbose)
  : SGPP::datadriven::LearnerBase(isRegression, verbose), vecType_(vecType),
    mpiType_(mpiType) {
}

LearnerVectorizedIdentity::LearnerVectorizedIdentity(const std::string
    tGridFilename, const std::string tAlphaFilename,
...
#ifndef USE_MPI
  return new SGPP::parallel::DMSystemMatrixVectorizedIdentity(*(this->grid_),
...
void LearnerVectorizedIdentity::postProcessing(const SGPP::base::DataMatrix&
...
SGPP::base::DataVector LearnerVectorizedIdentity::predict(
  ...
  SGPP::parallel::OperationMultipleEvalVectorized* MultEval =
    SGPP::op_factory::createOperationMultipleEvalVectorized(*grid_, vecType_,
        &tmpDataSet);
