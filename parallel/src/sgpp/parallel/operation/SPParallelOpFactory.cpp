...
parallel::OperationMultipleEvalVectorizedSP* createOperationMultipleEvalVectorizedSP(
    base::Grid& grid, const parallel::VectorizationType& vecType, base::DataMatrixSP* dataset,
  ...
  if (grid.getType() == base::GridType::Linear) {
    if (vecType == parallel::X86SIMD) {
      return new parallel::OperationMultipleEvalIterativeSP<
          parallel::SPCPUKernel<parallel::SPX86SimdLinear> >(&grid.getStorage(), dataset, gridFrom,
      ...
      return new parallel::OperationMultipleEvalIterativeSP<
          parallel::SPOCLCPUHybridKernel<parallel::SPX86SimdLinear, parallel::OCLLinear<float> > >(
          &grid.getStorage(), dataset, gridFrom, gridTo, datasetFrom, datasetTo);
    ...
    if (vecType == parallel::X86SIMD) {
      ...
      if (strcmp(modlinear_mode, "orig") == 0) {
        return new parallel::OperationMultipleEvalIterativeSP<parallel::SPOCLCPUHybridKernel<
      ...
      if (strcmp(modlinear_mode, "orig") == 0) {
        return new parallel::OperationMultipleEvalIterativeSP<
            parallel::SPMICKernel<parallel::SPMICModLinear> >(&grid.getStorage(), dataset, gridFrom,
                                                              gridTo, datasetFrom, datasetTo);
      } else if (strcmp(modlinear_mode, "mask") == 0) {
        return new parallel::OperationMultipleEvalIterativeSP<
      ...
      if (strcmp(modlinear_mode, "orig") == 0) {
        return new parallel::OperationMultipleEvalIterativeSP<parallel::SPMICCPUHybridKernel<
