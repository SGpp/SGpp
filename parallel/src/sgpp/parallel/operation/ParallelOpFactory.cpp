...
createOperationMultipleEvalVectorized(base::Grid& grid,
  ...
  if (grid.getType() == base::GridType::Linear) {
    if (vecType == parallel::X86SIMD) {
      ...
      return new parallel::OperationMultipleEvalIterativeArBBLinear(grid.getStorage(),
             dataset);
    }
...
base::OperationMatrix* createOperationLTwoDotProductVectorized(base::Grid& grid,
  ...
  if (grid.getType() == base::GridType::Linear) {
    if (vecType == parallel::X86SIMD) {
      ...
      return new parallel::OperationLTwoDotProductVectorizedLinearOCL(
               grid.getStorage());
#endif
    } else {
      throw base::factory_exception("Unsupported vectorization type");
             ...
             || grid.getType() == base::GridType::LinearBoundary) {
    if (vecType == parallel::X86SIMD) {
      return new parallel::OperationLTwoDotProductVectorizedLinearBoundary(
               grid.getStorage());
#ifdef USEOCL
    } else if (vecType == parallel::OpenCL) {
      return new parallel::OperationLTwoDotProductVectorizedLinearBoundaryOCL(
               grid.getStorage());
#endif
    } else {
      throw base::factory_exception("Unsupported vectorization type");
...
createOperationLTwoDotLaplaceVectorized(base::Grid& grid,
  ...
  if (grid.getType() == base::GridType::Linear) {
    if (vecType == parallel::X86SIMD) {
      ...
      return new parallel::OperationLTwoDotLaplaceVectorizedLinearOCL(
      ...
      throw base::factory_exception("Unsupported vectorization type");
             ...
             || grid.getType() == base::GridType::LinearBoundary) {
    if (vecType == parallel::X86SIMD) {
      return new parallel::OperationLTwoDotLaplaceVectorizedLinearBoundary(
               grid.getStorage(), lambda);
#ifdef USEOCL
    } else if (vecType == parallel::OpenCL) {
      return new parallel::OperationLTwoDotLaplaceVectorizedLinearBoundaryOCL(
               grid.getStorage(), lambda);
#endif
    } else {
      throw base::factory_exception("Unsupported vectorization type");
...
base::OperationMatrix* createOperationLaplaceVectorized(base::Grid& grid,
  ...
  if (grid.getType() == base::GridType::Linear) {
    ...
    if (vecType == parallel::X86SIMD) {
      ...
      return new parallel::OperationLaplaceVectorizedLinearBoundaryOCL(
               grid.getStorage());
#endif
    } else {
      throw base::factory_exception("Unsupported vectorization type");
