...
createOperationMultipleEvalVectorized(base::Grid& grid,
  ...
  if (grid.getType() == base::GridType::Linear) {
    if (vecType == parallel::X86SIMD) {
      return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(new
             parallel::OperationMultipleEvalIterative<parallel::CPUKernel<parallel::X86SimdLinear> >
      ...
      return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
          new parallel::OperationMultipleEvalIterative <
             parallel::OCLKernel<parallel::OCLLinear<double> > > (grid.getStorage(), dataset,
      ...
      return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
          new parallel::OperationMultipleEvalIterative
             ...
             parallel::OCLLinear<double> > > (grid.getStorage(), dataset, gridFrom, gridTo,
      ...
      return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
          new parallel::OperationMultipleEvalIterativeArBBLinear(grid.getStorage(),
             dataset));
    }
      ...
      return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(new
             parallel::OperationMultipleEvalIterative<parallel::MICKernel<parallel::MICLinear> >
             (grid.getStorage(), dataset, gridFrom, gridTo, datasetFrom, datasetTo));
    }
      ...
      return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(new
             parallel::OperationMultipleEvalIterative<parallel::MICCPUHybridKernel<parallel::X86SimdLinear, parallel::MICLinear> >
             (grid.getStorage(), dataset, gridFrom, gridTo, datasetFrom, datasetTo));
    }
    ...
    if (vecType == parallel::X86SIMD) {
      ...
      return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
          new parallel::OperationMultipleEvalIterative <
             parallel::OCLKernel < parallel::OCLLinear<double> > > (grid.getStorage(),
    ...
    if (vecType == parallel::X86SIMD) {
      if (strcmp(modlinear_mode, "orig") == 0) {
        return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(new
               parallel::OperationMultipleEvalIterative<parallel::CPUKernel<parallel::X86SimdModLinear> >
               (grid.getStorage(), dataset, gridFrom, gridTo, datasetFrom, datasetTo));
      } else if (strcmp(modlinear_mode, "mask") == 0) {
        return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(new
               parallel::OperationMultipleEvalIterative<parallel::CPUKernel<parallel::X86SimdModLinearMask> >
               (grid.getStorage(), dataset, gridFrom, gridTo, datasetFrom, datasetTo));
      } else {
      ...
      if (strcmp(modlinear_mode, "orig") == 0) {
        return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
            new parallel::OperationMultipleEvalIterative <
               parallel::OCLKernel < parallel::OCLModLinear<double> > > (grid.getStorage(),
                   dataset, gridFrom, gridTo, datasetFrom, datasetTo));
      } else if (strcmp(modlinear_mode, "mask") == 0) {
        return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
            new parallel::OperationMultipleEvalIterative <
               parallel::OCLKernel < parallel::OCLModLinearMask<double> > > (grid.getStorage(),
                   dataset, gridFrom, gridTo, datasetFrom, datasetTo));
      } else {
        throw base::factory_exception("ParallelOpFactory: SGPP_MODLINEAR_EVAL must be 'mask' or 'orig'.");
      }
      ...
      if (strcmp(modlinear_mode, "orig") == 0) {
        return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
            new parallel::OperationMultipleEvalIterative <
               ...
               parallel::OCLModLinear<double> > > (grid.getStorage(), dataset, gridFrom,
                   gridTo, datasetFrom, datasetTo));
      } else if (strcmp(modlinear_mode, "mask") == 0) {
        return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
            new parallel::OperationMultipleEvalIterative <
               parallel::OCLCPUHybridKernel < parallel::X86SimdModLinearMask,
               parallel::OCLModLinearMask<double> > > (grid.getStorage(), dataset, gridFrom,
                   gridTo, datasetFrom, datasetTo));
      } else {
        throw base::factory_exception("ParallelOpFactory: SGPP_MODLINEAR_EVAL must be 'mask' or 'orig'.");
      }
      ...
      if (strcmp(modlinear_mode, "orig") == 0) {
        return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
            new parallel::OperationMultipleEvalIterative
               < parallel::MICKernel < parallel::MICModLinear > >
               (grid.getStorage(), dataset, gridFrom, gridTo, datasetFrom, datasetTo));
      } else if (strcmp(modlinear_mode, "mask") == 0) {
        return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
            new parallel::OperationMultipleEvalIterative
      ...
      if (strcmp(modlinear_mode, "orig") == 0) {
        ...
        return std::unique_ptr<parallel::OperationMultipleEvalVectorized>(
            new parallel::OperationMultipleEvalIterative
               < parallel::MICCPUHybridKernel < parallel::X86SimdModLinearMask, parallel::MICModLinearMask > >
               (grid.getStorage(), dataset, gridFrom, gridTo, datasetFrom, datasetTo));
      } else {
        throw base::factory_exception("ParallelOpFactory: SGPP_MODLINEAR_EVAL must be 'mask' or 'orig'.");
      }
...
std::unique_ptr<base::OperationMatrix> createOperationLTwoDotProductVectorized(base::Grid& grid,
  ...
  if (grid.getType() == base::GridType::Linear) {
    if (vecType == parallel::X86SIMD) {
      ...
      return std::unique_ptr<base::OperationMatrix>(
          new parallel::OperationLTwoDotProductVectorizedLinearOCL(
               grid.getStorage()));
#endif
    } else {
      throw base::factory_exception("Unsupported vectorization type");
    ...
    if (vecType == parallel::X86SIMD) {
      return std::unique_ptr<base::OperationMatrix>(
          new parallel::OperationLTwoDotProductVectorizedLinearBoundary(
               grid.getStorage()));
#ifdef USEOCL
    } else if (vecType == parallel::OpenCL) {
      return std::unique_ptr<base::OperationMatrix>(
          new parallel::OperationLTwoDotProductVectorizedLinearBoundaryOCL(
               grid.getStorage()));
#endif
    } else {
      throw base::factory_exception("Unsupported vectorization type");
...
createOperationLTwoDotLaplaceVectorized(base::Grid& grid,
  ...
  if (grid.getType() == base::GridType::Linear) {
    if (vecType == parallel::X86SIMD) {
      ...
      return std::unique_ptr<base::OperationParabolicPDEMatrixCombined>(
          new parallel::OperationLTwoDotLaplaceVectorizedLinearOCL(
               grid.getStorage(), lambda));
#endif
    } else {
      throw base::factory_exception("Unsupported vectorization type");
    }
    ...
    if (vecType == parallel::X86SIMD) {
      return std::unique_ptr<base::OperationParabolicPDEMatrixCombined>(
          new parallel::OperationLTwoDotLaplaceVectorizedLinearBoundary(
               grid.getStorage(), lambda));
#ifdef USEOCL
    } else if (vecType == parallel::OpenCL) {
      return std::unique_ptr<base::OperationParabolicPDEMatrixCombined>(
          new parallel::OperationLTwoDotLaplaceVectorizedLinearBoundaryOCL(
               grid.getStorage(), lambda));
#endif
    } else {
      throw base::factory_exception("Unsupported vectorization type");
...
std::unique_ptr<base::OperationMatrix> createOperationLaplaceVectorized(base::Grid& grid,
  ...
  if (grid.getType() == base::GridType::Linear) {
    ...
    if (vecType == parallel::X86SIMD) {
      return std::unique_ptr<base::OperationMatrix>(
          new parallel::OperationLaplaceVectorizedLinearBoundary(
               grid.getStorage()));
#ifdef USEOCL
    } else if (vecType == parallel::OpenCL) {
      return std::unique_ptr<base::OperationMatrix>(
          new parallel::OperationLaplaceVectorizedLinearBoundaryOCL(
               grid.getStorage()));
#endif
    } else {
      throw base::factory_exception("Unsupported vectorization type");
