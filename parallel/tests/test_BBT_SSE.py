...
def generateBBTSSEMatrix(factory, training, verbose=False):
    ...
    #padding
    remainder = training.getNrows() % 12
    loopCount = 12 - remainder
    if loopCount != 12:
...
def compareBBTSSEMatrices(testCaseClass, m1, m2):
    from pysgpp import DataVector
...
class TestOperationBBTSSELinear(unittest.TestCase):
    ##
    ...
    def testHatRegular1D_one(self):
        ...
        # compare
        compareBBTSSEMatrices(self, m, m_ref) 
