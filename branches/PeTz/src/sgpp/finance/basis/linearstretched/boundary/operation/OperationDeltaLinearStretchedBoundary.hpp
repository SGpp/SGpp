...
namespace sg {
  namespace finance {
     ...
     * @version $HEAD$
     */
    class OperationDeltaLinearStretchedBoundary: public sg::pde::UpDownOneOpDim {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationDeltaLinearStretchedBoundary(sg::base::GridStorage* storage, sg::base::DataVector& coef);
