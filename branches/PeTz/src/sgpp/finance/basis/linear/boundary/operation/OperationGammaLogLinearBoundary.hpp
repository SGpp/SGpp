...
namespace sg {
  namespace finance {
     ...
     * @version $HEAD$
     */
    class OperationGammaLogLinearBoundary: public sg::pde::UpDownTwoOpDims {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationGammaLogLinearBoundary(sg::base::GridStorage* storage, sg::base::DataMatrix& coef);
