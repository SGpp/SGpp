...
#ifndef OPERATIONDELTALOGLINEARBOUNDARY_HPP
...
namespace sg {
  namespace finance {
     ...
     * @version $HEAD$
     */
    class OperationDeltaLogLinearBoundary: public sg::pde::UpDownOneOpDim {
      public:
        /**
         * Constructor
         *
         ...
         */
        OperationDeltaLogLinearBoundary(sg::base::GridStorage* storage, sg::base::DataVector& coef);

        /**
         * Destructor
         */
        virtual ~OperationDeltaLogLinearBoundary();
...
#endif /* OPERATIONDELTALOGLINEARBOUNDARY_HPP */
