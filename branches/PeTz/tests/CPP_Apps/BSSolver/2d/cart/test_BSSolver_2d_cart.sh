...
./BSSolver solveND cart 2 9 BStest2d.cart.bound BStest2d.stoch 1.0 std_euro_call 0.05 1.0 0.05 CrNic 2000 0.00001 > tmp
...
./BSSolver solveND cart 2 9 BStest2d.cart.bound BStest2d.stoch 1.0 std_euro_put 0.05 1.0 0.05 CrNic 2000 0.00001 > tmp
cat tmp | grep "Optionprice at testpoint"
echo "Finished executing BSSolver!"
echo "Monte Carlo Value of identical option:"
