...
TestScalarFunction& Sphere::getObjectiveFunction() {
  return f;
}
...
SphereObjective::SphereObjective(size_t d) :
...
float_t SphereObjective::evalUndisplaced(
...
void SphereObjective::clone(
  std::unique_ptr<ScalarFunction>& clone) const {
  clone = std::unique_ptr<ScalarFunction>(
            new SphereObjective(*this));
}
