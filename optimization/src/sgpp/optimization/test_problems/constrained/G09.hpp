...
class G09InequalityConstraint :
 ...
 public:
   ...
   * Destructor.
   */
  virtual ~G09InequalityConstraint() override;
...
class G09EqualityConstraint :
 ...
 public:
   ...
   * Destructor.
   */
  virtual ~G09EqualityConstraint() override;
