...
namespace SGPP {
  namespace optimization {
    namespace test_problems {
       ...
       * This class essentially manages an objective function and
       * two constraint functions
       * (one inequality and one equality constraint function),
      ...
      class ConstrainedTestProblem {
        public:
          ...
          /**
           * @return  inequality constraint function of the test problem
           */
