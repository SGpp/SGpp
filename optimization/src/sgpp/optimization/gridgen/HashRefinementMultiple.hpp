...
namespace SGPP {
  namespace optimization {
    namespace gridgen {
       ...
       *
       * In SG++ grids (as in SGPP::base), every grid fulfills the "hierarchical ancestors" property,
      ...
      class HashRefinementMultiple : public base::HashRefinement {
        ...
        protected:
           ...
           * @param maxIndices        the array where the point indices should be stored
           * @param maxValues         the array where the corresponding indicator values should be stored
           */
