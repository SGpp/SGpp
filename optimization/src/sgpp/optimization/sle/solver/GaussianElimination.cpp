  ...
  namespace optimization {
    namespace sle {
      namespace solver {
        ...
        bool GaussianElimination::solve(system::System& system, const std::vector<float_t>& b,
                                        std::vector<float_t>& x) const {
          tools::printer.printStatusBegin(
          ...
          for (size_t l = 0; l < n; l++) {
            tools::printer.printStatusUpdate("k = " + toString(l));
          ...
          tools::printer.printStatusUpdate("k = " + toString(n));
          tools::printer.printStatusEnd();
          return true;
        }
