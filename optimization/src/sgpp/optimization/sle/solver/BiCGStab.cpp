  ...
  namespace optimization {
    namespace sle {
      namespace solver {
        ...
        BiCGStab::BiCGStab(size_t maxItCount, float_t tolerance, const std::vector<float_t>& x0) :
          Solver(),
          N(maxItCount),
          tol(tolerance),
          x0(x0) {
        ...
        bool BiCGStab::solve(system::System& system, const std::vector<float_t>& b,
          ...
          for (k = 0; k < N; k++) {
            ...
            rNormSquared = std::inner_product(r.begin(), r.end(), r.begin(), 0.0);

            tools::printer.printStatusUpdate("k = " + toString(k) + ", residual norm = " +
                                             toString(sqrt(rNormSquared)));
        ...
        void BiCGStab::setStartingPoint(const std::vector<float_t>& startingPoint) {
          x0 = startingPoint;
        }
