...
#ifndef SGPP_OPTIMIZATION_SLE_SOLVER_MATLABSPARSE_HPP
#define SGPP_OPTIMIZATION_SLE_SOLVER_MATLABSPARSE_HPP
...
/**
 * Sparse linear system solver using MATLAB.
 ...
 */
class MATLABSparse : public SLESolver {
 public:
  /**
   * Destructor.
   */
  ~MATLABSparse() override;
...
#endif /* SGPP_OPTIMIZATION_SLE_SOLVER_MATLABSPARSE_HPP */
