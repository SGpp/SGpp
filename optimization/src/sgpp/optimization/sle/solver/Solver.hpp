...
#ifndef SGPP_OPTIMIZATION_SLE_SOLVER_SOLVER_HPP
#define SGPP_OPTIMIZATION_SLE_SOLVER_SOLVER_HPP
      ...
      namespace solver {
        ...
        class Solver {
          public:
             ...
             */
            virtual bool solve(system::System& system, const std::vector<float_t>& b,
             ...
             * @return              whether all went well (false if errors occurred)
             */
            virtual bool solve(system::System& system, const std::vector<std::vector<float_t> >& B,
