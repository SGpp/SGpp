...
#ifndef SGPP_OPTIMIZATION_FUNCTION_TEST_TEST_HPP
#define SGPP_OPTIMIZATION_FUNCTION_TEST_TEST_HPP
      ...
      namespace test {
        ...
        class Test : public Objective {
          public:
             ...
             * @return          minimal function value \f$f_{\text{opt}} = f(\vec{x}_{\text{opt}})\f$
             */
            virtual float_t getOptimalPointUndisplaced(std::vector<float_t>& x) = 0;
             ...
             */
            virtual void generateDisplacement(float_t std_dev);
