      ...
      class Hartman6 : public TestFunction {
        public:
          ...
          float_t evalUndisplaced(const base::DataVector& x) {
            return -1.0 * exp(-10.0 * (x.get(0) - 0.1312) * (x.get(0) - 0.1312) -
                   ...
                   1.2 * exp(-0.05 * (x.get(0) - 0.2329) * (x.get(0) - 0.2329) -
                   ...
                   3.0 * exp(-3.0 * (x.get(0) - 0.2348) * (x.get(0) - 0.2348) -
                   ...
                   3.2 * exp(-17.0 * (x.get(0) - 0.4047) * (x.get(0) - 0.4047) -
