...
#ifndef SGPP_OPTIMIZATION_FUNCTION_INTERPOLANT_HPP
#define SGPP_OPTIMIZATION_FUNCTION_INTERPOLANT_HPP
    ...
    namespace function {
      ...
      class Interpolant : public Objective {
        public:
           ...
           */
          Interpolant(size_t d, base::Grid& grid, const base::DataVector& alpha) :
            Objective(d),
            grid(grid),
