...
namespace SGPP {
  namespace optimization {
    namespace test_functions {
      ...
      Ackley::Ackley(size_t d) : TestFunction(d) {
      }

      Ackley::~Ackley() {
      }

      float_t Ackley::evalUndisplaced(const base::DataVector& x) {
        float_t result = 0.0;
      ...
      void Ackley::clone(std::unique_ptr<ScalarFunction>& clone) const {
