...
OperationMultipleHierarchisationModWeaklyFundamentalNotAKnotSpline::
OperationMultipleHierarchisationModWeaklyFundamentalNotAKnotSpline(
...
bool OperationMultipleHierarchisationModWeaklyFundamentalNotAKnotSpline::doHierarchisation(
...
void OperationMultipleHierarchisationModWeaklyFundamentalNotAKnotSpline::doDehierarchisation(
    base::DataVector& alpha) {
  base::GridStorage& storage = grid.getStorage();
  const size_t d = storage.getDimension();
  base::OperationEvalModWeaklyFundamentalNotAKnotSplineNaive opNaiveEval(storage, grid.getDegree());
