...
OperationMultipleHierarchisationWeaklyFundamentalNotAKnotSplineBoundary::
OperationMultipleHierarchisationWeaklyFundamentalNotAKnotSplineBoundary(
...
bool OperationMultipleHierarchisationWeaklyFundamentalNotAKnotSplineBoundary::doHierarchisation(
...
void OperationMultipleHierarchisationWeaklyFundamentalNotAKnotSplineBoundary::doDehierarchisation(
    base::DataVector& alpha) {
  base::GridStorage& storage = grid.getStorage();
  const size_t d = storage.getDimension();
  base::OperationEvalWeaklyFundamentalNotAKnotSplineBoundaryNaive opNaiveEval(storage, grid.getDegree());
