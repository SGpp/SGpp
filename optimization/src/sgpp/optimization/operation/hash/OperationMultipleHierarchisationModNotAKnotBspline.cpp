...
OperationMultipleHierarchisationModNotAKnotBspline::
OperationMultipleHierarchisationModNotAKnotBspline(
...
bool OperationMultipleHierarchisationModNotAKnotBspline::doHierarchisation(
...
void OperationMultipleHierarchisationModNotAKnotBspline::doDehierarchisation(
    base::DataVector& alpha) {
  base::GridStorage& storage = grid.getStorage();
  const size_t d = storage.getDimension();
  base::OperationEvalModNotAKnotBsplineNaive opNaiveEval(storage, grid.getDegree());
