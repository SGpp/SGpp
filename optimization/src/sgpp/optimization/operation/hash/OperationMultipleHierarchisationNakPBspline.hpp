...
#ifndef SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERNAKPBSPLINE_HPP
#define SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERNAKPBSPLINE_HPP
...
/**
 * Hierarchisation operation for not an otter B-spline basis functions on
 * Noboundary grids.
 */
class OperationMultipleHierarchisationNakPBspline : public OperationMultipleHierarchisation {
 public:
  /**
   * Constructor.
   *
   * @param grid      grid
   */
  explicit OperationMultipleHierarchisationNakPBspline(base::NakPBsplineGrid& grid);

  /**
   * Destructor.
   */
  ~OperationMultipleHierarchisationNakPBspline() override;
...
#endif /* SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERNAKPBSPLINE_HPP */
