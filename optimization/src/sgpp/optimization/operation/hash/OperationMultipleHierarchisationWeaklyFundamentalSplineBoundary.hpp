...
#ifndef SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERWEAKLYFUNDAMENTALSPLINEBOUNDARY_HPP
#define SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERWEAKLYFUNDAMENTALSPLINEBOUNDARY_HPP
...
class OperationMultipleHierarchisationWeaklyFundamentalSplineBoundary :
 ...
 public:
   ...
   * @param grid      grid
   */
  explicit OperationMultipleHierarchisationWeaklyFundamentalSplineBoundary(
      base::WeaklyFundamentalSplineBoundaryGrid& grid);

  /**
   * Destructor.
   */
  ~OperationMultipleHierarchisationWeaklyFundamentalSplineBoundary() override;
...
#endif /* SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERWEAKLYFUNDAMENTALSPLINEBOUNDARY_HPP */
