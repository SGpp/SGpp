...
#ifndef SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERMODWEAKLYFUNDAMENTALNOTAKNOTSPLINE_HPP
#define SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERMODWEAKLYFUNDAMENTALNOTAKNOTSPLINE_HPP
 ...
 */
class OperationMultipleHierarchisationModWeaklyFundamentalNotAKnotSpline :
 ...
 public:
   ...
   * @param grid      grid
   */
  explicit OperationMultipleHierarchisationModWeaklyFundamentalNotAKnotSpline(
      base::ModWeaklyFundamentalNotAKnotSplineGrid& grid);

  /**
   * Destructor.
   */
  ~OperationMultipleHierarchisationModWeaklyFundamentalNotAKnotSpline() override;
...
#endif /* SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERMODWEAKLYFUNDAMENTALNOTAKNOTSPLINE_HPP */
