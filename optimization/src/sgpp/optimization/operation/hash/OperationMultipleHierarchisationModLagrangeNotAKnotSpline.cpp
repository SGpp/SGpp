...
OperationMultipleHierarchisationModLagrangeNotAKnotSpline::
OperationMultipleHierarchisationModLagrangeNotAKnotSpline(
...
bool OperationMultipleHierarchisationModLagrangeNotAKnotSpline::doHierarchisation(
...
void OperationMultipleHierarchisationModLagrangeNotAKnotSpline::doDehierarchisation(
    base::DataVector& alpha) {
  base::GridStorage& storage = grid.getStorage();
  const size_t d = storage.getDimension();
  base::OperationEvalModLagrangeNotAKnotSplineNaive opNaiveEval(storage, grid.getDegree());
