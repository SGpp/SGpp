 ...
 * Noboundary grids.
 */
class OperationMultipleHierarchisationLinear : public OperationMultipleHierarchisation {
 public:
  /**
   * Constructor.
   *
   * @param grid      grid
   */
  explicit OperationMultipleHierarchisationLinear(base::LinearGrid& grid);

  /**
   * Destructor.
   */
  ~OperationMultipleHierarchisationLinear() override;
