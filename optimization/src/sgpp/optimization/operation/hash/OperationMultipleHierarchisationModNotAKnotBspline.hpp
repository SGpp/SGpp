...
#ifndef SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERMODNOTAKNOTBSPLINE_HPP
#define SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERMODNOTAKNOTBSPLINE_HPP
 ...
 */
class OperationMultipleHierarchisationModNotAKnotBspline :
 ...
 public:
   ...
   * @param grid      grid
   */
  explicit OperationMultipleHierarchisationModNotAKnotBspline(base::ModNotAKnotBsplineGrid& grid);

  /**
   * Destructor.
   */
  ~OperationMultipleHierarchisationModNotAKnotBspline() override;
 ...
 protected:
  ...
  base::ModNotAKnotBsplineGrid& grid;
};
}  // namespace optimization
}  // namespace sgpp

#endif /* SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERMODNOTAKNOTBSPLINE_HPP */
