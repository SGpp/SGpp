...
OperationMultipleHierarchisationNaturalBsplineBoundary::
OperationMultipleHierarchisationNaturalBsplineBoundary(
...
bool OperationMultipleHierarchisationNaturalBsplineBoundary::doHierarchisation(
...
void OperationMultipleHierarchisationNaturalBsplineBoundary::doDehierarchisation(
    base::DataVector& alpha) {
  base::GridStorage& storage = grid.getStorage();
  const size_t d = storage.getDimension();
  base::OperationEvalNaturalBsplineBoundaryNaive opNaiveEval(storage, grid.getDegree());
