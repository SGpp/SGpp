...
#ifndef SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERWEAKLYFUNDAMENTALNOTAKNOTSPLINEBOUNDARY_HPP
#define SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERWEAKLYFUNDAMENTALNOTAKNOTSPLINEBOUNDARY_HPP
 ...
 */
class OperationMultipleHierarchisationWeaklyFundamentalNotAKnotSplineBoundary :
 ...
 public:
   ...
   * @param grid      grid
   */
  explicit OperationMultipleHierarchisationWeaklyFundamentalNotAKnotSplineBoundary(
      base::WeaklyFundamentalNotAKnotSplineBoundaryGrid& grid);

  /**
   * Destructor.
   */
  ~OperationMultipleHierarchisationWeaklyFundamentalNotAKnotSplineBoundary() override;
...
#endif /* SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERWEAKLYFUNDAMENTALNOTAKNOTSPLINEBOUNDARY_HPP */
