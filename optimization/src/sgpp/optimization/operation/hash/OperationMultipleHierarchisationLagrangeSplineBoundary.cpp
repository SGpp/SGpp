...
OperationMultipleHierarchisationLagrangeSplineBoundary::
OperationMultipleHierarchisationLagrangeSplineBoundary(
...
bool OperationMultipleHierarchisationLagrangeSplineBoundary::doHierarchisation(
...
void OperationMultipleHierarchisationLagrangeSplineBoundary::doDehierarchisation(
    base::DataVector& alpha) {
  base::GridStorage& storage = grid.getStorage();
  const size_t d = storage.getDimension();
  base::OperationEvalLagrangeSplineBoundaryNaive opNaiveEval(storage, grid.getDegree());
