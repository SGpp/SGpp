...
OperationMultipleHierarchisationLagrangeNotAKnotSplineBoundary::
OperationMultipleHierarchisationLagrangeNotAKnotSplineBoundary(
...
bool OperationMultipleHierarchisationLagrangeNotAKnotSplineBoundary::doHierarchisation(
...
void OperationMultipleHierarchisationLagrangeNotAKnotSplineBoundary::doDehierarchisation(
    base::DataVector& alpha) {
  base::GridStorage& storage = grid.getStorage();
  const size_t d = storage.getDimension();
  base::OperationEvalLagrangeNotAKnotSplineBoundaryNaive opNaiveEval(storage, grid.getDegree());
