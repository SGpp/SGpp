 ...
 * Boundary grids.
 */
class OperationMultipleHierarchisationNakBspline : public OperationMultipleHierarchisation {
 public:
  /**
   * Constructor.
   *
   * @param grid      grid
   */
  explicit OperationMultipleHierarchisationNakBspline(base::NakBsplineGrid& grid);

  /**
   * Destructor.
   */
  ~OperationMultipleHierarchisationNakBspline() override;
