...
#ifndef SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERFUNDAMENTALNAKSPLINEBOUNDARY_HPP
#define SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERFUNDAMENTALNAKSPLINEBOUNDARY_HPP
...
class OperationMultipleHierarchisationFundamentalNakSplineBoundary :
 ...
 public:
   ...
   * @param grid      grid
   */
  explicit OperationMultipleHierarchisationFundamentalNakSplineBoundary(
      base::FundamentalNakSplineBoundaryGrid& grid);

  /**
   * Destructor.
   */
  ~OperationMultipleHierarchisationFundamentalNakSplineBoundary() override;
 ...
 protected:
  ...
  base::OperationHierarchisationFundamentalNakSplineBoundary op;
};
}  // namespace optimization
}  // namespace sgpp

#endif /* SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERFUNDAMENTALNAKSPLINEBOUNDARY_HPP */
