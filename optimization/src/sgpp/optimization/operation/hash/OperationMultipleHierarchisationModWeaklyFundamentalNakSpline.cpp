...
OperationMultipleHierarchisationModWeaklyFundamentalNakSpline::
OperationMultipleHierarchisationModWeaklyFundamentalNakSpline(
...
bool OperationMultipleHierarchisationModWeaklyFundamentalNakSpline::doHierarchisation(
...
void OperationMultipleHierarchisationModWeaklyFundamentalNakSpline::doDehierarchisation(
    base::DataVector& alpha) {
  base::GridStorage& storage = grid.getStorage();
  const size_t d = storage.getDimension();
  base::OperationEvalModWeaklyFundamentalNakSplineNaive opNaiveEval(storage, grid.getDegree());
