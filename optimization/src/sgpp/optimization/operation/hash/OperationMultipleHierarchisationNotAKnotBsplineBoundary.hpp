...
#ifndef SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERNOTAKNOTBSPLINEBOUNDARY_HPP
#define SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERNOTAKNOTBSPLINEBOUNDARY_HPP
 ...
 */
class OperationMultipleHierarchisationNotAKnotBsplineBoundary :
 ...
 public:
   ...
   * @param grid      grid
   */
  explicit OperationMultipleHierarchisationNotAKnotBsplineBoundary(
      base::NotAKnotBsplineBoundaryGrid& grid);

  /**
   * Destructor.
   */
  ~OperationMultipleHierarchisationNotAKnotBsplineBoundary() override;
...
#endif /* SGPP_OPTIMIZATION_OPERATION_HASH_OPMULTHIERNOTAKNOTBSPLINEBOUNDARY_HPP */
