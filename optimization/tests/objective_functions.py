...
# define and clear global clones list
sg_optimization_clones = []
...
class TitleFunction(pysgpp.OptObjective):
    ...
    def __init__(self):
        ...
        # were already deleted in the C++ library, resulting in a double free
    ...
    def clone(self):
        ...
        # create a new TitleFunction object
        ...
        global sg_optimization_clones
        sg_optimization_clones.append(TitleFunction())
        return sg_optimization_clones[-1]
...
class TitleFunctionGradient(pysgpp.OptObjectiveGradient):
    ...
    def clone(self):
        ...
        # see above
        global sg_optimization_clones
        sg_optimization_clones.append(TitleFunctionGradient())
        return sg_optimization_clones[-1]
...
class TitleFunctionHessian(pysgpp.OptObjectiveHessian):
    ...
    def clone(self):
        ...
        # see above
        global sg_optimization_clones
        sg_optimization_clones.append(TitleFunctionHessian())
        return sg_optimization_clones[-1]
...
class SphereFunctionGradient(pysgpp.OptObjectiveGradient):
    ...
    def clone(self):
        ...
        # see above
        global sg_optimization_clones
        sg_optimization_clones.append(SphereFunctionGradient(self.getDimension()))
        return sg_optimization_clones[-1]
...
class SphereFunctionHessian(pysgpp.OptObjectiveHessian):
    ...
    def clone(self):
        ...
        # see above
        global sg_optimization_clones
        sg_optimization_clones.append(SphereFunctionHessian(self.getDimension()))
        return sg_optimization_clones[-1] 
