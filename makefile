...
CFLAGS_GCC_OMP=-Wall -pedantic -ansi -c -Wno-long-long -fno-strict-aliasing -O3 -funroll-loops -ffloat-store -fopenmp -I$(SRCDIR)
LFLAGS_GCC_OMP=-Wall -pedantic -ansi -O3 -pthread -fopenmp
CFLAGS_GCC_OMP_TRONE=-Wall -pedantic -ansi -c -Wno-long-long -fno-strict-aliasing -O3 -funroll-loops -ffloat-store -fopenmp -I$(SRCDIR) -DUSETRONE -Isrc/sgpp/
...
CFLAGS_ICC_OMP=-Wall -ansi -c -O3 -axSSE3 -fno-strict-aliasing -ipo -ip -ansi-alias -funroll-loops -I$(SRCDIR) -openmp -DUSEICCINTRINSICS
LFLAGS_ICC_OMP=-Wall -ansi -O3 -static-intel -openmp -openmp-link static -ipo -ip
CFLAGS_ICC_OMP_TRONE=-Wall -ansi -c -fno-strict-aliasing -ipo -ip -ansi-alias -O3 -funroll-loops -I$(SRCDIR) -openmp -DUSETRONE -DUSEICCINTRINSICS -std=c++0x -axSSE3
