 ...
 *
 */
class OperationMatrixLTwoDotModNakBspline : public sgpp::base::OperationMatrix {
 public:
  /**
   * Constructor
   *
   ...
   */
  explicit OperationMatrixLTwoDotModNakBspline(sgpp::base::Grid* grid);

  /**
   * Destructor
   */
  virtual ~OperationMatrixLTwoDotModNakBspline();
