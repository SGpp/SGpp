...
OperationMatrixLTwoDotExplicitNakBsplineBoundary::OperationMatrixLTwoDotExplicitNakBsplineBoundary(
...
void OperationMatrixLTwoDotExplicitNakBsplineBoundary::buildMatrix(base::Grid* grid) {
  size_t gridSize = grid->getSize();
  size_t gridDim = grid->getDimension();
  const size_t p = dynamic_cast<base::NakBsplineBoundaryGrid*>(grid)->getDegree();
...
OperationMatrixLTwoDotExplicitNakBsplineBoundary::
    ~OperationMatrixLTwoDotExplicitNakBsplineBoundary() {
  if (ownsMatrix_) delete m_;
}

void OperationMatrixLTwoDotExplicitNakBsplineBoundary::mult(base::DataVector& alpha,
