...
OperationMatrixLTwoDotNakBsplineExtended::OperationMatrixLTwoDotNakBsplineExtended(
    sgpp::base::Grid* grid) {
  this->grid = grid;
}
...
void OperationMatrixLTwoDotNakBsplineExtended::mult(sgpp::base::DataVector& alpha,
