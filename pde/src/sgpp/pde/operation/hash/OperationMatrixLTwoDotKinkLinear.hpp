 ...
 *
 */
class OperationMatrixLTwoDotKinkLinear : public sgpp::base::OperationMatrix {
 public:
  /**
   * Constructor
   *
   ...
   */
  explicit OperationMatrixLTwoDotKinkLinear(sgpp::base::Grid* grid);

  /**
   * Destructor
   */
  virtual ~OperationMatrixLTwoDotKinkLinear();
