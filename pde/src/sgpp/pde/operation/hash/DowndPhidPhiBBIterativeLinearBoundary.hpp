...
#ifndef DOWNDPHIDPHIDOWNBBITERATIVELINEARBOUNDARY_HPP
#define DOWNDPHIDPHIDOWNBBITERATIVELINEARBOUNDARY_HPP
 ...
 * all ansatzfunctions
 */
class DowndPhidPhiBBIterativeLinearBoundary {
 private:
 ...
 public:
   ...
   */
  explicit DowndPhidPhiBBIterativeLinearBoundary(SGPP::base::GridStorage* storage);

  /**
   * Destructor
   */
  virtual ~DowndPhidPhiBBIterativeLinearBoundary();
...
#endif /* DOWNDPHIDPHIDOWNBBITERATIVELINEARBOUNDARY_HPP */
