...
#ifndef OPERATIONMATRIXLTWODOTPOLYBOUNDARY_HPP
#define OPERATIONMATRIXLTWODOTPOLYBOUNDARY_HPP
 ...
 *
 */
class OperationMatrixLTwoDotPolyBoundary : public sgpp::base::OperationMatrix {
 public:
  /**
   * Constructor
   *
   ...
   */
  explicit OperationMatrixLTwoDotPolyBoundary(sgpp::base::Grid* grid);
...
#endif /* OPERATIONMATRIXLTWODOTPOLYBOUNDARY_HPP */
