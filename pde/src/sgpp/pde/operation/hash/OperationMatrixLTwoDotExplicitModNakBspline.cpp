...
OperationMatrixLTwoDotExplicitModNakBspline::OperationMatrixLTwoDotExplicitModNakBspline()
    : ownsMatrix_(false) {
  m_ = nullptr;
}
...
void OperationMatrixLTwoDotExplicitModNakBspline::buildMatrix(sgpp::base::Grid* grid) {
...
void OperationMatrixLTwoDotExplicitModNakBspline::mult(sgpp::base::DataVector& alpha,
