...
#ifndef OPERATIONMATRIXLTWODOTMODLINEAR_HPP
#define OPERATIONMATRIXLTWODOTMODLINEAR_HPP
 ...
 *
 */
class OperationMatrixLTwoDotModLinear : public sgpp::base::OperationMatrix {
 public:
  /**
   * Constructor
   *
   ...
   */
  explicit OperationMatrixLTwoDotModLinear(sgpp::base::Grid* grid);
...
#endif /* OPERATIONMATRIXLTWODOTMODLINEAR_HPP */
