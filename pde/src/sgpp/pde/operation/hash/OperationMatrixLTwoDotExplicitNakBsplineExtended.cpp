...
OperationMatrixLTwoDotExplicitNakBsplineExtended::OperationMatrixLTwoDotExplicitNakBsplineExtended()
    : ownsMatrix_(false) {
  m_ = nullptr;
}
...
void OperationMatrixLTwoDotExplicitNakBsplineExtended::buildMatrix(sgpp::base::Grid* grid) {
...
void OperationMatrixLTwoDotExplicitNakBsplineExtended::mult(sgpp::base::DataVector& alpha,
