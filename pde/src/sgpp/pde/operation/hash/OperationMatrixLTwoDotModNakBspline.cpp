...
OperationMatrixLTwoDotModNakBspline::OperationMatrixLTwoDotModNakBspline(sgpp::base::Grid* grid) {
  this->grid = grid;
}

OperationMatrixLTwoDotModNakBspline::~OperationMatrixLTwoDotModNakBspline() {}

void OperationMatrixLTwoDotModNakBspline::mult(sgpp::base::DataVector& alpha,
