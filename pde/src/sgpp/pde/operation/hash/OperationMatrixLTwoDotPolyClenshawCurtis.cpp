...
OperationMatrixLTwoDotPolyClenshawCurtis::OperationMatrixLTwoDotPolyClenshawCurtis(
    sgpp::base::Grid* grid)
...
void OperationMatrixLTwoDotPolyClenshawCurtis::mult(sgpp::base::DataVector& alpha,
