 ...
 */
class OperationMatrixLTwoDotExplicitModBspline : public sgpp::base::OperationMatrix {
 public:
  /**
   ...
   * OperationMatrixLTwoDotExplicitModBsplineFullGrid
   *
   ...
   * @param grid the sparse grid
   */
  explicit OperationMatrixLTwoDotExplicitModBspline(sgpp::base::Grid* grid);
  ...
  inline void buildMatrixWithBounds(sgpp::base::DataMatrix* mat, sgpp::base::Grid* grid,
    ...
    base::SBsplineModifiedBase& basis = const_cast<base::SBsplineModifiedBase&>(
