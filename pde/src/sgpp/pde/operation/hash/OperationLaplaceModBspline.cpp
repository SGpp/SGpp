...
OperationLaplaceModBspline::OperationLaplaceModBspline(sgpp::base::Grid* grid):
  grid(grid) {}

OperationLaplaceModBspline::~OperationLaplaceModBspline() {}

void OperationLaplaceModBspline::mult(sgpp::base::DataVector& alpha,
