...
OperationMatrixLTwoDotModPolyClenshawCurtis::OperationMatrixLTwoDotModPolyClenshawCurtis(
    sgpp::base::Grid* grid)
  : clenshawCurtisTable(base::ClenshawCurtisTable::getInstance()) {
  this->grid = grid;
}

OperationMatrixLTwoDotModPolyClenshawCurtis::
  ~OperationMatrixLTwoDotModPolyClenshawCurtis() {}

void OperationMatrixLTwoDotModPolyClenshawCurtis::mult(sgpp::base::DataVector& alpha,
