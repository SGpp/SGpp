 ...
 *
 */
class OperationMatrixLTwoDotNakBsplineBoundary : public sgpp::base::OperationMatrix {
 public:
  /**
   * Constructor
   *
   ...
   */
  explicit OperationMatrixLTwoDotNakBsplineBoundary(sgpp::base::Grid* grid);

  /**
   * Destructor
   */
  virtual ~OperationMatrixLTwoDotNakBsplineBoundary();
