...
OperationMatrixLTwoDotBsplineClenshawCurtis::OperationMatrixLTwoDotBsplineClenshawCurtis(
    sgpp::base::Grid* grid) {
  this->grid = grid;
}
...
void OperationMatrixLTwoDotBsplineClenshawCurtis::mult(sgpp::base::DataVector& alpha,
