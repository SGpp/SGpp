...
void PoissonEquationSolver::solvePDE(DataVector& alpha, DataVector& rhs,
  ...
  PoissonEquationEllipticPDESolverSystemDirichlet* mySystem = new
  PoissonEquationEllipticPDESolverSystemDirichlet(*(this->myGrid), rhs);
...
void PoissonEquationSolver::initGridWithSmoothHeat(DataVector& alpha,
...
void PoissonEquationSolver::initGridWithSmoothHeatFullDomain(DataVector& alpha,
    float_t mu, float_t sigma, float_t factor) {
  if (this->bGridConstructed) {
    float_t tmp;
    float_t* dblFuncValues = new float_t[this->dim];
...
void PoissonEquationSolver::storeInnerRHS(DataVector& alpha,
    std::string tFilename) {
  SGppStopwatch* myStopwatch = new SGppStopwatch();
  PoissonEquationEllipticPDESolverSystemDirichlet* mySystem = new
  PoissonEquationEllipticPDESolverSystemDirichlet(*(this->myGrid), alpha);
...
void PoissonEquationSolver::storeInnerSolution(DataVector& alpha,
