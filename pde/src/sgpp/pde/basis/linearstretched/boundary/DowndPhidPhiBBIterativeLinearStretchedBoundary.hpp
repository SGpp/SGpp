...
#ifndef DOWNDPHIDPHIDOWNBBITERATIVELINEARSTRETCHEDBOUNDARY_HPP
#define DOWNDPHIDPHIDOWNBBITERATIVELINEARSTRETCHEDBOUNDARY_HPP
...
namespace SGPP {
  namespace pde {
     ...
     * all ansatzfunctions
     */
    class DowndPhidPhiBBIterativeLinearStretchedBoundary {
      private:
      ...
      public:
         ...
         */
        DowndPhidPhiBBIterativeLinearStretchedBoundary(SGPP::base::GridStorage* storage);
