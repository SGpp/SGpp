...
namespace SGPP {
  namespace pde {
    ...
    void LaplaceEnhancedDownBBLinear::rec(float_t fl, float_t fr, size_t dim, grid_iterator& index) {
      ...
      ptr_result_[(seq * this->numAlgoDims_) + dim] =  (((h * tmp_m) + (((2.0 / 3.0) * h) * alpha_value)));
...
#else
    void LaplaceEnhancedDownBBLinear::rec_LL(float_t fl, float_t fr, float_t fl2, float_t fr2, size_t dim, grid_iterator& index)
#endif
#else
#ifdef __SSE3__
    void LaplaceEnhancedDownBBLinear::rec_LL(__m128d fl, __m128d fr, size_t dim, grid_iterator& index)
    ...
    void LaplaceEnhancedDownBBLinear::rec_LG(float_t fl, float_t fr, size_t dim, grid_iterator& index) {
      ...
      ptr_result_[(seq * this->numAlgoDims_) + dim + 1] = (static_cast<float_t>(1 << (l + 1)) * alpha_value2);
    ...
    void LaplaceEnhancedDownBBLinear::rec_GL(float_t fl, float_t fr, size_t dim, grid_iterator& index) {
      ...
      ptr_result_[(seq * this->numAlgoDims_) + dim] = ((static_cast<float_t>(1 << (l + 1))) * alpha_value);
      // L2 scalar product
      ptr_result_[(seq * this->numAlgoDims_) + dim + 1] = (((h * tmp_m) + (((2.0 / 3.0) * h) * alpha_value2)));
    ...
    void LaplaceEnhancedDownBBLinear::recBB(float_t fl, float_t fr, size_t dim, grid_iterator& index) {
      ...
      // L2 scalar product
      float_t tmp_m = ((fl + fr) * 0.5);
      ptr_result_[(seq * this->numAlgoDims_) + dim] = (((h * tmp_m) + (((2.0 / 3.0) * h) * alpha_value)) * q_);
      float_t fm = tmp_m + alpha_value;
    ...
    void LaplaceEnhancedDownBBLinear::recBB_LL(float_t fl, float_t fr, float_t fl2, float_t fr2, size_t dim, grid_iterator& index) {
      size_t seq = index.seq();
      SGPP::base::GridStorage::index_type::level_type l;
      SGPP::base::GridStorage::index_type::index_type i;
      index.get(cur_algo_dim_, l, i);
      ...
      ptr_result_[(seq * this->numAlgoDims_) + dim] = (((h * tmp_m) + (((2.0 / 3.0) * h) * alpha_value)) * q_);
      ptr_result_[(seq * this->numAlgoDims_) + dim + 1] = (((h * tmp_m2) + (((2.0 / 3.0) * h) * alpha_value2)) * q_);
      float_t fm = tmp_m + alpha_value;
      float_t fm2 = tmp_m2 + alpha_value2;
    ...
    void LaplaceEnhancedDownBBLinear::recBB_LG(float_t fl, float_t fr, size_t dim, grid_iterator& index) {
      size_t seq = index.seq();
      SGPP::base::GridStorage::index_type::level_type l;
      SGPP::base::GridStorage::index_type::index_type i;
      index.get(cur_algo_dim_, l, i);
      ...
      ptr_result_[(seq * this->numAlgoDims_) + dim] = (((h * tmp_m) + (((2.0 / 3.0) * h) * alpha_value)) * q_);
      // Gradient in second dimension
      ptr_result_[(seq * this->numAlgoDims_) + dim + 1] = ((static_cast<float_t>(1 << (l + 1)) / q_) * alpha_value2);
    ...
    void LaplaceEnhancedDownBBLinear::recBB_GL(float_t fl, float_t fr, size_t dim, grid_iterator& index) {
      size_t seq = index.seq();
      SGPP::base::GridStorage::index_type::level_type l;
      SGPP::base::GridStorage::index_type::index_type i;
      index.get(cur_algo_dim_, l, i);
      ...
      // L2 scalar product
      ptr_result_[(seq * this->numAlgoDims_) + dim + 1] = (((h * tmp_m) + (((2.0 / 3.0) * h) * alpha_value2)) * q_);
      float_t fm = tmp_m + alpha_value2;
