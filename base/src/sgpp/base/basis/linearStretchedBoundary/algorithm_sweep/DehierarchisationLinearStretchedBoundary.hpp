...
#include <sgpp/base/basis/linearStretched/algorithm_sweep/DehierarchisationLinearStretched.hpp>
...
namespace SGPP {
  namespace base {
     ...
     * the grid traversal
     */
    class DehierarchisationLinearStretchedBoundary : public DehierarchisationLinearStretched {
      public:
        /**
         ...
         * Destructor
         */
        virtual ~DehierarchisationLinearStretchedBoundary();
