...
void L0BoundaryGridGenerator::coarsen(CoarseningFunctor& func, std::vector<size_t>* removedSeq) {
  HashCoarsening coarsen;
  coarsen.free_coarsen(this->storage, func, nullptr, removedSeq);
}

void L0BoundaryGridGenerator::coarsenNFirstOnly(CoarseningFunctor& func, size_t numFirstOnly,
