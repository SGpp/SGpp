...
namespace SGPP {
  namespace base {
    ...
    void TruncatedBoundaryGridGenerator::regular(size_t level) {
      HashGenerator gen;
      gen.regularWithBoundaries(this->storage, static_cast<HashGenerator::level_t>(level), true);
    }

    void TruncatedBoundaryGridGenerator::cliques(size_t level, size_t clique_size) {
      throw generation_exception("Method is not implemented");
    }

    void TruncatedBoundaryGridGenerator::full(size_t level) {
      HashGenerator gen;
    ...
    void TruncatedBoundaryGridGenerator::refineMaxLevel(RefinementFunctor* func, size_t maxLevel) {
    ...
    size_t TruncatedBoundaryGridGenerator::getNumberOfRefinablePointsToMaxLevel(size_t maxLevel) {
      HashRefinementBoundariesMaxLevel refine;
