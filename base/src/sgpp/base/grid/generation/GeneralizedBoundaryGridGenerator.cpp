...
namespace SGPP {
  namespace base {
    ...
    GeneralizedBoundaryGridGenerator::GeneralizedBoundaryGridGenerator(GridStorage* storage) : storage(storage) {
    }
    ...
    void GeneralizedBoundaryGridGenerator::cliques(size_t level, size_t clique_size) {
