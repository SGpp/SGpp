 ...
 */
class ModPolyClenshawCurtisGrid : public Grid {
 protected:
  /**
   ...
   */
  explicit ModPolyClenshawCurtisGrid(std::istream& istr);
 ...
 public:
   ...
   */
  explicit ModPolyClenshawCurtisGrid(size_t dim, size_t degree);

  /**
   * Destructor.
   */
  ~ModPolyClenshawCurtisGrid() override;
 ...
 protected:
  ...
  size_t degree;
  /// modified polybasis
  std::unique_ptr<SPolyModifiedClenshawCurtisBase> basis_;
};
