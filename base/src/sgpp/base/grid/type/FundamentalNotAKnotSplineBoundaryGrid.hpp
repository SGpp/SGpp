...
#ifndef FUNDAMENTALNOTAKNOTSPLINETRUNCATEDBOUNDARYGRID_HPP
#define FUNDAMENTALNOTAKNOTSPLINETRUNCATEDBOUNDARYGRID_HPP
 ...
 */
class FundamentalNotAKnotSplineBoundaryGrid : public Grid {
 protected:
  /**
   ...
   */
  explicit FundamentalNotAKnotSplineBoundaryGrid(std::istream& istr);
 ...
 public:
   ...
   */
  FundamentalNotAKnotSplineBoundaryGrid(size_t dim, size_t degree, level_t boundaryLevel = 1);

  /**
   * Destructor.
   */
  ~FundamentalNotAKnotSplineBoundaryGrid() override;
 ...
 protected:
  ...
  std::unique_ptr<SFundamentalNotAKnotSplineBase> basis_;
...
#endif /* FUNDAMENTALNOTAKNOTSPLINETRUNCATEDBOUNDARYGRID_HPP */
