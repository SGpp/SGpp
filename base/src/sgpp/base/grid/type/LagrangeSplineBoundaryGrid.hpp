...
#ifndef LAGRANGESPLINETRUNCATEDBOUNDARYGRID_HPP
#define LAGRANGESPLINETRUNCATEDBOUNDARYGRID_HPP
...
/**
 * Grid with Lagrange spline basis functions
 */
class LagrangeSplineBoundaryGrid : public Grid {
 protected:
  /**
   ...
   */
  explicit LagrangeSplineBoundaryGrid(std::istream& istr);
 ...
 public:
   ...
   */
  LagrangeSplineBoundaryGrid(size_t dim, size_t degree, level_t boundaryLevel = 1);

  /**
   * Destructor.
   */
  ~LagrangeSplineBoundaryGrid() override;
 ...
 protected:
  ...
  size_t degree;
  /// B-spline basis
  std::unique_ptr<SLagrangeSplineBase> basis_;
...
#endif /* LAGRANGESPLINETRUNCATEDBOUNDARYGRID_HPP */
