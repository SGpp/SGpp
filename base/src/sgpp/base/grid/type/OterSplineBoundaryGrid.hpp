...
/**
 * Grid with Oter B-spline basis functions with not-a-knot boundary conditions
 */
class OterSplineBoundaryGrid : public Grid {
 protected:
  /**
   ...
   */
  explicit OterSplineBoundaryGrid(std::istream& istr);
 ...
 public:
   ...
   */
  OterSplineBoundaryGrid(size_t dim, size_t degree, level_t boundaryLevel = 1);

  /**
   * Destructor.
   */
  ~OterSplineBoundaryGrid() override;
 ...
 protected:
  ...
  size_t degree;
  /// B-spline basis
  std::unique_ptr<SOterSplineBoundaryBase> basis_;
