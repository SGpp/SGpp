 ...
 */
class LinearClenshawCurtisBoundaryGrid : public Grid {
 protected:
  explicit LinearClenshawCurtisBoundaryGrid(std::istream& istr);
 ...
 public:
   ...
   */
  explicit LinearClenshawCurtisBoundaryGrid(size_t dim, level_t boundaryLevel = 1);

  /**
   * Destructor
   */
  ~LinearClenshawCurtisBoundaryGrid() override;
