...
#ifndef FUNDAMENTALNAKSPLINETRUNCATEDBOUNDARYGRID_HPP
#define FUNDAMENTALNAKSPLINETRUNCATEDBOUNDARYGRID_HPP
 ...
 */
class FundamentalNakSplineBoundaryGrid : public Grid {
 protected:
  /**
   ...
   */
  explicit FundamentalNakSplineBoundaryGrid(std::istream& istr);
...
#endif /* FUNDAMENTALNAKSPLINETRUNCATEDBOUNDARYGRID_HPP */
