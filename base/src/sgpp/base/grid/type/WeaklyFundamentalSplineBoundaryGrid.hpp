...
#ifndef WEAKLYFUNDAMENTALSPLINETRUNCATEDBOUNDARYGRID_HPP
#define WEAKLYFUNDAMENTALSPLINETRUNCATEDBOUNDARYGRID_HPP
...
/**
 * Grid with weakly fundamental spline basis functions
 */
class WeaklyFundamentalSplineBoundaryGrid : public Grid {
 protected:
  /**
   ...
   */
  explicit WeaklyFundamentalSplineBoundaryGrid(std::istream& istr);
 ...
 public:
   ...
   */
  WeaklyFundamentalSplineBoundaryGrid(size_t dim, size_t degree, level_t boundaryLevel = 1);

  /**
   * Destructor.
   */
  ~WeaklyFundamentalSplineBoundaryGrid() override;
 ...
 protected:
  ...
  size_t degree;
  /// B-spline basis
  std::unique_ptr<SWeaklyFundamentalSplineBase> basis_;
...
#endif /* WEAKLYFUNDAMENTALSPLINETRUNCATEDBOUNDARYGRID_HPP */
