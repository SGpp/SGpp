...
double OperationEvalPartialDerivativeFundamentalNakSplineNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeFundamentalNakSplineNaive::evalPartialDerivative(
