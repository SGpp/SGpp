...
double OperationNaiveEvalHessianModFundamentalSpline::evalHessian(const DataVector& alpha,
...
void OperationNaiveEvalHessianModFundamentalSpline::evalHessian(const DataMatrix& alpha,
                                                                const DataVector& point,
                                                                DataVector& value,
                                                                DataMatrix& gradient,
