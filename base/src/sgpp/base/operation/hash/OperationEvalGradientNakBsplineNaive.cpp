...
double OperationEvalGradientNakBsplineNaive::evalGradient(const DataVector& alpha,
...
void OperationEvalGradientNakBsplineNaive::evalGradient(const DataMatrix& alpha,
