...
double OperationEvalPartialDerivativeModWeaklyFundamentalNotAKnotSplineNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeModWeaklyFundamentalNotAKnotSplineNaive::evalPartialDerivative(
