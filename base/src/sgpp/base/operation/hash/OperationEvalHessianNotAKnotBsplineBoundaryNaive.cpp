...
double OperationEvalHessianNotAKnotBsplineBoundaryNaive::evalHessian(const DataVector& alpha,
...
void OperationEvalHessianNotAKnotBsplineBoundaryNaive::evalHessian(const DataMatrix& alpha,
                                                             const DataVector& point,
                                                             DataVector& value,
                                                             DataMatrix& gradient,
