...
#ifndef OPERATIONEVALPARTIALDERIVATIVEWAVELETBOUNDARYNAIVE_HPP
#define OPERATIONEVALPARTIALDERIVATIVEWAVELETBOUNDARYNAIVE_HPP
...
class OperationEvalPartialDerivativeWaveletBoundaryNaive :
 ...
 public:
   ...
   */
  explicit OperationEvalPartialDerivativeWaveletBoundaryNaive(GridStorage& storage) :
    storage(storage),
   ...
   * Destructor.
   */
  ~OperationEvalPartialDerivativeWaveletBoundaryNaive() override {
  }
...
#endif /* OPERATIONEVALPARTIALDERIVATIVEWAVELETBOUNDARYNAIVE_HPP */
