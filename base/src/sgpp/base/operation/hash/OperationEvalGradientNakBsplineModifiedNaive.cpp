...
double OperationEvalGradientNakBsplineModifiedNaive::evalGradient(const DataVector& alpha,
...
void OperationEvalGradientNakBsplineModifiedNaive::evalGradient(const DataMatrix& alpha,
                                                                const DataVector& point,
                                                                DataVector& value,
                                                                DataMatrix& gradient) {
  const size_t n = storage.getSize();
