...
#ifndef OPERATIONEVALPARTIALDERIVATIVEMODWAVELETNAIVE_HPP
#define OPERATIONEVALPARTIALDERIVATIVEMODWAVELETNAIVE_HPP
...
class OperationEvalPartialDerivativeModWaveletNaive :
 ...
 public:
   ...
   */
  explicit OperationEvalPartialDerivativeModWaveletNaive(GridStorage& storage) :
    storage(storage),
...
#endif /* OPERATIONEVALPARTIALDERIVATIVEMODWAVELETNAIVE_HPP */
