...
double OperationNaiveEvalGradientModFundamentalSpline::evalGradient(const DataVector& alpha,
...
void OperationNaiveEvalGradientModFundamentalSpline::evalGradient(const DataMatrix& alpha,
                                                                  const DataVector& point,
                                                                  DataVector& value,
                                                                  DataMatrix& gradient) {
  const size_t n = storage.getSize();
