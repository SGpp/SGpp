...
class OperationEvalPartialDerivativeModFundamentalSplineNaive :
 ...
 public:
   ...
   */
  OperationEvalPartialDerivativeModFundamentalSplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalPartialDerivativeModFundamentalSplineNaive() override {
  }
