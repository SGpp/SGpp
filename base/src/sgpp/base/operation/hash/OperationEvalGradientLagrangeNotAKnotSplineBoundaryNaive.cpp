...
double OperationEvalGradientLagrangeNotAKnotSplineBoundaryNaive::evalGradient(
...
void OperationEvalGradientLagrangeNotAKnotSplineBoundaryNaive::evalGradient(const DataMatrix& alpha,
                                                               const DataVector& point,
                                                               DataVector& value,
                                                               DataMatrix& gradient) {
  const size_t n = storage.getSize();
