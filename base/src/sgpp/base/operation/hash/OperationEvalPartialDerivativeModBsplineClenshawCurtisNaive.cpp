...
double OperationEvalPartialDerivativeModBsplineClenshawCurtisNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeModBsplineClenshawCurtisNaive::evalPartialDerivative(
