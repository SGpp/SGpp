...
#ifndef OPERATIONEVALPARTIALDERIVATIVEFUNDAMENTALNAKSPLINE_HPP
#define OPERATIONEVALPARTIALDERIVATIVEFUNDAMENTALNAKSPLINE_HPP
...
class OperationEvalPartialDerivativeFundamentalNakSplineNaive :
 ...
 public:
   ...
   */
  OperationEvalPartialDerivativeFundamentalNakSplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalPartialDerivativeFundamentalNakSplineNaive() override {
  }
...
#endif /* OPERATIONEVALPARTIALDERIVATIVEFUNDAMENTALNAKSPLINE_HPP */
