...
double OperationEvalPartialDerivativeWeaklyFundamentalNotAKnotSplineBoundaryNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeWeaklyFundamentalNotAKnotSplineBoundaryNaive::evalPartialDerivative(
