...
#ifndef OPERATIONQUADRATUREBSPLINEBOUNDARY_HPP
#define OPERATIONQUADRATUREBSPLINEBOUNDARY_HPP
 ...
 */
class OperationQuadratureBsplineBoundary : public OperationQuadrature {
 public:
  /**
   ...
   */
  OperationQuadratureBsplineBoundary(GridStorage& storage,
                                  size_t degree) : storage(storage), base(degree) {}

  ~OperationQuadratureBsplineBoundary() override {}
...
#endif /* OPERATIONQUADRATUREBSPLINEBOUNDARY_HPP */
