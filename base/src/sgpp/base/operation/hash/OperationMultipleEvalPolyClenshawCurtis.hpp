 ...
 */
class OperationMultipleEvalPolyClenshawCurtis : public OperationMultipleEval {
 public:
  /**
   * Constructor
   *
   ...
   */
  OperationMultipleEvalPolyClenshawCurtis(Grid& grid, size_t degree, DataMatrix& dataset)
      : OperationMultipleEval(grid, dataset), storage(grid.getStorage()), base(degree) {}

  /**
   * Destructor
   */
  ~OperationMultipleEvalPolyClenshawCurtis() override {}
