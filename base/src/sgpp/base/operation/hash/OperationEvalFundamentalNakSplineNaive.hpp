...
#ifndef OPERATIONEVALFUNDAMENTALNAKSPLINENAIVE_HPP
#define OPERATIONEVALFUNDAMENTALNAKSPLINENAIVE_HPP
 ...
 */
class OperationEvalFundamentalNakSplineNaive : public OperationEval {
 public:
  /**
   * Constructor.
   *
...
#endif /* OPERATIONEVALFUNDAMENTALNAKSPLINENAIVE_HPP */
