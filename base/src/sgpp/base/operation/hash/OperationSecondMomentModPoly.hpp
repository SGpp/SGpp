...
#ifndef OPERATIONSECONDMOMENTMODPOLY_HPP
#define OPERATIONSECONDMOMENTMODPOLY_HPP
 ...
 */
class OperationSecondMomentModPoly : public OperationSecondMoment {
 public:
  /**
...
#endif /* OPERATIONSECONDMOMENTMODPOLY_HPP */
