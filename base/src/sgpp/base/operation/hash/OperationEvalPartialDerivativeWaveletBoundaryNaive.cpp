...
double OperationEvalPartialDerivativeWaveletBoundaryNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeWaveletBoundaryNaive::evalPartialDerivative(
