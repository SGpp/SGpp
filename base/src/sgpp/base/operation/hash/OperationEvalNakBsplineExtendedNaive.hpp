...
/**
 * Operation for evaluating Extended B-spline linear combinations on Noboundary grids.
 */
class OperationEvalNakBsplineExtendedNaive : public OperationEval {
 public:
  /**
   * Constructor.
   *
   ...
   */
  OperationEvalNakBsplineExtendedNaive(GridStorage& storage, size_t degree)
      : storage(storage), base(degree), pointInUnitCube(storage.getDimension()) {}

  /**
   * Destructor.
   */
  ~OperationEvalNakBsplineExtendedNaive() override {}
