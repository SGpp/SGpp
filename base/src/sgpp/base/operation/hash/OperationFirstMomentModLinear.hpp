...
#ifndef OPERATIONFIRSTMOMENTMODLINEAR_HPP
#define OPERATIONFIRSTMOMENTMODLINEAR_HPP
 ...
 */
class OperationFirstMomentModLinear : public OperationFirstMoment {
 public:
  /**
   * Constructor of OperationFirstMomentModLinear
   *
   * @param storage sparse grid storage object
   */
...
#endif /* OPERATIONFIRSTMOMENTMODLINEAR_HPP */
