 ...
 * gradients.
 */
class OperationEvalGradientNakBsplineModifiedNaive : public OperationEvalGradient {
 public:
  /**
   * Constructor.
   *
   ...
   */
  OperationEvalGradientNakBsplineModifiedNaive(GridStorage& storage, size_t degree)
      : storage(storage),
        base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalGradientNakBsplineModifiedNaive() override {}
