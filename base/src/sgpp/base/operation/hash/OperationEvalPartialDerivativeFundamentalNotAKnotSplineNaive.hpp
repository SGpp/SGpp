...
#ifndef OPERATIONEVALPARTIALDERIVATIVEFUNDAMENTALNOTAKNOTSPLINE_HPP
#define OPERATIONEVALPARTIALDERIVATIVEFUNDAMENTALNOTAKNOTSPLINE_HPP
...
/**
 * Operation for evaluating partial derivatives of fundamental not-a-knot spline
 * linear combinations.
 */
class OperationEvalPartialDerivativeFundamentalNotAKnotSplineNaive :
 ...
 public:
   ...
   */
  OperationEvalPartialDerivativeFundamentalNotAKnotSplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalPartialDerivativeFundamentalNotAKnotSplineNaive() override {
  }
...
#endif /* OPERATIONEVALPARTIALDERIVATIVEFUNDAMENTALNOTAKNOTSPLINE_HPP */
