...
double OperationEvalModLinearClenshawCurtisNaive::eval(const DataVector& alpha,
...
void OperationEvalModLinearClenshawCurtisNaive::eval(const DataMatrix& alpha,
