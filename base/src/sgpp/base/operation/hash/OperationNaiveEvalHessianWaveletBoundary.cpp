...
double OperationNaiveEvalHessianWaveletBoundary::evalHessian(const DataVector& alpha,
...
void OperationNaiveEvalHessianWaveletBoundary::evalHessian(const DataMatrix& alpha,
                                                           const DataVector& point,
                                                           DataVector& value,
                                                           DataMatrix& gradient,
