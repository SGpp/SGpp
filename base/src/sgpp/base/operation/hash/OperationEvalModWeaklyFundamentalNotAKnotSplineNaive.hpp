...
#ifndef OPERATIONEVALMODWEAKLYFUNDAMENTALNOTAKNOTSPLINENAIVE_HPP
#define OPERATIONEVALMODWEAKLYFUNDAMENTALNOTAKNOTSPLINENAIVE_HPP
 ...
 */
class OperationEvalModWeaklyFundamentalNotAKnotSplineNaive : public OperationEval {
 public:
  /**
   * Constructor.
   *
   ...
   */
  OperationEvalModWeaklyFundamentalNotAKnotSplineNaive(GridStorage& storage, size_t degree) :
   ...
   * Destructor.
   */
  ~OperationEvalModWeaklyFundamentalNotAKnotSplineNaive() override {
  }
...
#endif /* OPERATIONEVALMODWEAKLYFUNDAMENTALNOTAKNOTSPLINENAIVE_HPP */
