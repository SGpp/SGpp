...
#ifndef OPERATIONEVALHESSIANMODWAVELETNAIVE_HPP
#define OPERATIONEVALHESSIANMODWAVELETNAIVE_HPP
 ...
 */
class OperationEvalHessianModWaveletNaive : public OperationEvalHessian {
 public:
  /**
   * Constructor.
   *
   ...
   */
  explicit OperationEvalHessianModWaveletNaive(GridStorage& storage) :
    storage(storage),
   ...
   * Destructor.
   */
  ~OperationEvalHessianModWaveletNaive() override {
  }
...
#endif /* OPERATIONEVALHESSIANMODWAVELETNAIVE_HPP */
