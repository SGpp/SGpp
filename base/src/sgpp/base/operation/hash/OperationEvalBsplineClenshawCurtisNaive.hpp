...
#ifndef OPERATIONEVALBSPLINECLENSHAWCURTISNAIVE_HPP
#define OPERATIONEVALBSPLINECLENSHAWCURTISNAIVE_HPP
 ...
 */
class OperationEvalBsplineClenshawCurtisNaive : public OperationEval {
 public:
  /**
   * Constructor.
   *
...
#endif /* OPERATIONEVALBSPLINECLENSHAWCURTISNAIVE_HPP */
