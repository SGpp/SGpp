...
double OperationEvalHessianModWaveletNaive::evalHessian(const DataVector& alpha,
...
void OperationEvalHessianModWaveletNaive::evalHessian(const DataMatrix& alpha,
                                                      const DataVector& point,
                                                      DataVector& value,
                                                      DataMatrix& gradient,
