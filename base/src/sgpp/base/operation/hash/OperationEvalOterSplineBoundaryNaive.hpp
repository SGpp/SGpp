 ...
 * boundary conditions.
 */
class OperationEvalOterSplineBoundaryNaive : public OperationEval {
 public:
  /**
   * Constructor.
   *
   ...
   */
  OperationEvalOterSplineBoundaryNaive(GridStorage& storage, size_t degree)
      : storage(storage), base(degree), pointInUnitCube(storage.getDimension()) {}

  /**
   * Destructor.
   */
  ~OperationEvalOterSplineBoundaryNaive() override {}
