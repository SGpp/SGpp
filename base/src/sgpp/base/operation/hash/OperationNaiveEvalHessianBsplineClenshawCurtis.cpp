...
double OperationNaiveEvalHessianBsplineClenshawCurtis::evalHessian(const DataVector& alpha,
...
void OperationNaiveEvalHessianBsplineClenshawCurtis::evalHessian(const DataMatrix& alpha,
                                                                 const DataVector& point,
                                                                 DataVector& value,
                                                                 DataMatrix& gradient,
