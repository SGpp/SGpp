 ...
 * gradients.
 */
class OperationEvalGradientNakPBsplineNaive : public OperationEvalGradient {
 public:
  /**
   * Constructor.
   *
   ...
   */
  OperationEvalGradientNakPBsplineNaive(GridStorage& storage, size_t degree)
      : storage(storage),
        base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalGradientNakPBsplineNaive() override {}
