...
#ifndef OPERATIONEVALGRADIENTWAVELETBOUNDARYNAIVE_HPP
#define OPERATIONEVALGRADIENTWAVELETBOUNDARYNAIVE_HPP
 ...
 */
class OperationEvalGradientWaveletBoundaryNaive : public
 ...
 public:
   ...
   */
  explicit OperationEvalGradientWaveletBoundaryNaive(GridStorage& storage) :
    storage(storage),
   ...
   * Destructor.
   */
  ~OperationEvalGradientWaveletBoundaryNaive() override {
  }
...
#endif /* OPERATIONEVALGRADIENTWAVELETBOUNDARYNAIVE_HPP */
