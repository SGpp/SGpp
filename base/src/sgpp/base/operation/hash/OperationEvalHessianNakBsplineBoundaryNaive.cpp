...
double OperationEvalHessianNakBsplineBoundaryNaive::evalHessian(const DataVector& alpha,
...
void OperationEvalHessianNakBsplineBoundaryNaive::evalHessian(const DataMatrix& alpha,
                                                             const DataVector& point,
                                                             DataVector& value,
                                                             DataMatrix& gradient,
