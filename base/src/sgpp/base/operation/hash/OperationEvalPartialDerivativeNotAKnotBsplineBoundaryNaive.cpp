...
double OperationEvalPartialDerivativeNotAKnotBsplineBoundaryNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeNotAKnotBsplineBoundaryNaive::evalPartialDerivative(
