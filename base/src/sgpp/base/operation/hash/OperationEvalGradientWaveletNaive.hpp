...
#ifndef OPERATIONEVALGRADIENTWAVELETNAIVE_HPP
#define OPERATIONEVALGRADIENTWAVELETNAIVE_HPP
 ...
 */
class OperationEvalGradientWaveletNaive : public OperationEvalGradient {
 public:
  /**
   * Constructor.
   *
   ...
   */
  explicit OperationEvalGradientWaveletNaive(GridStorage& storage) :
    storage(storage),
...
#endif /* OPERATIONEVALGRADIENTWAVELETNAIVE_HPP */
