...
double OperationEvalHessianWaveletBoundaryNaive::evalHessian(const DataVector& alpha,
...
void OperationEvalHessianWaveletBoundaryNaive::evalHessian(const DataMatrix& alpha,
                                                           const DataVector& point,
                                                           DataVector& value,
                                                           DataMatrix& gradient,
