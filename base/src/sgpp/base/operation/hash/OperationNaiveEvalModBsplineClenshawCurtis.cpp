...
double OperationNaiveEvalModBsplineClenshawCurtis::eval(
  ...
  for (size_t i = 0; i < n; i++) {
    ...
    for (size_t t = 0; t < d; t++) {
      const double val1d = base.eval(gp.getLevel(t), gp.getIndex(t),
                                      point[t]);
...
void OperationNaiveEvalModBsplineClenshawCurtis::eval(const DataMatrix& alpha,
