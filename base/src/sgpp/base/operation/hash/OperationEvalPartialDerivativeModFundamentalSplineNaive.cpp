...
double OperationEvalPartialDerivativeModFundamentalSplineNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeModFundamentalSplineNaive::evalPartialDerivative(
