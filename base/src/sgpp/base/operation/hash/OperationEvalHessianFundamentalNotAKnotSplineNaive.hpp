...
#ifndef OPERATIONEVALHESSIANFUNDAMENTALNOTAKNOTSPLINE_HPP
#define OPERATIONEVALHESSIANFUNDAMENTALNOTAKNOTSPLINE_HPP
 ...
 */
class OperationEvalHessianFundamentalNotAKnotSplineNaive : public
 ...
 public:
   ...
   */
  OperationEvalHessianFundamentalNotAKnotSplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalHessianFundamentalNotAKnotSplineNaive() override {
  }
...
#endif /* OPERATIONEVALHESSIANFUNDAMENTALNOTAKNOTSPLINE_HPP */
