...
double OperationEvalGradientNakPBsplineNaive::evalGradient(const DataVector& alpha,
...
void OperationEvalGradientNakPBsplineNaive::evalGradient(const DataMatrix& alpha,
