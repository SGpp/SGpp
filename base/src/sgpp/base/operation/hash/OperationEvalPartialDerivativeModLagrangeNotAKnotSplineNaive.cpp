...
double OperationEvalPartialDerivativeModLagrangeNotAKnotSplineNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeModLagrangeNotAKnotSplineNaive::evalPartialDerivative(
