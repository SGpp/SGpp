...
double OperationEvalHessianLagrangeSplineBoundaryNaive::evalHessian(const DataVector& alpha,
...
void OperationEvalHessianLagrangeSplineBoundaryNaive::evalHessian(const DataMatrix& alpha,
                                                             const DataVector& point,
                                                             DataVector& value,
                                                             DataMatrix& gradient,
