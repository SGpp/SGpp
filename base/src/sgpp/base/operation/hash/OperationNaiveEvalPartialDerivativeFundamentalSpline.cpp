...
double OperationNaiveEvalPartialDerivativeFundamentalSpline::evalPartialDerivative(
...
void OperationNaiveEvalPartialDerivativeFundamentalSpline::evalPartialDerivative(
