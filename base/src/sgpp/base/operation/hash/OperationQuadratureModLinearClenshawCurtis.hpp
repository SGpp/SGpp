 ...
 */
class OperationQuadratureModLinearClenshawCurtis : public OperationQuadrature {
 public:
  /**
   ...
   */
  explicit OperationQuadratureModLinearClenshawCurtis(GridStorage& storage) : storage(storage) {}

  ~OperationQuadratureModLinearClenshawCurtis() override {}
