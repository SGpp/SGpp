 ...
 */
class OperationHierarchisationModLinearClenshawCurtis : public OperationHierarchisation {
 public:
  /**
   * Constructor
   *
   ...
   */
  OperationHierarchisationModLinearClenshawCurtis(GridStorage& storage) : storage(storage) {}

  /**
   * Destructor
   */
  ~OperationHierarchisationModLinearClenshawCurtis() override {}
