 ...
 * and their Hessians.
 */
class OperationEvalHessianFundamentalSplineNaive : public
 ...
 public:
   ...
   */
  OperationEvalHessianFundamentalSplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalHessianFundamentalSplineNaive() override {
  }
