...
#ifndef OPERATIONEVALPARTIALDERIVATIVEWEAKLYFUNDAMENTALNAKSPLINEBOUNDARY_HPP
#define OPERATIONEVALPARTIALDERIVATIVEWEAKLYFUNDAMENTALNAKSPLINEBOUNDARY_HPP
...
class OperationEvalPartialDerivativeWeaklyFundamentalNakSplineBoundaryNaive :
 ...
 public:
   ...
   */
  OperationEvalPartialDerivativeWeaklyFundamentalNakSplineBoundaryNaive(
   ...
   * Destructor.
   */
  ~OperationEvalPartialDerivativeWeaklyFundamentalNakSplineBoundaryNaive() override {
  }
...
#endif /* OPERATIONEVALPARTIALDERIVATIVEWEAKLYFUNDAMENTALNAKSPLINEBOUNDARY_HPP */
