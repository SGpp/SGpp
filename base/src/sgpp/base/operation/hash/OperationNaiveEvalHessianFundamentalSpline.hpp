...
namespace SGPP {
  namespace base {
     ...
     * and their Hessians.
     */
    class OperationNaiveEvalHessianFundamentalSpline : public OperationNaiveEvalHessian {
      public:
        /**
         * Constructor.
         *
         ...
         */
        OperationNaiveEvalHessianFundamentalSpline(GridStorage* storage, size_t degree) :
