...
#ifndef OPERATIONEVALPARTIALDERIVATIVELAGRANGENOTAKNOTSPLINEBOUNDARY_HPP
#define OPERATIONEVALPARTIALDERIVATIVELAGRANGENOTAKNOTSPLINEBOUNDARY_HPP
 ...
 */
class OperationEvalPartialDerivativeLagrangeNotAKnotSplineBoundaryNaive :
 ...
 public:
   ...
   */
  OperationEvalPartialDerivativeLagrangeNotAKnotSplineBoundaryNaive(
   ...
   * Destructor.
   */
  ~OperationEvalPartialDerivativeLagrangeNotAKnotSplineBoundaryNaive() override {
  }
...
#endif /* OPERATIONEVALPARTIALDERIVATIVELAGRANGENOTAKNOTSPLINEBOUNDARY_HPP */
