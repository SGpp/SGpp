...
double OperationEvalPartialDerivativeModWeaklyFundamentalNakSplineNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeModWeaklyFundamentalNakSplineNaive::evalPartialDerivative(
