 ...
 *
 * OperationMultipleEvalPartialDerivativeModBsplineNaive.cpp
 *
 * Author: Paul Sarbu
 */
...
void OperationMultipleEvalPartialDerivativeModBsplineNaive::mult(DataVector& alpha,
                                                                 DataVector& result) {
...
void OperationMultipleEvalPartialDerivativeModBsplineNaive::multTranspose(DataVector& alpha,
                                                                          DataVector& result) {
  const size_t n = storage.getSize();
  const size_t d = storage.getDimension();
  const size_t m = dataset.getNrows();
...
double OperationMultipleEvalPartialDerivativeModBsplineNaive::getDuration() { return 0.0; }
