...
double OperationEvalPartialDerivativeFundamentalNotAKnotSplineNaive::evalPartialDerivative(
  ...
  for (size_t i = 0; i < n; i++) {
    ...
    const double dx1d = base.evalDx(gp.getLevel(derivDim), gp.getIndex(derivDim),
...
void OperationEvalPartialDerivativeFundamentalNotAKnotSplineNaive::evalPartialDerivative(
