...
#ifndef OPERATIONEVALHESSIANMODWEAKLYFUNDAMENTALNAKSPLINE_HPP
#define OPERATIONEVALHESSIANMODWEAKLYFUNDAMENTALNAKSPLINE_HPP
 ...
 */
class OperationEvalHessianModWeaklyFundamentalNakSplineNaive : public
 ...
 public:
   ...
   */
  OperationEvalHessianModWeaklyFundamentalNakSplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
    baseDeriv1(degree),
    baseDeriv2(degree),
   ...
   * Destructor.
   */
  ~OperationEvalHessianModWeaklyFundamentalNakSplineNaive() override {
  }
 ...
 protected:
  ...
  SWeaklyFundamentalNakSplineModifiedBaseDeriv2 baseDeriv2;
...
#endif /* OPERATIONEVALHESSIANMODWEAKLYFUNDAMENTALNAKSPLINE_HPP */
