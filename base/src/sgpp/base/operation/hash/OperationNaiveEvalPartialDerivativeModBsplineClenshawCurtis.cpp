...
double OperationNaiveEvalPartialDerivativeModBsplineClenshawCurtis::evalPartialDerivative(
...
void OperationNaiveEvalPartialDerivativeModBsplineClenshawCurtis::evalPartialDerivative(
