...
double OperationEvalHessianFundamentalNotAKnotSplineNaive::evalHessian(const DataVector& alpha,
...
void OperationEvalHessianFundamentalNotAKnotSplineNaive::evalHessian(const DataMatrix& alpha,
                                                             const DataVector& point,
                                                             DataVector& value,
                                                             DataMatrix& gradient,
