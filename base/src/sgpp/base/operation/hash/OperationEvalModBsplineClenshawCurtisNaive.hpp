...
#ifndef OPERATIONEVALMODBSPLINECLENSHAWCURTISNAIVE_HPP
#define OPERATIONEVALMODBSPLINECLENSHAWCURTISNAIVE_HPP
 ...
 */
class OperationEvalModBsplineClenshawCurtisNaive : public OperationEval {
 public:
  /**
   * Constructor.
   *
   ...
   */
  OperationEvalModBsplineClenshawCurtisNaive(GridStorage& storage, size_t degree) :
   ...
   * Destructor.
   */
  ~OperationEvalModBsplineClenshawCurtisNaive() override {
  }
...
#endif /* OPERATIONEVALMODBSPLINECLENSHAWCURTISNAIVE_HPP */
