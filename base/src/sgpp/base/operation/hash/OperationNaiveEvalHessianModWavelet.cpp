...
double OperationNaiveEvalHessianModWavelet::evalHessian(const DataVector& alpha,
...
void OperationNaiveEvalHessianModWavelet::evalHessian(const DataMatrix& alpha,
                                                      const DataVector& point,
                                                      DataVector& value,
                                                      DataMatrix& gradient,
