...
double OperationEvalPartialDerivativeBsplineBoundaryNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeBsplineBoundaryNaive::evalPartialDerivative(
