...
#ifndef OPERATIONEVALHESSIANNAKSPLINEBOUNDARY_HPP
#define OPERATIONEVALHESSIANNAKSPLINEBOUNDARY_HPP
 ...
 */
class OperationEvalHessianNakBsplineBoundaryNaive : public
...
#endif /* OPERATIONEVALHESSIANNAKSPLINEBOUNDARY_HPP */
