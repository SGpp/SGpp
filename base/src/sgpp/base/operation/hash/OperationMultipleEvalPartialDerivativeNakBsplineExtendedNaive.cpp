...
void OperationMultipleEvalPartialDerivativeNakBsplineExtendedNaive::mult(DataVector& alpha,
                                                                         DataVector& result) {
...
void OperationMultipleEvalPartialDerivativeNakBsplineExtendedNaive::multTranspose(
...
double OperationMultipleEvalPartialDerivativeNakBsplineExtendedNaive::getDuration() { return 0.0; }
