...
#ifndef OPERATIONEVALHESSIANMODNOTAKNOTSPLINE_HPP
#define OPERATIONEVALHESSIANMODNOTAKNOTSPLINE_HPP
 ...
 */
class OperationEvalHessianModNotAKnotBsplineNaive : public
 ...
 public:
   ...
   */
  OperationEvalHessianModNotAKnotBsplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
    baseDeriv1(degree),
    baseDeriv2(degree),
   ...
   * Destructor.
   */
  ~OperationEvalHessianModNotAKnotBsplineNaive() override {
  }
 ...
 protected:
  ...
  SNotAKnotBsplineModifiedBaseDeriv2 baseDeriv2;
...
#endif /* OPERATIONEVALHESSIANMODNOTAKNOTSPLINE_HPP */
