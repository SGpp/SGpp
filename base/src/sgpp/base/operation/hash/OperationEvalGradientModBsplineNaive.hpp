 ...
 * their gradients.
 */
class OperationEvalGradientModBsplineNaive : public OperationEvalGradient {
 public:
  /**
   * Constructor.
   *
   ...
   */
  OperationEvalGradientModBsplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalGradientModBsplineNaive() override {
  }
