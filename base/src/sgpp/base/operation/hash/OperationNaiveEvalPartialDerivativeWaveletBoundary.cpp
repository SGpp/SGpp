...
double OperationNaiveEvalPartialDerivativeWaveletBoundary::evalPartialDerivative(
...
void OperationNaiveEvalPartialDerivativeWaveletBoundary::evalPartialDerivative(
