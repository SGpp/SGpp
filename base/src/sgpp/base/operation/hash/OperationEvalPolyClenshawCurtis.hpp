 ...
 *
 */
class OperationEvalPolyClenshawCurtis : public OperationEval {
 public:
  /**
   * Constructor
   *
   ...
   */
  OperationEvalPolyClenshawCurtis(GridStorage& storage, size_t degree)
      : storage(storage), base(degree) {}

  /**
   * Destructor
   */
  ~OperationEvalPolyClenshawCurtis() override {}
