 ...
 */
class OperationEvalGradientBsplineBoundaryNaive : public
 ...
 public:
   ...
   */
  OperationEvalGradientBsplineBoundaryNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalGradientBsplineBoundaryNaive() override {
  }
