...
double OperationEvalPartialDerivativeBsplineClenshawCurtisNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeBsplineClenshawCurtisNaive::evalPartialDerivative(
