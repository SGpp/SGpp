...
double OperationEvalHessianFundamentalNakSplineNaive::evalHessian(const DataVector& alpha,
...
void OperationEvalHessianFundamentalNakSplineNaive::evalHessian(const DataMatrix& alpha,
                                                             const DataVector& point,
                                                             DataVector& value,
                                                             DataMatrix& gradient,
