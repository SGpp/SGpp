...
#ifndef NOTAKNOT_BSPLINE_BASE_DERIV1_HPP
#define NOTAKNOT_BSPLINE_BASE_DERIV1_HPP
...
class NotAKnotBsplineBasisDeriv1: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  NotAKnotBsplineBasisDeriv1() : bsplineBasis(BsplineBasis<LT, IT>()) {
  }
   ...
   */
  explicit NotAKnotBsplineBasisDeriv1(size_t degree) :
   ...
   * Destructor.
   */
  ~NotAKnotBsplineBasisDeriv1() override {
  }
...
typedef NotAKnotBsplineBasisDeriv1<unsigned int, unsigned int> SNotAKnotBsplineBaseDeriv1;

}  // namespace base
}  // namespace sgpp

#endif /* NOTAKNOT_BSPLINE_BASE_DERIV1_HPP */
