...
#ifndef WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_BASE_DERIV2_HPP
#define WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_BASE_DERIV2_HPP
...
class WeaklyFundamentalNotAKnotSplineBasisDeriv2: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  WeaklyFundamentalNotAKnotSplineBasisDeriv2() :
   ...
   */
  explicit WeaklyFundamentalNotAKnotSplineBasisDeriv2(size_t degree) :
   ...
   * Destructor.
   */
  ~WeaklyFundamentalNotAKnotSplineBasisDeriv2() override {
  }
...
typedef WeaklyFundamentalNotAKnotSplineBasisDeriv2<unsigned int, unsigned int>
SWeaklyFundamentalNotAKnotSplineBaseDeriv2;

}  // namespace base
}  // namespace sgpp

#endif /* WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_BASE_DERIV2_HPP */
