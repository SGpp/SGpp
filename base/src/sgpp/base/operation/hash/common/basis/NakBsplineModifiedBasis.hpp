...
//     std::cerr << "NakBsplineModifiedBasis: evalDx not implemented" << std::endl;
//     return -1;
//   }
...
//     double temp_res = basisMean(l, i, start, stop, offset, hik, quadCoordinates, quadWeights,
//     pdf); double mean = temp_res * hik;
