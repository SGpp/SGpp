...
#ifndef LAGRANGE_SPLINE_BASE_DERIV1_HPP
#define LAGRANGE_SPLINE_BASE_DERIV1_HPP
...
/**
 * Lagrange spline basis (1st derivative).
 */
template <class LT, class IT>
class LagrangeSplineBasisDeriv1: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  LagrangeSplineBasisDeriv1() : degree(0) {
  }
   ...
   */
  explicit LagrangeSplineBasisDeriv1(size_t degree) : degree(degree) {
    if (degree < 1) {
      this->degree = 1;
    } else if (degree % 2 == 0) {
   ...
   * Destructor.
   */
  ~LagrangeSplineBasisDeriv1() override {
  }
...
typedef LagrangeSplineBasisDeriv1<unsigned int, unsigned int> SLagrangeSplineBaseDeriv1;

}  // namespace base
}  // namespace sgpp

#endif /* LAGRANGE_SPLINE_BASE_DERIV1_HPP */
