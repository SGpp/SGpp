...
class NotAKnotBsplineBoundaryBasis : public Basis<LT, IT> {
 public:
   ...
   * Default constructor.
   */
  NotAKnotBsplineBoundaryBasis() : bsplineBasis(BsplineBasis<LT, IT>()) {}
   ...
   */
  explicit NotAKnotBsplineBoundaryBasis(size_t degree)
   ...
   * Destructor.
   */
  ~NotAKnotBsplineBoundaryBasis() override {}
...
typedef NotAKnotBsplineBoundaryBasis<unsigned int, unsigned int> SNotAKnotBsplineBoundaryBase;
