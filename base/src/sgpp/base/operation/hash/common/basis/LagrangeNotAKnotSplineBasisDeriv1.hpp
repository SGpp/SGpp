...
#ifndef LAGRANGE_NOTAKNOT_SPLINE_BASE_DERIV1_HPP
#define LAGRANGE_NOTAKNOT_SPLINE_BASE_DERIV1_HPP
...
/**
 * Lagrange not-a-knot spline basis (1st derivative).
 */
template <class LT, class IT>
class LagrangeNotAKnotSplineBasisDeriv1: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  LagrangeNotAKnotSplineBasisDeriv1() :
    lagrangeSplineBasisDeriv1(LagrangeSplineBasisDeriv1<LT, IT>()) {
  }
   ...
   */
  explicit LagrangeNotAKnotSplineBasisDeriv1(size_t degree) :
        lagrangeSplineBasisDeriv1(LagrangeSplineBasisDeriv1<LT, IT>(degree)) {
    if (getDegree() > 7) {
   ...
   * Destructor.
   */
  ~LagrangeNotAKnotSplineBasisDeriv1() override {
  }
  ...
  inline double eval(LT l, IT i, double x) override {
    ...
    switch (getDegree()) {
      case 1:
        return lagrangeSplineBasisDeriv1.eval(l, i, x);
  ...
  inline size_t getDegree() const {
    return lagrangeSplineBasisDeriv1.getDegree();
  }

 protected:
  /// B-spline basis for B-spline evaluation
  LagrangeSplineBasisDeriv1<LT, IT> lagrangeSplineBasisDeriv1;
};

// default type-def (unsigned int for level and index)
typedef LagrangeNotAKnotSplineBasisDeriv1<unsigned int, unsigned int>
SLagrangeNotAKnotSplineBaseDeriv1;

}  // namespace base
}  // namespace sgpp

#endif /* LAGRANGE_NOTAKNOT_SPLINE_BASE_DERIV1_HPP */
