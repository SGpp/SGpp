...
#ifndef LAGRANGE_NOTAKNOT_SPLINE_MODIFIED_BASE_DERIV1_HPP
#define LAGRANGE_NOTAKNOT_SPLINE_MODIFIED_BASE_DERIV1_HPP
...
class LagrangeNotAKnotSplineModifiedBasisDeriv1: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  LagrangeNotAKnotSplineModifiedBasisDeriv1() :
    lagrangeNotAKnotSplineBasisDeriv1(LagrangeNotAKnotSplineBasisDeriv1<LT, IT>()) {
  }
   ...
   */
  explicit LagrangeNotAKnotSplineModifiedBasisDeriv1(size_t degree) :
    lagrangeNotAKnotSplineBasisDeriv1(LagrangeNotAKnotSplineBasisDeriv1<LT, IT>(degree)) {
    if (getDegree() > 7) {
   ...
   * Destructor.
   */
  ~LagrangeNotAKnotSplineModifiedBasisDeriv1() override {
  }
  ...
  inline double eval(LT l, IT i, double x) override {
    ...
    switch (getDegree()) {
      case 1:
        return lagrangeNotAKnotSplineBasisDeriv1.eval(l, i, x);
  ...
  inline size_t getDegree() const {
    return lagrangeNotAKnotSplineBasisDeriv1.getDegree();
  }

 protected:
  /// Unmodified basis
  LagrangeNotAKnotSplineBasisDeriv1<LT, IT> lagrangeNotAKnotSplineBasisDeriv1;
};

// default type-def (unsigned int for level and index)
typedef LagrangeNotAKnotSplineModifiedBasisDeriv1<unsigned int, unsigned int>
SLagrangeNotAKnotSplineModifiedBaseDeriv1;

}  // namespace base
}  // namespace sgpp

#endif /* LAGRANGE_NOTAKNOT_SPLINE_MODIFIED_BASE_DERIV1_HPP */
