...
#ifndef LAGRANGE_SPLINE_BASE_DERIV2_HPP
#define LAGRANGE_SPLINE_BASE_DERIV2_HPP
...
/**
 * Lagrange spline basis (2nd derivative).
 */
template <class LT, class IT>
class LagrangeSplineBasisDeriv2: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  LagrangeSplineBasisDeriv2() : degree(0) {
  }
   ...
   */
  explicit LagrangeSplineBasisDeriv2(size_t degree) : degree(degree) {
    if (degree < 1) {
      this->degree = 1;
    } else if (degree % 2 == 0) {
   ...
   * Destructor.
   */
  ~LagrangeSplineBasisDeriv2() override {
  }
...
typedef LagrangeSplineBasisDeriv2<unsigned int, unsigned int> SLagrangeSplineBaseDeriv2;

}  // namespace base
}  // namespace sgpp

#endif /* LAGRANGE_SPLINE_BASE_DERIV2_HPP */
