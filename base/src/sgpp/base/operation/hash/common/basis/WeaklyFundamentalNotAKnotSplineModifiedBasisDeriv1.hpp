...
#ifndef WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_MODIFIED_BASE_DERIV1_HPP
#define WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_MODIFIED_BASE_DERIV1_HPP
...
class WeaklyFundamentalNotAKnotSplineModifiedBasisDeriv1: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  WeaklyFundamentalNotAKnotSplineModifiedBasisDeriv1() :
    weaklyFundamentalNotAKnotSplineBasisDeriv1(WeaklyFundamentalNotAKnotSplineBasisDeriv1<LT, IT>()) {
  }
   ...
   */
  explicit WeaklyFundamentalNotAKnotSplineModifiedBasisDeriv1(size_t degree) :
    weaklyFundamentalNotAKnotSplineBasisDeriv1(WeaklyFundamentalNotAKnotSplineBasisDeriv1<LT, IT>(degree)) {
    if (getDegree() > 7) {
   ...
   * Destructor.
   */
  ~WeaklyFundamentalNotAKnotSplineModifiedBasisDeriv1() override {
  }
  ...
  inline double eval(LT l, IT i, double x) override {
    ...
    switch (getDegree()) {
      case 1:
        return weaklyFundamentalNotAKnotSplineBasisDeriv1.eval(l, i, x);
  ...
  inline size_t getDegree() const {
    return weaklyFundamentalNotAKnotSplineBasisDeriv1.getDegree();
  }

 protected:
  /// Unmodified basis
  WeaklyFundamentalNotAKnotSplineBasisDeriv1<LT, IT> weaklyFundamentalNotAKnotSplineBasisDeriv1;
};

// default type-def (unsigned int for level and index)
typedef WeaklyFundamentalNotAKnotSplineModifiedBasisDeriv1<unsigned int, unsigned int>
SWeaklyFundamentalNotAKnotSplineModifiedBaseDeriv1;

}  // namespace base
}  // namespace sgpp

#endif /* WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_MODIFIED_BASE_DERIV1_HPP */
