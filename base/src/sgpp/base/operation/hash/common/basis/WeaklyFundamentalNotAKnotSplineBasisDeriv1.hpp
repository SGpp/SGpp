...
#ifndef WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_BASE_DERIV1_HPP
#define WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_BASE_DERIV1_HPP
...
class WeaklyFundamentalNotAKnotSplineBasisDeriv1: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  WeaklyFundamentalNotAKnotSplineBasisDeriv1() :
   ...
   */
  explicit WeaklyFundamentalNotAKnotSplineBasisDeriv1(size_t degree) :
   ...
   * Destructor.
   */
  ~WeaklyFundamentalNotAKnotSplineBasisDeriv1() override {
  }
...
typedef WeaklyFundamentalNotAKnotSplineBasisDeriv1<unsigned int, unsigned int>
SWeaklyFundamentalNotAKnotSplineBaseDeriv1;

}  // namespace base
}  // namespace sgpp

#endif /* WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_BASE_DERIV1_HPP */
