...
#ifndef NOTAKNOT_BSPLINE_BASE_DERIV2_HPP
#define NOTAKNOT_BSPLINE_BASE_DERIV2_HPP
...
class NotAKnotBsplineBasisDeriv2: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  NotAKnotBsplineBasisDeriv2() : bsplineBasis(BsplineBasis<LT, IT>()) {
  }
   ...
   */
  explicit NotAKnotBsplineBasisDeriv2(size_t degree) :
   ...
   * Destructor.
   */
  ~NotAKnotBsplineBasisDeriv2() override {
  }
...
typedef NotAKnotBsplineBasisDeriv2<unsigned int, unsigned int> SNotAKnotBsplineBaseDeriv2;

}  // namespace base
}  // namespace sgpp

#endif /* NOTAKNOT_BSPLINE_BASE_DERIV2_HPP */
