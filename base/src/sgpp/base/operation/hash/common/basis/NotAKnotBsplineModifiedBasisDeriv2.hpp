...
#ifndef NOTAKNOT_BSPLINE_MODIFIED_BASE_DERIV2_HPP
#define NOTAKNOT_BSPLINE_MODIFIED_BASE_DERIV2_HPP
...
class NotAKnotBsplineModifiedBasisDeriv2: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  NotAKnotBsplineModifiedBasisDeriv2() :
   ...
   */
  explicit NotAKnotBsplineModifiedBasisDeriv2(size_t degree) :
   ...
   * Destructor.
   */
  ~NotAKnotBsplineModifiedBasisDeriv2() override {
  }
  ...
  inline size_t getDegree() const {
    return notAKnotBsplineBasisDeriv2.getDegree();
  }
...
typedef NotAKnotBsplineModifiedBasisDeriv2<unsigned int, unsigned int>
SNotAKnotBsplineModifiedBaseDeriv2;

}  // namespace base
}  // namespace sgpp

#endif /* NOTAKNOT_BSPLINE_MODIFIED_BASE_DERIV2_HPP */
