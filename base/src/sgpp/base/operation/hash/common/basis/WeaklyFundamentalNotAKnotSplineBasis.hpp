...
#ifndef WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_BASE_HPP
#define WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_BASE_HPP
...
class WeaklyFundamentalNotAKnotSplineBasis: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  WeaklyFundamentalNotAKnotSplineBasis() : weaklyFundamentalSplineBasis(WeaklyFundamentalSplineBasis<LT, IT>()) {
  }
   ...
   */
  explicit WeaklyFundamentalNotAKnotSplineBasis(size_t degree) :
   ...
   * Destructor.
   */
  ~WeaklyFundamentalNotAKnotSplineBasis() override {
  }
...
typedef WeaklyFundamentalNotAKnotSplineBasis<unsigned int, unsigned int> SWeaklyFundamentalNotAKnotSplineBase;

}  // namespace base
}  // namespace sgpp

#endif /* WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_BASE_HPP */
