...
#ifndef NOTAKNOT_BSPLINE_MODIFIED_BASE_DERIV1_HPP
#define NOTAKNOT_BSPLINE_MODIFIED_BASE_DERIV1_HPP
...
class NotAKnotBsplineModifiedBasisDeriv1: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  NotAKnotBsplineModifiedBasisDeriv1() :
   ...
   */
  explicit NotAKnotBsplineModifiedBasisDeriv1(size_t degree) :
   ...
   * Destructor.
   */
  ~NotAKnotBsplineModifiedBasisDeriv1() override {
  }
    ...
    switch (getDegree()) {
      case 1:
        if (l == 1) {
          ...
          // l >= 3, 1 < i < 2^l - 1
          return notAKnotBsplineBasisDeriv1.eval(l, i, x);
        } else {
          if (i > hInv / 2) {
            i = hInv - i;
            t *= -1.0;
  ...
  inline size_t getDegree() const {
    return notAKnotBsplineBasisDeriv1.getDegree();
  }
...
typedef NotAKnotBsplineModifiedBasisDeriv1<unsigned int, unsigned int>
SNotAKnotBsplineModifiedBaseDeriv1;

}  // namespace base
}  // namespace sgpp

#endif /* NOTAKNOT_BSPLINE_MODIFIED_BASE_DERIV1_HPP */
