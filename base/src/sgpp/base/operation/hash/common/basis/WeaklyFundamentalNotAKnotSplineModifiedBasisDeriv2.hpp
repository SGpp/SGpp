...
#ifndef WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_MODIFIED_BASE_DERIV2_HPP
#define WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_MODIFIED_BASE_DERIV2_HPP
...
class WeaklyFundamentalNotAKnotSplineModifiedBasisDeriv2: public Basis<LT, IT> {
 public:
  /**
   * Default constructor.
   */
  WeaklyFundamentalNotAKnotSplineModifiedBasisDeriv2() :
    weaklyFundamentalNotAKnotSplineBasisDeriv2(WeaklyFundamentalNotAKnotSplineBasisDeriv2<LT, IT>()) {
  }
   ...
   */
  explicit WeaklyFundamentalNotAKnotSplineModifiedBasisDeriv2(size_t degree) :
    weaklyFundamentalNotAKnotSplineBasisDeriv2(WeaklyFundamentalNotAKnotSplineBasisDeriv2<LT, IT>(degree)) {
    if (getDegree() > 7) {
   ...
   * Destructor.
   */
  ~WeaklyFundamentalNotAKnotSplineModifiedBasisDeriv2() override {
  }
  ...
  inline double eval(LT l, IT i, double x) override {
    ...
    switch (getDegree()) {
      case 1:
        return weaklyFundamentalNotAKnotSplineBasisDeriv2.eval(l, i, x);
  ...
  inline size_t getDegree() const {
    return weaklyFundamentalNotAKnotSplineBasisDeriv2.getDegree();
  }

 protected:
  /// Unmodified basis
  WeaklyFundamentalNotAKnotSplineBasisDeriv2<LT, IT> weaklyFundamentalNotAKnotSplineBasisDeriv2;
};

// default type-def (unsigned int for level and index)
typedef WeaklyFundamentalNotAKnotSplineModifiedBasisDeriv2<unsigned int, unsigned int>
SWeaklyFundamentalNotAKnotSplineModifiedBaseDeriv2;

}  // namespace base
}  // namespace sgpp

#endif /* WEAKLY_FUNDAMENTAL_NOTAKNOT_SPLINE_MODIFIED_BASE_DERIV2_HPP */
