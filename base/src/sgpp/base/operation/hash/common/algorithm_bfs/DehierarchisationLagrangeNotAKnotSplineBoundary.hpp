...
#ifndef DEHIERARCHISATIONLAGRANGENOTAKNOTSPLINEBOUNDARY_HPP
#define DEHIERARCHISATIONLAGRANGENOTAKNOTSPLINEBOUNDARY_HPP
...
/**
 * Functor for dehierarchization with Lagrange splines with not-a-knot boundary conditions via
 * BreadthFirstSearch.
 */
class DehierarchisationLagrangeNotAKnotSplineBoundary {
 protected:
  /// grid iterator
 ...
 public:
   ...
   * @param grid grid
   */
  explicit DehierarchisationLagrangeNotAKnotSplineBoundary(
      LagrangeNotAKnotSplineBoundaryGrid* grid);

  /**
   * Destructor.
   */
  virtual ~DehierarchisationLagrangeNotAKnotSplineBoundary();
...
#endif /* DEHIERARCHISATIONLAGRANGENOTAKNOTSPLINEBOUNDARY_HPP */
