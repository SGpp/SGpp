...
#ifndef HIERARCHISATIONMODNOTAKNOTBSPLINE_HPP
#define HIERARCHISATIONMODNOTAKNOTBSPLINE_HPP
 ...
 * BreadthFirstSearch.
 */
class HierarchisationModNotAKnotBspline {
 protected:
  /// grid iterator
 ...
 public:
   ...
   * @param grid grid
   */
  explicit HierarchisationModNotAKnotBspline(ModNotAKnotBsplineGrid* grid);

  /**
   * Destructor.
   */
  virtual ~HierarchisationModNotAKnotBspline();
...
#endif /* HIERARCHISATIONMODNOTAKNOTBSPLINE_HPP */
