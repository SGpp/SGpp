...
namespace sgpp {
namespace base {
DehierarchisationLagrangeSplineBoundary::DehierarchisationLagrangeSplineBoundary(
...
void DehierarchisationLagrangeSplineBoundary::operator()(
  ...
  SLagrangeSplineBase base(grid->getDegree());
