...
#ifndef DEHIERARCHISATIONLAGRANGESPLINEBOUNDARY_HPP
#define DEHIERARCHISATIONLAGRANGESPLINEBOUNDARY_HPP
...
/**
 * Functor for dehierarchization with Lagrange splines via
 * BreadthFirstSearch.
 */
class DehierarchisationLagrangeSplineBoundary {
 protected:
  /// grid iterator
 ...
 public:
   ...
   * @param grid grid
   */
  explicit DehierarchisationLagrangeSplineBoundary(LagrangeSplineBoundaryGrid* grid);

  /**
   * Destructor.
   */
  virtual ~DehierarchisationLagrangeSplineBoundary();
...
#endif /* DEHIERARCHISATIONLAGRANGESPLINEBOUNDARY_HPP */
