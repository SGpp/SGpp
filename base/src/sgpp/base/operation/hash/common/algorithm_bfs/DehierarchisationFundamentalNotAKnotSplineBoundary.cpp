...
namespace sgpp {
namespace base {
DehierarchisationFundamentalNotAKnotSplineBoundary::
DehierarchisationFundamentalNotAKnotSplineBoundary(
...
void DehierarchisationFundamentalNotAKnotSplineBoundary::operator()(
  ...
  SFundamentalNotAKnotSplineBase base(grid->getDegree());
