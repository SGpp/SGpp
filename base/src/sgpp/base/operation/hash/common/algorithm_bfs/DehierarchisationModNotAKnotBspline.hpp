...
#ifndef DEHIERARCHISATIONMODNOTAKNOTBSPLINEBOUNDARY_HPP
#define DEHIERARCHISATIONMODNOTAKNOTBSPLINEBOUNDARY_HPP
 ...
 * BreadthFirstSearch.
 */
class DehierarchisationModNotAKnotBspline {
 protected:
  /// grid iterator
 ...
 public:
   ...
   * @param grid grid
   */
  explicit DehierarchisationModNotAKnotBspline(ModNotAKnotBsplineGrid* grid);

  /**
   * Destructor.
   */
  virtual ~DehierarchisationModNotAKnotBspline();
...
#endif /* DEHIERARCHISATIONMODNOTAKNOTBSPLINEBOUNDARY_HPP */
