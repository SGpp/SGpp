...
#ifndef DEHIERARCHISATIONFUNDAMENTALNAKSPLINEBOUNDARY_HPP
#define DEHIERARCHISATIONFUNDAMENTALNAKSPLINEBOUNDARY_HPP
...
class DehierarchisationFundamentalNakSplineBoundary {
 ...
 public:
   ...
   * @param grid grid
   */
  explicit DehierarchisationFundamentalNakSplineBoundary(
    FundamentalNakSplineBoundaryGrid* grid);

  /**
   * Destructor.
   */
  virtual ~DehierarchisationFundamentalNakSplineBoundary();
...
#endif /* DEHIERARCHISATIONFUNDAMENTALNAKSPLINEBOUNDARY_HPP */
