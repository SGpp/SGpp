...
#ifndef HIERARCHISATIONNOTAKNOTBSPLINEBOUNDARY_HPP
#define HIERARCHISATIONNOTAKNOTBSPLINEBOUNDARY_HPP
 ...
 * BreadthFirstSearch.
 */
class HierarchisationNotAKnotBsplineBoundary {
 protected:
  /// grid iterator
 ...
 public:
   ...
   * @param grid grid
   */
  explicit HierarchisationNotAKnotBsplineBoundary(NotAKnotBsplineBoundaryGrid* grid);

  /**
   * Destructor.
   */
  virtual ~HierarchisationNotAKnotBsplineBoundary();
...
#endif /* HIERARCHISATIONNOTAKNOTBSPLINEBOUNDARY_HPP */
