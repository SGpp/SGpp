...
namespace sgpp {
namespace base {
DehierarchisationModNotAKnotBspline::DehierarchisationModNotAKnotBspline(
...
void DehierarchisationModNotAKnotBspline::operator()(
  ...
  SNotAKnotBsplineModifiedBase base(grid->getDegree());
