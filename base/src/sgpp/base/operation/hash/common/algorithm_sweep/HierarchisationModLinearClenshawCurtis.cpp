...
HierarchisationModLinearClenshawCurtis::HierarchisationModLinearClenshawCurtis(GridStorage& storage)
    : storage(storage), clenshawCurtisTable(ClenshawCurtisTable::getInstance()) {}

HierarchisationModLinearClenshawCurtis::~HierarchisationModLinearClenshawCurtis() {}

void HierarchisationModLinearClenshawCurtis::operator()(DataVector& source, DataVector& result,
...
void HierarchisationModLinearClenshawCurtis::rec(DataVector& source, DataVector& result,
                                                 grid_iterator& index, size_t dim,
                                                 DataVector& coeffs) {
