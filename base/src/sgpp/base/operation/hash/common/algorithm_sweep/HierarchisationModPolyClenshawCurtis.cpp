...
HierarchisationModPolyClenshawCurtis::HierarchisationModPolyClenshawCurtis(
...
void HierarchisationModPolyClenshawCurtis::operator()(DataVector& source, DataVector& result,
...
void HierarchisationModPolyClenshawCurtis::rec(DataVector& source, DataVector& result,
                                               grid_iterator& index, size_t dim,
                                               DataVector& coeffs) {
