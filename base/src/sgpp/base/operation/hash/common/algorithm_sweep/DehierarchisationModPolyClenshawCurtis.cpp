...
DehierarchisationModPolyClenshawCurtis::DehierarchisationModPolyClenshawCurtis(
    GridStorage& storage, SPolyModifiedClenshawCurtisBase* base)
    : storage(storage), base(base), clenshawCurtisTable(ClenshawCurtisTable::getInstance()) {}

DehierarchisationModPolyClenshawCurtis::~DehierarchisationModPolyClenshawCurtis() {}

void DehierarchisationModPolyClenshawCurtis::operator()(DataVector& source, DataVector& result,
...
void DehierarchisationModPolyClenshawCurtis::rec(DataVector& source, DataVector& result,
                                                 grid_iterator& index, size_t dim,
                                                 DataVector& coeffs) {
