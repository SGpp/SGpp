...
DehierarchisationPolyClenshawCurtis::DehierarchisationPolyClenshawCurtis(
    GridStorage& storage, SPolyClenshawCurtisBase* base)
    : storage(storage), base(base), clenshawCurtisTable(ClenshawCurtisTable::getInstance()) {}

DehierarchisationPolyClenshawCurtis::~DehierarchisationPolyClenshawCurtis() {}

void DehierarchisationPolyClenshawCurtis::operator()(DataVector& source, DataVector& result,
...
void DehierarchisationPolyClenshawCurtis::rec(DataVector& source, DataVector& result,
                                              grid_iterator& index, size_t dim,
                                              DataVector& coeffs) {
