...
HierarchisationPolyClenshawCurtisBoundary::HierarchisationPolyClenshawCurtisBoundary(
...
void HierarchisationPolyClenshawCurtisBoundary::operator()(DataVector& source, DataVector& result,
