...
void OperationMultipleEvalInterKinkLinear::mult(DataVector& alpha, DataVector& result) {
  /*
...
void OperationMultipleEvalInterKinkLinear::multTranspose(DataVector& source, DataVector& result) {
  result.setAll(0.0);
