...
#ifndef OPERATIONEVALGRADIENTWEAKLYFUNDAMENTALNOTAKNOTSPLINEBOUNDARY_HPP
#define OPERATIONEVALGRADIENTWEAKLYFUNDAMENTALNOTAKNOTSPLINEBOUNDARY_HPP
 ...
 */
class OperationEvalGradientWeaklyFundamentalNotAKnotSplineBoundaryNaive : public
 ...
 public:
   ...
   */
  OperationEvalGradientWeaklyFundamentalNotAKnotSplineBoundaryNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
    baseDeriv1(degree),
   ...
   * Destructor.
   */
  ~OperationEvalGradientWeaklyFundamentalNotAKnotSplineBoundaryNaive() override {
  }
...
#endif /* OPERATIONEVALGRADIENTWEAKLYFUNDAMENTALNOTAKNOTSPLINEBOUNDARY_HPP */
