...
double OperationEvalPartialDerivativeNakBsplineBoundaryNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeNakBsplineBoundaryNaive::evalPartialDerivative(
