...
double OperationNaiveEvalHessianBsplineBoundary::evalHessian(const DataVector& alpha,
...
void OperationNaiveEvalHessianBsplineBoundary::evalHessian(const DataMatrix& alpha,
                                                           const DataVector& point,
                                                           DataVector& value,
                                                           DataMatrix& gradient,
