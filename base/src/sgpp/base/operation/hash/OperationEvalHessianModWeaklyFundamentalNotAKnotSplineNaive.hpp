...
#ifndef OPERATIONEVALHESSIANMODWEAKLYFUNDAMENTALNOTAKNOTSPLINE_HPP
#define OPERATIONEVALHESSIANMODWEAKLYFUNDAMENTALNOTAKNOTSPLINE_HPP
 ...
 */
class OperationEvalHessianModWeaklyFundamentalNotAKnotSplineNaive : public
 ...
 public:
   ...
   */
  OperationEvalHessianModWeaklyFundamentalNotAKnotSplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
    baseDeriv1(degree),
    baseDeriv2(degree),
   ...
   * Destructor.
   */
  ~OperationEvalHessianModWeaklyFundamentalNotAKnotSplineNaive() override {
  }
 ...
 protected:
  ...
  SWeaklyFundamentalNotAKnotSplineModifiedBaseDeriv2 baseDeriv2;
...
#endif /* OPERATIONEVALHESSIANMODWEAKLYFUNDAMENTALNOTAKNOTSPLINE_HPP */
