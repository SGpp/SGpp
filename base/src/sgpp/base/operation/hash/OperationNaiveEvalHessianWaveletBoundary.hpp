 ...
 * and their Hessians.
 */
class OperationNaiveEvalHessianWaveletBoundary : public
 ...
 public:
   ...
   */
  explicit OperationNaiveEvalHessianWaveletBoundary(GridStorage* storage) : storage(
      storage) {
  }
   ...
   * Destructor.
   */
  ~OperationNaiveEvalHessianWaveletBoundary() override {
  }
