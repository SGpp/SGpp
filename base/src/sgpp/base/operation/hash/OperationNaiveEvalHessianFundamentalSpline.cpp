...
double OperationNaiveEvalHessianFundamentalSpline::evalHessian(const DataVector& alpha,
...
void OperationNaiveEvalHessianFundamentalSpline::evalHessian(const DataMatrix& alpha,
                                                             const DataVector& point,
                                                             DataVector& value,
                                                             DataMatrix& gradient,
