...
#ifndef OPERATIONEVALHESSIANWAVELETNAIVE_HPP
#define OPERATIONEVALHESSIANWAVELETNAIVE_HPP
 ...
 * and their Hessians.
 */
class OperationEvalHessianWaveletNaive : public OperationEvalHessian {
 public:
  /**
   * Constructor.
   *
   ...
   */
  explicit OperationEvalHessianWaveletNaive(GridStorage& storage) :
    storage(storage),
...
#endif /* OPERATIONEVALHESSIANWAVELETNAIVE_HPP */
