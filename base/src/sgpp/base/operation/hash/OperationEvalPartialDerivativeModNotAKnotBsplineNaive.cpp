...
double OperationEvalPartialDerivativeModNotAKnotBsplineNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeModNotAKnotBsplineNaive::evalPartialDerivative(
