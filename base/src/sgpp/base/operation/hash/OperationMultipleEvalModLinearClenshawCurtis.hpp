 ...
 */
class OperationMultipleEvalModLinearClenshawCurtis : public OperationMultipleEval {
 public:
  /**
   * Constructor
   *
   ...
   */
  OperationMultipleEvalModLinearClenshawCurtis(Grid& grid, DataMatrix& dataset)
      : OperationMultipleEval(grid, dataset), storage(grid.getStorage()) {}

  /**
   * Destructor
   */
  ~OperationMultipleEvalModLinearClenshawCurtis() override {}
