...
double OperationNaiveEvalGradientFundamentalSpline::evalGradient(const DataVector& alpha,
...
void OperationNaiveEvalGradientFundamentalSpline::evalGradient(const DataMatrix& alpha,
                                                               const DataVector& point,
                                                               DataVector& value,
                                                               DataMatrix& gradient) {
  const size_t n = storage.getSize();
