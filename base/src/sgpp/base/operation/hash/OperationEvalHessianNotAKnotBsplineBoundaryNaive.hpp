...
#ifndef OPERATIONEVALHESSIANNOTAKNOTSPLINEBOUNDARY_HPP
#define OPERATIONEVALHESSIANNOTAKNOTSPLINEBOUNDARY_HPP
...
/**
 * Operation for evaluating spline linear combinations on Boundary grids with not-a-knot
 * boundary conditions, their gradients and their Hessians.
 */
class OperationEvalHessianNotAKnotBsplineBoundaryNaive : public
 ...
 public:
   ...
   */
  OperationEvalHessianNotAKnotBsplineBoundaryNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
    baseDeriv1(degree),
    baseDeriv2(degree),
   ...
   * Destructor.
   */
  ~OperationEvalHessianNotAKnotBsplineBoundaryNaive() override {
  }
 ...
 protected:
  ...
  SNotAKnotBsplineBaseDeriv2 baseDeriv2;
...
#endif /* OPERATIONEVALHESSIANNOTAKNOTSPLINEBOUNDARY_HPP */
