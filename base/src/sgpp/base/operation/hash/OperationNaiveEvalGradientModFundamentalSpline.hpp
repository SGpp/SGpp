...
namespace SGPP {
  namespace base {
     ...
     * their gradients.
     */
    class OperationNaiveEvalGradientModFundamentalSpline : public OperationNaiveEvalGradient {
      public:
        /**
         * Constructor.
         *
         ...
         */
        OperationNaiveEvalGradientModFundamentalSpline(GridStorage* storage, size_t degree) :
         ...
         * Destructor.
         */
        virtual ~OperationNaiveEvalGradientModFundamentalSpline() override {
        }
