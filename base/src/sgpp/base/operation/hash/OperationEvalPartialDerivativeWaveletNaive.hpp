...
#ifndef OPERATIONEVALPARTIALDERIVATIVEWAVELETNAIVE_HPP
#define OPERATIONEVALPARTIALDERIVATIVEWAVELETNAIVE_HPP
...
class OperationEvalPartialDerivativeWaveletNaive :
 ...
 public:
   ...
   */
  explicit OperationEvalPartialDerivativeWaveletNaive(GridStorage& storage) :
    storage(storage),
...
#endif /* OPERATIONEVALPARTIALDERIVATIVEWAVELETNAIVE_HPP */
