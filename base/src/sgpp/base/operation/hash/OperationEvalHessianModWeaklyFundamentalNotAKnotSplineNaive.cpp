...
double OperationEvalHessianModWeaklyFundamentalNotAKnotSplineNaive::evalHessian(const DataVector& alpha,
...
void OperationEvalHessianModWeaklyFundamentalNotAKnotSplineNaive::evalHessian(const DataMatrix& alpha,
                                                             const DataVector& point,
                                                             DataVector& value,
                                                             DataMatrix& gradient,
