...
double OperationEvalHessianBsplineBoundaryNaive::evalHessian(const DataVector& alpha,
...
void OperationEvalHessianBsplineBoundaryNaive::evalHessian(const DataMatrix& alpha,
                                                           const DataVector& point,
                                                           DataVector& value,
                                                           DataMatrix& gradient,
