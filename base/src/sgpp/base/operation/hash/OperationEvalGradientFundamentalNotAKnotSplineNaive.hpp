...
#ifndef OPERATIONEVALGRADIENTFUNDAMENTALNOTAKNOTSPLINE_HPP
#define OPERATIONEVALGRADIENTFUNDAMENTALNOTAKNOTSPLINE_HPP
 ...
 * and their gradients.
 */
class OperationEvalGradientFundamentalNotAKnotSplineNaive : public
 ...
 public:
   ...
   */
  OperationEvalGradientFundamentalNotAKnotSplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalGradientFundamentalNotAKnotSplineNaive() override {
  }
...
#endif /* OPERATIONEVALGRADIENTFUNDAMENTALNOTAKNOTSPLINE_HPP */
