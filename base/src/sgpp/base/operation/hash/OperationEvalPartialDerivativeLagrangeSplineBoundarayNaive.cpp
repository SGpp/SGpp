...
double OperationEvalPartialDerivativeLagrangeSplineBoundaryNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeLagrangeSplineBoundaryNaive::evalPartialDerivative(
