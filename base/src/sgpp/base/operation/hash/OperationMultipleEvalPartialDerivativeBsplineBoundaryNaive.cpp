 ...
 *
 * OperationMultipleEvalPartialDerivativeBsplineBoundaryNaive.cpp
 *
 * Author: Paul Sarbu
 */
...
void OperationMultipleEvalPartialDerivativeBsplineBoundaryNaive::mult(DataVector& alpha,
                                                                      DataVector& result) {
...
void OperationMultipleEvalPartialDerivativeBsplineBoundaryNaive::multTranspose(DataVector& alpha,
                                                                               DataVector& result) {
  const size_t n = storage.getSize();
  const size_t d = storage.getDimension();
  const size_t m = dataset.getNrows();
...
double OperationMultipleEvalPartialDerivativeBsplineBoundaryNaive::getDuration() { return 0.0; }
