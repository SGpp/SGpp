...
double OperationNaiveEvalHessianModBspline::evalHessian(const DataVector& alpha,
...
void OperationNaiveEvalHessianModBspline::evalHessian(const DataMatrix& alpha,
                                                      const DataVector& point,
                                                      DataVector& value,
                                                      DataMatrix& gradient,
