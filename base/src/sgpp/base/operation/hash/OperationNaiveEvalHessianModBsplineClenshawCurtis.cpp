...
double OperationNaiveEvalHessianModBsplineClenshawCurtis::evalHessian(const DataVector& alpha,
...
void OperationNaiveEvalHessianModBsplineClenshawCurtis::evalHessian(
