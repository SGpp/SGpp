 ...
 */
class OperationMultipleEvalModPolyClenshawCurtis : public OperationMultipleEval {
 public:
  /**
   * Constructor
   *
   ...
   */
  OperationMultipleEvalModPolyClenshawCurtis(Grid& grid, size_t degree, DataMatrix& dataset)
      : OperationMultipleEval(grid, dataset), storage(grid.getStorage()), base(degree) {}

  /**
   * Destructor
   */
  ~OperationMultipleEvalModPolyClenshawCurtis() override {}
