...
class OperationNaiveEvalPartialDerivativeModBsplineClenshawCurtis :
 ...
 public:
   ...
   */
  OperationNaiveEvalPartialDerivativeModBsplineClenshawCurtis(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
   ...
   * Destructor.
   */
  ~OperationNaiveEvalPartialDerivativeModBsplineClenshawCurtis() override {
  }
