...
double OperationEvalPartialDerivativeLagrangeNotAKnotSplineBoundaryNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeLagrangeNotAKnotSplineBoundaryNaive::evalPartialDerivative(
