...
#ifndef OPERATIONEVALBSPLINEBOUNDARYNAIVE_HPP
#define OPERATIONEVALBSPLINEBOUNDARYNAIVE_HPP
 ...
 */
class OperationEvalBsplineBoundaryNaive : public OperationEval {
 public:
  /**
   * Constructor.
   *
   ...
   */
  OperationEvalBsplineBoundaryNaive(GridStorage& storage, size_t degree) :
   ...
   * Destructor.
   */
  ~OperationEvalBsplineBoundaryNaive() override {
  }
...
#endif /* OPERATIONEVALBSPLINEBOUNDARYNAIVE_HPP */
