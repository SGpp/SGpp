...
double OperationEvalHessianBsplineClenshawCurtisNaive::evalHessian(const DataVector& alpha,
...
void OperationEvalHessianBsplineClenshawCurtisNaive::evalHessian(const DataMatrix& alpha,
                                                                 const DataVector& point,
                                                                 DataVector& value,
                                                                 DataMatrix& gradient,
