 ...
 */
class OperationEvalGradientBsplineNaive : public OperationEvalGradient {
 public:
  /**
   * Constructor.
   *
   ...
   */
  OperationEvalGradientBsplineNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
   ...
   * Destructor.
   */
  ~OperationEvalGradientBsplineNaive() override {
  }
