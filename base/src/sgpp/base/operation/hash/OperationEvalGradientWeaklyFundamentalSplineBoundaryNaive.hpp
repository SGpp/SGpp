...
#ifndef OPERATIONEVALGRADIENTWEAKLYFUNDAMENTALSPLINEBOUNDARY_HPP
#define OPERATIONEVALGRADIENTWEAKLYFUNDAMENTALSPLINEBOUNDARY_HPP
 ...
 * and their gradients.
 */
class OperationEvalGradientWeaklyFundamentalSplineBoundaryNaive : public
 ...
 public:
   ...
   */
  OperationEvalGradientWeaklyFundamentalSplineBoundaryNaive(GridStorage& storage, size_t degree) :
    storage(storage),
    base(degree),
    baseDeriv1(degree),
   ...
   * Destructor.
   */
  ~OperationEvalGradientWeaklyFundamentalSplineBoundaryNaive() override {
  }
...
#endif /* OPERATIONEVALGRADIENTWEAKLYFUNDAMENTALSPLINEBOUNDARY_HPP */
