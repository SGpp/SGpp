...
double OperationEvalPartialDerivativeFundamentalSplineNaive::evalPartialDerivative(
...
void OperationEvalPartialDerivativeFundamentalSplineNaive::evalPartialDerivative(
