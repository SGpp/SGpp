...
#ifndef OPERATIONEVALBSPLINENAIVE_HPP
#define OPERATIONEVALBSPLINENAIVE_HPP
 ...
 */
class OperationEvalBsplineNaive : public OperationEval {
 public:
  /**
   * Constructor.
   *
   ...
   */
  OperationEvalBsplineNaive(GridStorage& storage, size_t degree) :
   ...
   * Destructor.
   */
  ~OperationEvalBsplineNaive() override {
  }
...
#endif /* OPERATIONEVALBSPLINENAIVE_HPP */
