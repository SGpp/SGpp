...
class GridPrinterForStretching: public GridPrinter {
 public:
   ...
   */
  explicit GridPrinterForStretching(Grid& SparseGrid);
   ...
   */
  void printGrid(DataVector& alpha, std::string tFilename,
                 size_t PointsPerDimension) override;
   ...
   */
  void printGridDomain(DataVector& alpha, std::string tFilename,
   ...
   * @param PointsPerDimension specifies how many functions evaluations in every dimension should be calculated
   */
  void printGridDomainStretching(DataVector& alpha, std::string tFilename,
                                 Stretching& GridArea,
   ...
   */
  void printSparseGrid(DataVector& alpha, std::string tFilename,
                       bool bSurplus) override;
   ...
   * @param bSurplus specifies whether the surplus (true) or the node basis value (false) is written
   */
  void printSparseGridExpTransform(DataVector& alpha,
