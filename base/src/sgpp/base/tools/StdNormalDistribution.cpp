...
double StdNormalDistribution::getDensity(const double x) {
  ...
  const double secondTerm = -( (x - mean) * (x - mean) /
                                (2.0 * stddev * stddev) );
...
double StdNormalDistribution::getDensity(const double x, const double mu,
    const double sigma) {
...
double StdNormalDistribution::getNormedDensity(const double x,
