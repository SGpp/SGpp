...
//#define BOOST_TEST_MODULE DataVector
//#define BOOST_TEST_MODULE SGppBaseModule
...
struct Fixture {
	...
	int nrows, ncols, N;SGPP::float_t **l_rand;SGPP::float_t *l_rand_total;
	DataVector d_rand;SGPP::float_t min, max, sum;
};
