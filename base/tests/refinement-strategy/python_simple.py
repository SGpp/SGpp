...
print "dimensionality:         %d" % (HashGridStorage.dim())
...
for i in xrange(HashGridStorage.size()):
    ...
    print ('dim = 1; level = ' + str(HashGridStorage.get(i).getLevel(1)) + '; index = ' + str(HashGridStorage.get(i).getIndex(1)))
    print ('dim = 2; level = ' + str(HashGridStorage.get(i).getLevel(0)) + '; index = ' + str(HashGridStorage.get(i).getIndex(0)) + ';\n' )
