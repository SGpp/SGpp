...
BOOST_AUTO_TEST_CASE(testFreeRefine2d) {
  ...
  DataMatrix gridPoints(27, 2);
  gridPoints.set(0, 0, 0.625);
  gridPoints.set(0, 1, 0.75);
  gridPoints.set(1, 0, 0.6875);
  gridPoints.set(1, 1, 0.5);
  gridPoints.set(2, 0, 0.5625);
  gridPoints.set(2, 1, 0.5);
  gridPoints.set(3, 0, 0.75);
  gridPoints.set(3, 1, 0.125);
  gridPoints.set(4, 0, 0.875);
  gridPoints.set(4, 1, 0.25);
  gridPoints.set(5, 0, 0.5);
  gridPoints.set(5, 1, 0.5);
  gridPoints.set(6, 0, 0.5);
  gridPoints.set(6, 1, 0.125);
  gridPoints.set(7, 0, 0.25);
  gridPoints.set(7, 1, 0.5);
  gridPoints.set(8, 0, 0.5);
  gridPoints.set(8, 1, 0.75);
  gridPoints.set(9, 0, 0.5);
  gridPoints.set(9, 1, 0.25);
  gridPoints.set(10, 0, 0.5);
  gridPoints.set(10, 1, 0.875);
  gridPoints.set(11, 0, 0.75);
  gridPoints.set(11, 1, 0.5);
  gridPoints.set(12, 0, 0.5);
  gridPoints.set(12, 1, 0.375);
  gridPoints.set(13, 0, 0.25);
  gridPoints.set(13, 1, 0.25);
  gridPoints.set(14, 0, 0.5);
  gridPoints.set(14, 1, 0.625);
  gridPoints.set(15, 0, 0.25);
  gridPoints.set(15, 1, 0.75);
  gridPoints.set(16, 0, 0.75);
  gridPoints.set(16, 1, 0.25);
  gridPoints.set(17, 0, 0.25);
  gridPoints.set(17, 1, 0.375);
  gridPoints.set(18, 0, 0.75);
  gridPoints.set(18, 1, 0.75);
  gridPoints.set(19, 0, 0.125);
  gridPoints.set(19, 1, 0.5);
  gridPoints.set(20, 0, 0.5);
  gridPoints.set(20, 1, 0.3125);
  gridPoints.set(21, 0, 0.375);
  gridPoints.set(21, 1, 0.5);
  gridPoints.set(22, 0, 0.625);
  gridPoints.set(22, 1, 0.5);
  gridPoints.set(23, 0, 0.875);
  gridPoints.set(23, 1, 0.5);
  gridPoints.set(24, 0, 0.75);
  gridPoints.set(24, 1, 0.375);
  gridPoints.set(25, 0, 0.5);
  gridPoints.set(25, 1, 0.4375);
  gridPoints.set(26, 0, 0.625);
  gridPoints.set(26, 1, 0.25);
