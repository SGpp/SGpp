...
% newobject sgpp::base::Grid::createLinearClenshawCurtisBoundaryGrid(size_t dim,
...
% newobject sgpp::base::Grid::createPolyClenshawCurtisBoundaryGrid(size_t dim, size_t degree,
                                                                   size_t boundaryLevel);
...
% newobject sgpp::base::Grid::createWeaklyFundamentalSplineBoundaryGrid(size_t dim,
                                                                        size_t boundaryLevel);
% newobject sgpp::base::Grid::createWeaklyFundamentalNakSplineBoundaryGrid(size_t dim,
                                                                           size_t boundaryLevel);
% newobject sgpp::base::Grid::createModWeaklyFundamentalNakSplineGrid(size_t dim);
% newobject sgpp::base::Grid::createFundamentalSplineBoundaryGrid(size_t dim, size_t degree,
                                                                  size_t boundaryLevel);
% newobject sgpp::base::Grid::createFundamentalNakSplineBoundaryGrid(size_t dim, size_t degree,
                                                                     size_t boundaryLevel);
...
% extend sgpp::base::Grid{sgpp::base::Grid * createMemento(){return $self;
}
...
% extend sgpp::base::Grid {
  size_t getDegree() { return $self->getBasis().getDegree(); };
};
