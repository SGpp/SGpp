...
int main() {
       ...
       */
      std::string filename = "../../datasets/house_numbers/SVHN_32x32.train.arff";
      // load training samples
      std::cout << "# loading file: " << filename << std::endl;
      sgpp::datadriven::Dataset trainDataset = sgpp::datadriven::ARFFTools::readARFF(filename);

      filename = "../../datasets/house_numbers/SVHN_32x32.test.arff";
      // load test samples
      std::cout << "# loading file: " << filename << std::endl;
      ...
      */
      ...
      //std::string matrixfile = "32x32_NN_Inter_lvl3_Chol.out";
