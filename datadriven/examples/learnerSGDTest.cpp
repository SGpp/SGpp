...
int main(int argc, char** argv) {
  ...
  gridConfig.level_ = 3; //ripley - fixed grid: l=4
  ...
  adaptConfig.numRefinements_ = 7; //banana 20 | ripley 7
  adaptConfig.noPoints_ = 5; //banana 5 | ripley 5
  adaptConfig.threshold_ = 0.0;

  // specify additional parameters
  //size_t maxRuns = 1;
  double lambda = 0.005; //1e-4 //banana 0.001 | ripley 0.005
  double gamma = 0.01; // banana 0.05 | ripley 0.005
