...
int main(int argc, char* argv[]) {
  ...
  description.add_options()
      ...
      ("help", "display help")(
          ...
          "lambda", boost::program_options::value<SGPP::float_t>(&lambda),
      ...
      ("solverRefine.eps", boost::program_options::value<SGPP::float_t>(
                               &SLESolverConfigRefine.eps_),
       "error for early aborting training (set to 0 to disable)")(
          ...
          boost::program_options::value<SGPP::float_t>(
      ...
      ("solverFinal.eps",
       boost::program_options::value<SGPP::float_t>(&SLESolverConfigFinal.eps_),
       "error for early aborting training (set to 0 to disable)")(
          "solverFinal.maxIterations",
          boost::program_options::value<size_t>(
              &SLESolverConfigFinal.maxIterations_),
          "maximum number of iterations before the training is stopped")(
          "solverFinal.threshold", boost::program_options::value<SGPP::float_t>(
                                       &SLESolverConfigRefine.threshold_),
          "early abort solver if this residual threshold is reached")(
          "solverFinal.type",
          boost::program_options::value<SGPP::solver::SLESolverType>(
