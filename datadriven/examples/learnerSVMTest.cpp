...
int main() {
  ...
  for (size_t numSets = 0; numSets < totalSets; numSets++) {
    ...
    for (size_t numFolds = 0; numFolds < totalFolds; numFolds++) {
      ...
      //  +std::to_string(numSets+1)+"_"+std::to_string(numFolds+1)+".arff";
      //std::string filename = "/media/sf_Downloads/MA/DR10/5_fold/fixed_train_seed42/50k/DR10_train_"
      //  +std::to_string(numSets+1)+"_"+std::to_string(numFolds+1)+".arff";
      ...
      //  +std::to_string(numSets+1)+"_"+std::to_string(numFolds+1)+".arff";
      //filename = "/media/sf_Downloads/MA/DR10/5_fold/fixed_train_seed42/50k/DR10_val_"
      //  +std::to_string(numSets+1)+"_"+std::to_string(numFolds+1)+".arff";
      ...
      // combined-measure refinement (cm), impurity-based refinement
      std::string refType;
