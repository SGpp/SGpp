...
int main() {
  ...
  for (size_t level = 1; level < 5; level++) {
    ...
    auto regularResponseSurf =
        std::make_shared<sgpp::datadriven::SparseGridResponseSurfaceNakBspline>(objectiveFunc,
                                                                                gridType, degree);
    ...
    sgpp::datadriven::ASMatrixBsplineAnalytic ASM_Bspline(objectiveFunc, gridType, degree);
    ...
    auto responseSurf_regularBspline =
        std::make_shared<sgpp::datadriven::ASResponseSurfaceNakBspline>(W1_adaptiveBspline,
                                                                        gridType, degree);
    ...
    sgpp::datadriven::ASMatrixGradientMC ASM_GradientMCFD(objectiveFunc);
    ...
    auto responseSurf_gradientMCFD =
        std::make_shared<sgpp::datadriven::ASResponseSurfaceNakBspline>(W1_gradientMCFD, gridType,
                                                                        degree);
    ...
    //    sgpp::datadriven::ASMatrixGradientMC ASM_GradientMC(objectiveFunc);
    ...
    //        std::make_shared<sgpp::datadriven::ASResponseSurfaceNakBspline>(W1_gradientMC,
    //        gridType,
    //                                                                          degree);
