...
# Contains class test_CheckpointController::TestCheckpointController with unittests for @link python.pysgpp.extensions.datadriven.controller.CheckpointController.CheckpointController CheckpointController @endlink

##
# Class with unittests for @link python.pysgpp.extensions.datadriven.controller.CheckpointController.CheckpointController CheckpointController @endlink
#
# @ingroup tests
#
# @test Unittests for @link python.pysgpp.extensions.datadriven.controller.CheckpointController.CheckpointController CheckpointController @endlink
class TestCheckpointController(unittest.TestCase):

    ##
    # Tests the function @link python.pysgpp.extensions.datadriven.controller.CheckpointController.CheckpointController.saveGrid() CheckpointController.saveGrid() @endlink
    ...
    ##
    # Tests the function @link python.pysgpp.extensions.datadriven.controller.CheckpointController.CheckpointController.loadGrid() CheckpointController.loadGrid() @endlink
    ...
    ##
    # Tests the function @link python.pysgpp.extensions.datadriven.controller.CheckpointController.CheckpointController.saveLearnedKnowledge() CheckpointController.saveLearnedKnowledge() @endlink
    ...
    ##
    # Tests the function @link python.pysgpp.extensions.datadriven.controller.CheckpointController.CheckpointController.loadLearnedKnowledge() CheckpointController.loadLearnedKnowledge() @endlink
    ...
    ##
    # Tests the functions @link python.pysgpp.extensions.datadriven.controller.CheckpointController.CheckpointController.saveAll() CheckpointController.saveAll() @endlink
    # @link python.pysgpp.extensions.datadriven.controller.CheckpointController.CheckpointController.loadAll() CheckpointController.loadAll() @endlink
