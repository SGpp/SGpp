...
# Contains class test_DataContainer::TestDataContainer with unittests for @link python.pysgpp_datadriven.data.DataContainer.DataContainer DataContainer @endlink

##
# Class with unittests for @link python.pysgpp_datadriven.data.DataContainer.DataContainer DataContainer @endlink
#
# @ingroup tests
#
# @test Unittests for @link python.pysgpp_datadriven.data.DataContainer.DataContainer DataContainer @endlink
class TestDataContainer(unittest.TestCase):
    ...
    ##
    # Tests the function @link python.pysgpp_datadriven.data.DataContainer.DataContainer.next() DataContainer.next() @endlink
    def testNext(self):
        c = 0
    ...
    ##
    # Tests the function @link python.pysgpp_datadriven.data.DataContainer.DataContainer.getTrainDataset() DataContainer.getTrainDataset() @endlink
    ...
    ##
    # Tests the function @link python.pysgpp_datadriven.data.DataContainer.DataContainer.getTestDataset() DataContainer.getTestDataset() @endlink
...
#        self.fail("Not implemented")
    ...
    ##
    # Tests the function @link python.pysgpp_datadriven.data.DataContainer.DataContainer.combine() DataContainer.combine() @endlink
    ...
    ##
    # Tests the function @link python.pysgpp_datadriven.data.DataContainer.DataContainer.createNullVector() DataContainer.createNullVector() @endlink
