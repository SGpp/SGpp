...
# Contains class test_Classifier::TestClassifier with unittests for @link python.pysgpp.extensions.datadriven.learner.Classifier.Classifier Classifier @endlink

##
# Class with unittests for @link python.pysgpp.extensions.datadriven.learner.Classifier.Classifier Classifier @endlink
#
# @ingroup tests
#
# @test Unittests for @link python.pysgpp.extensions.datadriven.learner.Classifier.Classifier Classifier @endlink
...
#     ##
#     # Tests the function @link python.pysgpp.extensions.datadriven.learner.Learner.Learner.learnDataWithTest() Classifier.learnDataWithTest() @endlink
...
#             self.assertAlmostEqual(alpha[i], correct[i], 3)
    ...
    ##
    # Tests the function @link python.pysgpp.extensions.datadriven.learner.Learner.Learner.applyData() Classifier.applyData() @endlink
    ...
    ##
    # Tests the function @link python.pysgpp.extensions.datadriven.learner.Learner.Learner.learnData() Classifier.learnData() @endlink
    ...
    ##
    # Tests the function @link python.pysgpp.extensions.datadriven.learner.Learner.Learner.learnDataWithFolding() Classifier.learnDataWithFolding() @endlink
