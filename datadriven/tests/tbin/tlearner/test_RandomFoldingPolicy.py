...
# Contains class test_RandomFoldingPolicy::TestRandomFoldingPolicy with unittests for @link datadriven.learner.folding.RandomFoldingPolicy.RandomFoldingPolicy RandomFoldingPolicy @endlink

##
# Class with unittests for @link datadriven.learner.folding.RandomFoldingPolicy.RandomFoldingPolicy RandomFoldingPolicy @endlink
#
# @ingroup tests
#
# @test Unittests for @link datadriven.learner.folding.RandomFoldingPolicy.RandomFoldingPolicy RandomFoldingPolicy @endlink
class TestRandomFoldingPolicy(unittest.TestCase):
    ...
    ##
    # Tests the function @link datadriven.learner.folding.FoldingPolicy.FoldingPolicy.next() RandomFoldingPolicy.next() @endlink    
    def testNext(self):
