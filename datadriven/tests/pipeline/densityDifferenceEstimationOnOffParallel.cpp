...
double testDistributionDDE_OnOffParallel(std::string testCSV, std::string config) {
  // Train model
...
BOOST_AUTO_TEST_SUITE(testDensityDifferenceEstimationOnOffParallel)
...
BOOST_AUTO_TEST_CASE(Test_2D_B2_64_B2_2) {
  ...
  double mse = testDistributionDDE_OnOffParallel(
