...
BOOST_AUTO_TEST_SUITE(GridPointBasedCoarseningFunctor)

    BOOST_AUTO_TEST_CASE(testCoarsen2class) {
        ...
        alphas2.set(49, -0.05);
        // serialized
        // build and src add header files
        // wiki new parameters
        size_t dim = 2;
        size_t level = 3;
        ...
        sgpp::datadriven::GridPointBasedCoarseningFunctor gpbc(grids, alphas, 4, 0.1, 0);
