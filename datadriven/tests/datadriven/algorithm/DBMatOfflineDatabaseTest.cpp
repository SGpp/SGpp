...
using sgpp::datadriven::GeometryConfiguration;
...
BOOST_AUTO_TEST_CASE(TestPutgMatrix) {
  ...
  DensityEstimationConfiguration densityEstimationConfig;
  GeometryConfiguration geometryConfig;
  initializeStandardConfiguration(gridConfig, geometryConfig, adaptivityConfig, regularizationConfig,
  ...
  BOOST_CHECK(database.hasDataMatrix(gridConfig, geometryConfig, adaptivityConfig, regularizationConfig,
                                     densityEstimationConfig));
  removeDatabase(filepath);
}
...
BOOST_AUTO_TEST_CASE(TestOverwriteMatrix) {
  ...
  pathFromDatabase = database.getDataMatrix(gridConfig, geometryConfig, adaptivityConfig, regularizationConfig,
                                            densityEstimationConfig);
...
BOOST_AUTO_TEST_CASE(TestBaseMatrix) {
  ...
  database.putDataMatrix(baseGridConfig1, geometryConfig, adaptivityConfig, regularizationConfig,
  ...
  database.putDataMatrix(baseGridConfig2, geometryConfig, adaptivityConfig, regularizationConfig,
  ...
  BOOST_CHECK(database.hasBaseDataMatrix(testGridConfig1, geometryConfig, adaptivityConfig, regularizationConfig,
                                         densityEstimationConfig));

  sgpp::base::GeneralGridConfiguration obtainedBaseGridConfig;

  std::string obtainedPath =
      database.getBaseDataMatrix(testGridConfig1, geometryConfig, adaptivityConfig, regularizationConfig,
  ...
  BOOST_CHECK(database.hasBaseDataMatrix(testGridConfig2, geometryConfig, adaptivityConfig, regularizationConfig,
                                         densityEstimationConfig));

  obtainedPath = database.getBaseDataMatrix(testGridConfig2, geometryConfig, adaptivityConfig, regularizationConfig,
                                            densityEstimationConfig, obtainedBaseGridConfig);
  ...
  BOOST_CHECK(database.hasBaseDataMatrix(testGridConfig3, geometryConfig, adaptivityConfig, regularizationConfig,
                                         densityEstimationConfig));

  obtainedPath = database.getBaseDataMatrix(testGridConfig3, geometryConfig, adaptivityConfig, regularizationConfig,
                                            densityEstimationConfig, obtainedBaseGridConfig);
