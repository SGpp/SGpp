...
BOOST_AUTO_TEST_CASE(testHatRegular1D_one) {
  ...
  std::string referenceMatrixFileName(
      ...
      "BT_phi_li_ausgeklappt_dim_1_nopsgrid_7_float.dat.gz");
...
BOOST_AUTO_TEST_CASE(testHatRegular1D_two) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_ausgeklappt_dim_1_nopsgrid_31_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegulardD_one) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_ausgeklappt_dim_3_nopsgrid_31_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegulardD_two) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_ausgeklappt_dim_3_nopsgrid_111_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegular1D_two) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_dim_1_nopsgrid_31_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegulardD_one) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_dim_3_nopsgrid_31_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegulardD_two) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_dim_3_nopsgrid_111_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegular1D_one) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_l0_rand_dim_1_nopsgrid_17_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegular1D_two) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_l0_rand_dim_1_nopsgrid_33_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegulardD_one) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_l0_rand_dim_3_nopsgrid_123_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegulardD_two) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_l0_rand_dim_3_nopsgrid_297_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegular1D_one) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_trapezrand_dim_1_nopsgrid_17_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegular1D_two) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_trapezrand_dim_1_nopsgrid_33_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegulardD_one) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_trapezrand_dim_3_nopsgrid_81_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
...
BOOST_AUTO_TEST_CASE(testHatRegulardD_two) {
  ...
  std::string referenceMatrixFileName(
      "datadriven/datasets/BT_BBT/"
      "BT_phi_li_hut_trapezrand_dim_3_nopsgrid_225_float.dat.gz");
  std::string content = uncompressFile(fileName);
  sgpp::datadriven::ARFFTools arffTools;
  sgpp::datadriven::Dataset dataset =
      arffTools.readARFFFromString(content, false);
