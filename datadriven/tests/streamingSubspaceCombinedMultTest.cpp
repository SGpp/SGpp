...
BOOST_AUTO_TEST_SUITE(TestStreamingSubspaceCombinedMult)

BOOST_AUTO_TEST_CASE(Simple) {
  std::vector<std::tuple<std::string, double> > fileNamesError = {
      std::tuple<std::string, double>("datadriven/tests/data/friedman_4d.arff.gz", 1E-24),
      std::tuple<std::string, double>("datadriven/tests/data/friedman_10d.arff.gz", 1E-21)};
