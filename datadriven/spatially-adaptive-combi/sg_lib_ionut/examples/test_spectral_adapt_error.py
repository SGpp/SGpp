...
from sg_op.adaptivity.spectral_error import *
...
if __name__ == '__main__':
	...
	Adaptivity_obj 			= SpectralError(dim, tol, init_multiindex, max_level)
	...
	Adaptivity_obj.init_adaption(init_delta, init_coeff)
	...
	while not Adaptivity_obj.stop_adaption:
		...
		Adaptivity_obj.do_one_adaption_step_postproc(curr_delta, curr_coeffs)
