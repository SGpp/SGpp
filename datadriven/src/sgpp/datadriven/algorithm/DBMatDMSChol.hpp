...
public:
	 ...
	 * @param do_cv indicating if updates are used for cross valdiation (using special structure of update vectors to save runtime)
	 */
	void choleskyUpdate(sgpp::base::DataMatrix& DecompMatrix, sgpp::base::DataVector* update, bool do_cv = false);
	 ...
	 * @param do_cv indicating if updates are used for cross valdiation (using special structure of update vectors to save runtime)
	 */
	void choleskyDowndate(sgpp::base::DataMatrix& DecompMatrix, sgpp::base::DataVector* downdate, bool do_cv = false);
};
