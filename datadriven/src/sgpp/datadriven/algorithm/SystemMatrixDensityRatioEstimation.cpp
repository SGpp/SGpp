...
SystemMatrixDensityRatioEstimation::SystemMatrixDensityRatioEstimation(base::Grid& grid,
  ...
  this->B_p.reset(
      op_factory::createOperationMultipleEval(grid, this->datasetP_,
                                              this->implementationConfiguration));
  this->B_q.reset(
      op_factory::createOperationMultipleEval(grid, this->datasetQ_,
                                              this->implementationConfiguration));
...
void SystemMatrixDensityRatioEstimation::generateb(base::DataVector& b) {
  base::DataVector y(this->instancesP);
  y.setAll(this->instancesQ);
...
void SystemMatrixDensityRatioEstimation::setImplementation(
  ...
  this->B_p.reset(
      op_factory::createOperationMultipleEval(this->grid, this->datasetP_,
                                              this->implementationConfiguration));
  this->B_q.reset(
      op_factory::createOperationMultipleEval(this->grid, this->datasetQ_,
                                              this->implementationConfiguration));
}
