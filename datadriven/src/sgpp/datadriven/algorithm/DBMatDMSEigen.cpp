...
void DBMatDMSEigen::solve(sgpp::base::DataMatrix& eigenVectors,
	...
	gsl_matrix_view q = gsl_matrix_view_array(eigenVectors.getPointer(), n, n); //Create a matrix view for the eigenvectors
	gsl_vector_view b = gsl_vector_view_array(rhs.getPointer(), n); //Create a vector view for the right hand side
	gsl_vector_view e = gsl_vector_view_array(eigenValues.getPointer(), n); //Create a vector view for the eigenvalues
