...
/**
 * Class that implements the virtual class OperationMatrix for the application of derivative
 * estimation for the Systemmatrix by using a density function
 */
class DensityDerivativeSystemMatrix : public base::OperationMatrix {
 private:
 ...
 public:
   ...
   * @param derivDim direction along which to compute the derivative
   */
  DensityDerivativeSystemMatrix(base::Grid& grid, base::DataMatrix& trainData,
                                base::OperationMatrix* C, double lambda, size_t derivDim);

  /**
   * Generates the left hand side of the density derivative estimation equation
   *
  ...
  /**
   * Generates the right hand side of the density derivative estimation equation
   *
  ...
  /**
   * Computes the unweighted right hand side of the density derivative estimation equation
   *
   * @param b reference to the vector which will contain the result of the matrix vector
   * multiplication on the rhs
   */
   ...
   * Std-Destructor
   */
  virtual ~DensityDerivativeSystemMatrix();
};
