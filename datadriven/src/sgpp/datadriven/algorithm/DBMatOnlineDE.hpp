...
class DBMatOnlineDE: public DBMatOnline {
 ...
 public:
   ...
   */
  virtual void computeDensityFunction(sgpp::base::DataMatrix& m, bool save_b = false,
   ...
   */
  virtual void setCrossValidationParameters(int lambda_step, double lambda_start,
