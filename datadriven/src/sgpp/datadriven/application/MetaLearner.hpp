...
class MetaLearner {
 private:
  ...
  void optimizeLambdaLog_(SGPP::base::DataMatrix& dataset,
                          SGPP::base::DataVector& datasetValues, size_t kFold,
 ...
 public:
  ...
  void learnString(SGPP::datadriven::OperationMultipleEvalConfiguration&
                   operationConfiguration, std::string& content,
                   float_t lambda, bool isRegression = true);

  void learnReference(std::string& fileName, float_t lambda,
  ...
  float_t optimizeLambdaLog(SGPP::base::DataMatrix& dataset,
                            SGPP::base::DataVector& values, size_t kFold,
                            size_t maxLevel);

  void optimizeLambdaLog(SGPP::base::DataMatrix& dataset,
                         SGPP::base::DataVector& values, size_t kFold,
