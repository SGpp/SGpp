...
namespace sgpp {
    namespace datadriven {
        ...
        protected:
            ...
            unsigned long
            handleDataAndZeroBasedRefinement(bool preCompute, MultiGridRefinementFunctor *func, unsigned long idx,
                                             base::Grid &grid,
                                             base::GridGenerator &gridGen) const;

            unsigned long
            handleSurplusBasedRefinement(DBMatOnlineDE *densEst, Grid &grid, base::GridGenerator &gridGen) const;
        ...
        public:
            ...
            /**
                ...
                */
            void updateClassVariablesAfterRefinement(unsigned long classIndex, RefinementResult *refinementResult,
...
/**
    ...
    */
            ...
            void doRefinementForClass(const std::string &refType, RefinementResult *refinementResult,
                                      const ClassDensityConntainer &onlineObjects, bool preCompute,
                                      MultiGridRefinementFunctor *refinementFunctor, unsigned long classIndex);
        };
