...
namespace SGPP {
  namespace datadriven {
    ...
    void Friedman1Generator::createData(size_t offset, size_t size, base::DataMatrix& trData, base::DataVector& classes) {
      trData.resize(size);
      classes.resize(size);
    ...
    void Friedman2Generator::createData(size_t offset, size_t size, base::DataMatrix& trData, base::DataVector& classes) {
      trData.resize(size);
      classes.resize(size);
      srand((unsigned int)(offset));
    ...
    void Friedman3Generator::createData(size_t offset, size_t size, base::DataMatrix& trData, base::DataVector& classes) {
      trData.resize(size);
      classes.resize(size);
      srand((unsigned int)(offset));
