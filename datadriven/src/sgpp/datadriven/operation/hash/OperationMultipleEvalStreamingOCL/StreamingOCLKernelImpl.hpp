  ...
  namespace datadriven {
    ...
    class StreamingOCLKernelImpl {
      private:
        ...
        StreamingOCLKernelSourceBuilder<real_type> kernelSourceBuilder;
      ...
      public:
        ...
        StreamingOCLKernelImpl(size_t dims, base::OCLManager& manager, base::ConfigurationParameters parameters) :
