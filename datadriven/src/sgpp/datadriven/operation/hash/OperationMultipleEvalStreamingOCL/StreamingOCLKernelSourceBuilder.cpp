...
StreamingOCLKernelSourceBuilder::StreamingOCLKernelSourceBuilder(
...
void StreamingOCLKernelSourceBuilder::writeSource(std::string fileName,
    std::string source) {
...
std::string StreamingOCLKernelSourceBuilder::getData(std::string dim,
...
std::string StreamingOCLKernelSourceBuilder::getData(size_t dim,
    size_t dataBlockingIndex) {
...
std::string StreamingOCLKernelSourceBuilder::unrolledBasisFunctionEvalulation(
...
std::string
StreamingOCLKernelSourceBuilder::unrolledBasisFunctionEvalulationTrans(
  size_t dims, size_t startDim,
  size_t endDim, std::string unrollVariable) {
  std::stringstream output;
