...
std::string StreamingModOCLFastMultiPlatformKernelSourceBuilder::getData(
  ...
  } else if (firstDeviceConfig["KERNEL_STORE_DATA"].get().compare("pointer") ==
             0) {
...
std::string StreamingModOCLFastMultiPlatformKernelSourceBuilder::getData(
  size_t dim, size_t dataBlockingIndex) {
...
std::string
StreamingModOCLFastMultiPlatformKernelSourceBuilder::unrolledBasisFunctionEvalulation(
  size_t dims,
  ...
  for (size_t d = startDim; d < endDim; d++) {
    ...
    output << indent3 << "dimLevelIndex = " << "(m * " << dims << ") + " <<
...
std::string StreamingModOCLFastMultiPlatformKernelSourceBuilder::getDataTrans(
  std::string dim,
...
std::string StreamingModOCLFastMultiPlatformKernelSourceBuilder::getLevelTrans(
  std::string dim,
...
std::string StreamingModOCLFastMultiPlatformKernelSourceBuilder::getIndexTrans(
  std::string dim,
  size_t gridBlockingIndex) {
  std::stringstream output;
...
std::string
StreamingModOCLFastMultiPlatformKernelSourceBuilder::unrolledBasisFunctionEvalulationTrans(
  size_t dims,
  size_t startDim, size_t endDim, std::string unrollVariable,
  ...
  for (size_t d = startDim; d < endDim; d++) {
    ...
    output << indent3 << "dimDataIndex = " << "(" << pointerAccess <<
...
std::string StreamingModOCLFastMultiPlatformKernelSourceBuilder::reuseSource(
  std::string fileName) {
...
void StreamingModOCLFastMultiPlatformKernelSourceBuilder::writeSource(
  std::string fileName, std::string source) {
