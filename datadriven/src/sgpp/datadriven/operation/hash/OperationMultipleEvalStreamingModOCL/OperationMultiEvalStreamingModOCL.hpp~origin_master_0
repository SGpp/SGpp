  ...
  namespace datadriven {
    ...
    class OperationMultiEvalStreamingModOCL: public base::OperationMultipleEval {
      ...
      public:
        ...
        OperationMultiEvalStreamingModOCL(base::Grid& grid, base::DataMatrix& dataset, std::shared_ptr<base::OCLOperationConfiguration> parameters) :
      ...
      private:
        ...
        size_t padDataset(
          ...
          size_t vecWidth = (*parameters)["LOCAL_SIZE"].getUInt() * (*parameters)["KERNEL_DATA_BLOCKING_SIZE"].getUInt();
