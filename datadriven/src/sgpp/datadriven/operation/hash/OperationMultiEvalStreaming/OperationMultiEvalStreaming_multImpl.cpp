...
void OperationMultiEvalStreaming::multImpl(SGPP::base::DataMatrix* level,
...
#define _mm512_broadcast_sd(A) _mm512_broadcastsd_pd(_mm_load_sd(A))
  ...
  //#pragma message "mult configured with unroll factor " STR(STREAMING_LINEAR_MIC_AVX512_UNROLLING_WIDTH)
  for (size_t i = start_index_data; i < end_index_data;
    ...
    for (size_t j = start_index_grid; j < end_index_grid; j++) {
      ...
      for (size_t d = 0; d < dims; d++) {
        ...
        eval_0 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                     _mm512_castpd_si512(eval_0)));
        eval_1 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                     _mm512_castpd_si512(eval_1)));
        eval_2 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                     _mm512_castpd_si512(eval_2)));
#if  ( STREAMING_LINEAR_MIC_AVX512_UNROLLING_WIDTH >  24 )
        eval_3 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                     _mm512_castpd_si512(eval_3)));
#endif
#if  ( STREAMING_LINEAR_MIC_AVX512_UNROLLING_WIDTH >  32 )
        eval_4 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                     _mm512_castpd_si512(eval_4)));
        eval_5 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                     _mm512_castpd_si512(eval_5)));
#endif
#if  ( STREAMING_LINEAR_MIC_AVX512_UNROLLING_WIDTH >  48 )
        eval_6 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                     _mm512_castpd_si512(eval_6)));
        eval_7 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                     _mm512_castpd_si512(eval_7)));
#endif
#if  ( STREAMING_LINEAR_MIC_AVX512_UNROLLING_WIDTH >  64 )
        eval_8 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                     _mm512_castpd_si512(eval_8)));
#endif
#if  ( STREAMING_LINEAR_MIC_AVX512_UNROLLING_WIDTH >  72 )
        eval_9 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                     _mm512_castpd_si512(eval_9)));
#endif
#if  ( STREAMING_LINEAR_MIC_AVX512_UNROLLING_WIDTH >  80 )
        eval_10 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
                                      _mm512_castpd_si512(eval_10)));
        eval_11 = _mm512_castsi512_pd(_mm512_and_epi64( abs2Mask,
