...
class StreamingOCLMultiPlatformMTKernelSourceBuilder {
private:
...
public:
    StreamingOCLMultiPlatformMTKernelSourceBuilder(std::shared_ptr<base::OCLConfigurationParameters> parameters, size_t dims);
