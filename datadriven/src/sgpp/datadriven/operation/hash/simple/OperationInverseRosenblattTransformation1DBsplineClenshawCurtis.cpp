...
OperationInverseRosenblattTransformation1DBsplineClenshawCurtis::
    OperationInverseRosenblattTransformation1DBsplineClenshawCurtis(base::Grid* grid)
...
double OperationInverseRosenblattTransformation1DBsplineClenshawCurtis::doTransformation1D(
    base::DataVector* alpha1d, double coord1d) {
  init(alpha1d);
