...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINEBOUNDARY_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINEBOUNDARY_HPP
...
class OperationInverseRosenblattTransformationBsplineBoundary
 ...
 public:
  explicit OperationInverseRosenblattTransformationBsplineBoundary(base::Grid* grid) : grid(grid) {}
  virtual ~OperationInverseRosenblattTransformationBsplineBoundary() {}
  /**
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINEBOUNDARY_HPP */
