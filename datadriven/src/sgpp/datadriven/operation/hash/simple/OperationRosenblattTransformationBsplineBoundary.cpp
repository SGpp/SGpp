...
void OperationRosenblattTransformationBsplineBoundary::doTransformation_start_dimX(
...
void OperationRosenblattTransformationBsplineBoundary::doTransformation_in_next_dim(
