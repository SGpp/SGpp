...
#ifndef OPERATIONROSENBLATTTRANSFORMATIONMODPOLY_HPP
#define OPERATIONROSENBLATTTRANSFORMATIONMODPOLY_HPP
...
class OperationRosenblattTransformationModPoly : public OperationRosenblattTransformation {
 public:
  explicit OperationRosenblattTransformationModPoly(base::Grid* grid) : grid(grid) {}
  virtual ~OperationRosenblattTransformationModPoly() {}
...
#endif /* OPERATIONROSENBLATTTRANSFORMATIONMODPOLY_HPP */
