 ...
 */
OperationRosenblattTransformation1DBspline::OperationRosenblattTransformation1DBspline(
    base::Grid* grid)
    : grid(grid) {}

OperationRosenblattTransformation1DBspline::~OperationRosenblattTransformation1DBspline() {}

double OperationRosenblattTransformation1DBspline::doTransformation1D(base::DataVector* alpha1d,
                                                                     double coord1d) {
  if (coord1d == 0.0)
    return 0.0;
  /***************** STEP 1. Compute CDF  ********************/
