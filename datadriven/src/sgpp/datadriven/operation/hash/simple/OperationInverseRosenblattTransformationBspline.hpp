...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINE_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINE_HPP
...
class OperationInverseRosenblattTransformationBspline
 ...
 public:
  explicit OperationInverseRosenblattTransformationBspline(base::Grid* grid) : grid(grid) {}
  virtual ~OperationInverseRosenblattTransformationBspline() {}
  /**
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINE_HPP */
