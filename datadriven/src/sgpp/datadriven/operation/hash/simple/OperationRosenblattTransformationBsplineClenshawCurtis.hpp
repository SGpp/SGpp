...
#ifndef OPERATIONROSENBLATTTRANSFORMATIONBSPLINECLENSHAWCURTIS_HPP
#define OPERATIONROSENBLATTTRANSFORMATIONBSPLINECLENSHAWCURTIS_HPP
...
class OperationRosenblattTransformationBsplineClenshawCurtis
 ...
 public:
  explicit OperationRosenblattTransformationBsplineClenshawCurtis(base::Grid* grid) : grid(grid) {}
...
#endif /* OPERATIONROSENBLATTTRANSFORMATIONBSPLINECLENSHAWCURTIS_HPP */
