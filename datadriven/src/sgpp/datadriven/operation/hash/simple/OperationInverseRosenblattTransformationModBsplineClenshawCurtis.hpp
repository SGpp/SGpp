...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINECLENSHAWCURTIS_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINECLENSHAWCURTIS_HPP
...
class OperationInverseRosenblattTransformationModBsplineClenshawCurtis
 ...
 public:
  explicit OperationInverseRosenblattTransformationModBsplineClenshawCurtis(base::Grid* grid)
      : grid(grid) {}
  virtual ~OperationInverseRosenblattTransformationModBsplineClenshawCurtis() {}
  /**
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINECLENSHAWCURTIS_HPP */
