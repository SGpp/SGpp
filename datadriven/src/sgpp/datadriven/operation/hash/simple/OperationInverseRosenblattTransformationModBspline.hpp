...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINE_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINE_HPP
...
class OperationInverseRosenblattTransformationModBspline
 ...
 public:
  explicit OperationInverseRosenblattTransformationModBspline(base::Grid* grid) : grid(grid) {}
  virtual ~OperationInverseRosenblattTransformationModBspline() {}
  /**
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINE_HPP */
