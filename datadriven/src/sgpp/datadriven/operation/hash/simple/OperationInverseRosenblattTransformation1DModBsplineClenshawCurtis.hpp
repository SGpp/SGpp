...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINECLENSHAWCURTIS1D_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINECLENSHAWCURTIS1D_HPP
...
class OperationInverseRosenblattTransformation1DModBsplineClenshawCurtis
 ...
 public:
  explicit OperationInverseRosenblattTransformation1DModBsplineClenshawCurtis(base::Grid* grid);
  virtual ~OperationInverseRosenblattTransformation1DModBsplineClenshawCurtis();
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINECLENSHAWCURTIS1D_HPP */
