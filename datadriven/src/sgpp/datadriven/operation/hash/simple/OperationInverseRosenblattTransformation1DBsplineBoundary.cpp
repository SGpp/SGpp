 ...
 */
OperationInverseRosenblattTransformation1DBsplineBoundary::
    OperationInverseRosenblattTransformation1DBsplineBoundary(base::Grid* grid)
    : sum(0.0), quadOrder(0), grid(grid) {}

OperationInverseRosenblattTransformation1DBsplineBoundary::
    ~OperationInverseRosenblattTransformation1DBsplineBoundary() {}

void OperationInverseRosenblattTransformation1DBsplineBoundary::init(
...
double OperationInverseRosenblattTransformation1DBsplineBoundary::sample(
...
double
OperationInverseRosenblattTransformation1DBsplineBoundary::doTransformation1D(
    base::DataVector* alpha1d, double coord1d) {
  init(alpha1d);
