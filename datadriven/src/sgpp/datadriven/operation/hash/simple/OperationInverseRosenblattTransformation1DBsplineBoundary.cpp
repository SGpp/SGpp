...
void OperationInverseRosenblattTransformation1DBsplineBoundary::init(base::DataVector* alpha1d) {
  patch_areas.clear();
...
double OperationInverseRosenblattTransformation1DBsplineBoundary::sample(base::DataVector* alpha1d,
                                                                         double coord1d) {
...
double OperationInverseRosenblattTransformation1DBsplineBoundary::doTransformation1D(
