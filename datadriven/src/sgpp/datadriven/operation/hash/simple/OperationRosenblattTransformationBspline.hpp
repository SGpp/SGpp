...
#ifndef OPERATIONROSENBLATTTRANSFORMATIONBSPLINE_HPP
#define OPERATIONROSENBLATTTRANSFORMATIONBSPLINE_HPP
...
class OperationRosenblattTransformationBspline : public OperationRosenblattTransformation {
 public:
  explicit OperationRosenblattTransformationBspline(base::Grid* grid) : grid(grid) {}
...
#endif /* OPERATIONROSENBLATTTRANSFORMATIONBSPLINE_HPP */
