...
OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary::
    OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary(base::Grid* grid)
    : sum(0.0), quadOrder(0), grid(grid) {}

OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary::
    ~OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary() {}

void OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary::init(
  ...
  size_t p = dynamic_cast<sgpp::base::PolyClenshawCurtisBoundaryGrid*>(grid)->getDegree();
  quadOrder = (p + 1) / 2;
...
double OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary::sample(
...
double OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary::doTransformation1D(
    base::DataVector* alpha1d, double coord1d) {
  init(alpha1d);
