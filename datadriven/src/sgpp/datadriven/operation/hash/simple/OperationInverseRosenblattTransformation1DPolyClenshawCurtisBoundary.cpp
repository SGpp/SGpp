...
void OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary::init(
  ...
  size_t p = dynamic_cast<sgpp::base::PolyClenshawCurtisBoundaryGrid*>(grid)
                 ->getDegree();
  quadOrder = (p + 1) / 2;
...
double
OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary::sample(
...
double OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary::
