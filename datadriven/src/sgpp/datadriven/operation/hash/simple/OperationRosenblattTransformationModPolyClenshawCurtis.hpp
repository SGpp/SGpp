...
#ifndef OPERATIONROSENBLATTTRANSFORMATIONMODPOLYCLENSHAWCURTIS_HPP
#define OPERATIONROSENBLATTTRANSFORMATIONMODPOLYCLENSHAWCURTIS_HPP
...
class OperationRosenblattTransformationModPolyClenshawCurtis
 ...
 public:
  explicit OperationRosenblattTransformationModPolyClenshawCurtis(base::Grid* grid) : grid(grid) {}
...
#endif /* OPERATIONROSENBLATTTRANSFORMATIONMODPOLYCLENSHAWCURTIS_HPP */
