...
float_t OperationTestLinearStretchedBoundary::test(SGPP::base::DataVector& alpha,
...
float_t OperationTestLinearStretchedBoundary::testMSE(SGPP::base::DataVector& alpha,
                                                      SGPP::base::DataMatrix& data,
