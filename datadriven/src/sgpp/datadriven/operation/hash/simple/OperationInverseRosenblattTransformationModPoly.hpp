...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLY_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLY_HPP
...
class OperationInverseRosenblattTransformationModPoly
 ...
 public:
  explicit OperationInverseRosenblattTransformationModPoly(base::Grid* grid) : grid(grid) {}
  virtual ~OperationInverseRosenblattTransformationModPoly() {}
  /**
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLY_HPP */
