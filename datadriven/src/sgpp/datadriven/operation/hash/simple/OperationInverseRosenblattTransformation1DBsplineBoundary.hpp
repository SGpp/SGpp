...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINEBOUNDARY1D_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINEBOUNDARY1D_HPP
...
class OperationInverseRosenblattTransformation1DBsplineBoundary : public OperationTransformation1D {
 private:
 ...
 public:
  explicit OperationInverseRosenblattTransformation1DBsplineBoundary(base::Grid* grid);
  virtual ~OperationInverseRosenblattTransformation1DBsplineBoundary();
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINEBOUNDARY1D_HPP */
