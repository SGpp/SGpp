...
#ifndef OPERATIONROSENBLATTTRANSFORMATIONBSPLINEBOUNDARY_HPP
#define OPERATIONROSENBLATTTRANSFORMATIONBSPLINEBOUNDARY_HPP
...
class OperationRosenblattTransformationBsplineBoundary : public OperationRosenblattTransformation {
 public:
  explicit OperationRosenblattTransformationBsplineBoundary(base::Grid* grid) : grid(grid) {}
  virtual ~OperationRosenblattTransformationBsplineBoundary() {}
...
#endif /* OPERATIONROSENBLATTTRANSFORMATIONBSPLINEBOUNDARY_HPP */
