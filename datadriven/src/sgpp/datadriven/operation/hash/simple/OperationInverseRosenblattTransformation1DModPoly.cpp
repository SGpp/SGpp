...
void OperationInverseRosenblattTransformation1DModPoly::init(
  ...
  size_t p = dynamic_cast<sgpp::base::ModPolyGrid*>(grid)->getDegree();
  quadOrder = (p + 1) / 2;
...
double OperationInverseRosenblattTransformation1DModPoly::sample(
