...
#ifndef OPERATIONROSENBLATTTRANSFORMATIONPOLYCLENSHAWCURTISBOUNDARY_HPP
#define OPERATIONROSENBLATTTRANSFORMATIONPOLYCLENSHAWCURTISBOUNDARY_HPP
...
class OperationRosenblattTransformationPolyClenshawCurtisBoundary
 ...
 public:
  explicit OperationRosenblattTransformationPolyClenshawCurtisBoundary(base::Grid* grid)
    : grid(grid) {}
  virtual ~OperationRosenblattTransformationPolyClenshawCurtisBoundary() {}
...
#endif /* OPERATIONROSENBLATTTRANSFORMATIONPOLYCLENSHAWCURTISBOUNDARY_HPP */
