 ...
 */
OperationRosenblattTransformation1DModBspline::OperationRosenblattTransformation1DModBspline(
    base::Grid* grid)
    : grid(grid) {}

OperationRosenblattTransformation1DModBspline::~OperationRosenblattTransformation1DModBspline() {}

double OperationRosenblattTransformation1DModBspline::doTransformation1D(base::DataVector* alpha1d,
                                                                         double coord1d) {
