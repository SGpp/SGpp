...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLYCLENSHAWCURTIS_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLYCLENSHAWCURTIS_HPP
...
class OperationInverseRosenblattTransformationModPolyClenshawCurtis
 ...
 public:
  explicit OperationInverseRosenblattTransformationModPolyClenshawCurtis(base::Grid* grid)
    : grid(grid) {}
  virtual ~OperationInverseRosenblattTransformationModPolyClenshawCurtis() {}
  /**
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLYCLENSHAWCURTIS_HPP */
