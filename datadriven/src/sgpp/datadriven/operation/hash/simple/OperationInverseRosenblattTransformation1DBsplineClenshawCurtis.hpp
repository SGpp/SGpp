...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINECLENSHAWCURTIS1D_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINECLENSHAWCURTIS1D_HPP
...
class OperationInverseRosenblattTransformation1DBsplineClenshawCurtis
 ...
 public:
  explicit OperationInverseRosenblattTransformation1DBsplineClenshawCurtis(base::Grid* grid);
  virtual ~OperationInverseRosenblattTransformation1DBsplineClenshawCurtis();
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINECLENSHAWCURTIS1D_HPP */
