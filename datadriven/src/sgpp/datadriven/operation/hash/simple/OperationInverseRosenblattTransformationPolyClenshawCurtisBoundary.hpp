...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONPOLYCLENSHAWCURTISBOUNDARY_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONPOLYCLENSHAWCURTISBOUNDARY_HPP
...
class OperationInverseRosenblattTransformationPolyClenshawCurtisBoundary
 ...
 public:
  explicit OperationInverseRosenblattTransformationPolyClenshawCurtisBoundary(base::Grid* grid)
    : grid(grid) {}
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONPOLYCLENSHAWCURTISBOUNDARY_HPP */
