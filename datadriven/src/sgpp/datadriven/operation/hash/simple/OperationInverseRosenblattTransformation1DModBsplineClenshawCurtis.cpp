...
OperationInverseRosenblattTransformation1DModBsplineClenshawCurtis::
    OperationInverseRosenblattTransformation1DModBsplineClenshawCurtis(base::Grid* grid)
...
double OperationInverseRosenblattTransformation1DModBsplineClenshawCurtis::sample(
...
double OperationInverseRosenblattTransformation1DModBsplineClenshawCurtis::doTransformation1D(
    base::DataVector* alpha1d, double coord1d) {
  init(alpha1d);
