...
void OperationInverseRosenblattTransformation1DModBsplineClenshawCurtis::init(
  ...
  size_t p = dynamic_cast<sgpp::base::ModBsplineClenshawCurtisGrid*>(grid)
                 ->getDegree();
  quadOrder = (p + 1) / 2;
...
double
OperationInverseRosenblattTransformation1DModBsplineClenshawCurtis::sample(
...
double OperationInverseRosenblattTransformation1DModBsplineClenshawCurtis::
