...
void OperationInverseRosenblattTransformationPolyBoundary::doTransformation(
...
double OperationInverseRosenblattTransformationPolyBoundary::doTransformation1D(
