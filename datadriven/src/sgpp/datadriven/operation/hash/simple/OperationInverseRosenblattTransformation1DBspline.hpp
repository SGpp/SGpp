...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINE1D_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINE1D_HPP
...
class OperationInverseRosenblattTransformation1DBspline : public OperationTransformation1D {
 private:
 ...
 public:
  explicit OperationInverseRosenblattTransformation1DBspline(base::Grid* grid);
  virtual ~OperationInverseRosenblattTransformation1DBspline();
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINE1D_HPP */
