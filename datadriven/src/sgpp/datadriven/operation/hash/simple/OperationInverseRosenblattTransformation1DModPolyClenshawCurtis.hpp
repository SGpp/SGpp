...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLYCLENSHAWCURTIS1D_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLYCLENSHAWCURTIS1D_HPP
...
class OperationInverseRosenblattTransformation1DModPolyClenshawCurtis
 ...
 public:
  explicit OperationInverseRosenblattTransformation1DModPolyClenshawCurtis(base::Grid* grid);
  virtual ~OperationInverseRosenblattTransformation1DModPolyClenshawCurtis();
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLYCLENSHAWCURTIS1D_HPP */
