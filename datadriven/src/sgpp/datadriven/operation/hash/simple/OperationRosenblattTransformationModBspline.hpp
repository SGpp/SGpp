...
#ifndef OPERATIONROSENBLATTTRANSFORMATIONMODBSPLINE_HPP
#define OPERATIONROSENBLATTTRANSFORMATIONMODBSPLINE_HPP
...
class OperationRosenblattTransformationModBspline : public OperationRosenblattTransformation {
 public:
  explicit OperationRosenblattTransformationModBspline(base::Grid* grid) : grid(grid) {}
  virtual ~OperationRosenblattTransformationModBspline() {}
...
#endif /* OPERATIONROSENBLATTTRANSFORMATIONMODBSPLINE_HPP */
