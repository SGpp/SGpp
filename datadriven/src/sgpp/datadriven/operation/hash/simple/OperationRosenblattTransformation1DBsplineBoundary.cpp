 ...
 */
OperationRosenblattTransformation1DBsplineBoundary::
    OperationRosenblattTransformation1DBsplineBoundary(base::Grid* grid)
    : grid(grid) {}

OperationRosenblattTransformation1DBsplineBoundary::
    ~OperationRosenblattTransformation1DBsplineBoundary() {}

double OperationRosenblattTransformation1DBsplineBoundary::doTransformation1D(
