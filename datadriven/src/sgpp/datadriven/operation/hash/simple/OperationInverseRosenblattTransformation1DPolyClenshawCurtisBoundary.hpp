...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONPOLYCLENSHAWCURTISBOUNDARY1D_HPP
...
class OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary
 ...
 public:
  explicit OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary(base::Grid* grid);
  virtual ~OperationInverseRosenblattTransformation1DPolyClenshawCurtisBoundary();
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONPOLYCLENSHAWCURTISBOUNDARY1D_HPP */
