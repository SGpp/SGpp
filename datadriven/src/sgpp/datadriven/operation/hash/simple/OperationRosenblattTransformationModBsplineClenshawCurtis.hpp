...
#ifndef OPERATIONROSENBLATTTRANSFORMATIONMODBSPLINECLENSHAWCURTIS_HPP
#define OPERATIONROSENBLATTTRANSFORMATIONMODBSPLINECLENSHAWCURTIS_HPP
...
class OperationRosenblattTransformationModBsplineClenshawCurtis
 ...
 public:
  explicit OperationRosenblattTransformationModBsplineClenshawCurtis(base::Grid* grid)
      : grid(grid) {}
  virtual ~OperationRosenblattTransformationModBsplineClenshawCurtis() {}
...
#endif /* OPERATIONROSENBLATTTRANSFORMATIONMODBSPLINECLENSHAWCURTIS_HPP */
