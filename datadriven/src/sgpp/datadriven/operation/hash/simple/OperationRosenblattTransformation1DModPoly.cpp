 ...
 */
OperationRosenblattTransformation1DModPoly::OperationRosenblattTransformation1DModPoly(
    base::Grid* grid)
    : grid(grid) {}

OperationRosenblattTransformation1DModPoly::~OperationRosenblattTransformation1DModPoly() {}

double OperationRosenblattTransformation1DModPoly::doTransformation1D(base::DataVector* alpha1d,
                                                                      double coord1d) {
