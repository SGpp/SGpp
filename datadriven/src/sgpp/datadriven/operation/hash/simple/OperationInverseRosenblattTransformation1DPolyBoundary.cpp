 ...
 */
OperationInverseRosenblattTransformation1DPolyBoundary::
    OperationInverseRosenblattTransformation1DPolyBoundary(base::Grid* grid)
    : sum(0.0), quadOrder(0), grid(grid) {}

OperationInverseRosenblattTransformation1DPolyBoundary::
    ~OperationInverseRosenblattTransformation1DPolyBoundary() {}

void OperationInverseRosenblattTransformation1DPolyBoundary::init(
...
double OperationInverseRosenblattTransformation1DPolyBoundary::sample(
...
double
OperationInverseRosenblattTransformation1DPolyBoundary::doTransformation1D(
    base::DataVector* alpha1d, double coord1d) {
  init(alpha1d);
