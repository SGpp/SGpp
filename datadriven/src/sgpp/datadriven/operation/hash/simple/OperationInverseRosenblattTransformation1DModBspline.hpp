...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINE1D_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINE1D_HPP
...
class OperationInverseRosenblattTransformation1DModBspline : public OperationTransformation1D {
 private:
 ...
 public:
  explicit OperationInverseRosenblattTransformation1DModBspline(base::Grid* grid);
  virtual ~OperationInverseRosenblattTransformation1DModBspline();
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODBSPLINE1D_HPP */
