...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLY1D_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLY1D_HPP
...
class OperationInverseRosenblattTransformation1DModPoly : public OperationTransformation1D {
 private:
 ...
 public:
  explicit OperationInverseRosenblattTransformation1DModPoly(base::Grid* grid);
  virtual ~OperationInverseRosenblattTransformation1DModPoly();
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONMODPOLY1D_HPP */
