...
#ifndef OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINECLENSHAWCURTIS_HPP
#define OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINECLENSHAWCURTIS_HPP
...
class OperationInverseRosenblattTransformationBsplineClenshawCurtis
 ...
 public:
  explicit OperationInverseRosenblattTransformationBsplineClenshawCurtis(base::Grid* grid)
      : grid(grid) {}
  virtual ~OperationInverseRosenblattTransformationBsplineClenshawCurtis() {}
  /**
...
#endif /* OPERATIONINVERSEROSENBLATTTRANSFORMATIONBSPLINECLENSHAWCURTIS_HPP */
