...
Node::Node(std::vector<float_t> x, std::vector<float_t> h, std::vector<size_t> supportIndizes, base::DataMatrix &dataset,
...
float_t Node::getAverage(std::vector<size_t> &supportIndizes, std::vector<float_t> &x, std::vector<float_t> &h) {
    float_t sum = 0.0;
...
float_t Node::getMSE(std::vector<size_t> &supportIndizes, std::vector<float_t> &x, std::vector<float_t> &h,
...
void Node::hierarchize(float_t targetMSE, size_t targetMaxLevel, float_t parentValue, size_t refineDim,
        size_t levelLimit) {
