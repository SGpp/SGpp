...
//#include "StreamingOCLMPParameters.hpp"

namespace SGPP {
namespace datadriven {

std::string StreamingOCLMPKernelSourceBuilder::generateSourceMultTrans() {

    if (parameters.getAsBoolean("REUSE_SOURCE")) {
        return this->reuseSource("StreamingOCLMP_multTrans.cl");
    }
    ...
    if (parameters.getAsBoolean("WRITE_SOURCE")) {
        this->writeSource("StreamingOCLMP_multTrans.cl", sourceStream.str());
    }
