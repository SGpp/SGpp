...
class StreamingOCLMPKernelImpl {
private:
    size_t dims;
    ...
    StreamingOCLMPKernelSourceBuilder kernelSourceBuilder;
...
public:
    ...
    StreamingOCLMPKernelImpl(size_t dims, base::OCLManager& manager, base::OCLConfigurationParameters parameters) :
