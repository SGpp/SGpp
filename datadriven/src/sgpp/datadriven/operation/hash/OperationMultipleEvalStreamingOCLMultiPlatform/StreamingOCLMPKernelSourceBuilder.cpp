...
StreamingOCLMPKernelSourceBuilder::StreamingOCLMPKernelSourceBuilder(base::OCLConfigurationParameters parameters,
        size_t dims) :
...
std::string StreamingOCLMPKernelSourceBuilder::asString() {
...
std::string StreamingOCLMPKernelSourceBuilder::constSuffix() {
    if (parameters["INTERNAL_PRECISION"] == "float") {
        return "f";
    } else {
        return "";
...
std::string StreamingOCLMPKernelSourceBuilder::intAsString() {
    if (parameters["INTERNAL_PRECISION"] == "float") {
        return "uint";
    } else {
        return "ulong";
...
std::string StreamingOCLMPKernelSourceBuilder::reuseSource(std::string fileName) {
...
void StreamingOCLMPKernelSourceBuilder::writeSource(std::string fileName, std::string source) {
...
std::string StreamingOCLMPKernelSourceBuilder::getData(std::string dim, size_t dataBlockingIndex) {
...
std::string StreamingOCLMPKernelSourceBuilder::getData(size_t dim, size_t dataBlockingIndex) {
...
std::string StreamingOCLMPKernelSourceBuilder::unrolledBasisFunctionEvalulation(size_t dims, size_t startDim,
