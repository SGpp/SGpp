...
#include "StreamingOCLMPKernelImpl.hpp"

namespace SGPP {
namespace datadriven {

template<typename T>
class OperationMultiEvalStreamingOCLMP: public base::OperationMultipleEval {
protected:
    ...
    StreamingOCLMPKernelImpl<T> *kernel;
public:

    OperationMultiEvalStreamingOCLMP(base::Grid& grid, base::DataMatrix& dataset,
            base::OCLConfigurationParameters parameters) :
        ...
        this->kernel = new StreamingOCLMPKernelImpl<T>(dims, *(this->manager), parameters);
    ...
    ~OperationMultiEvalStreamingOCLMP() {
