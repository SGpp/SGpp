...
#include "StreamingMod1DOCLKernelSourceBuilder.hpp"

namespace SGPP {
  namespace datadriven {

    template<typename real_type>
    class StreamingMod1DOCLKernelImpl {
      private:
        size_t dims;
        ...
        StreamingMod1DOCLKernelSourceBuilder<real_type> kernelSourceBuilder;
      ...
      public:
        ...
        StreamingMod1DOCLKernelImpl(size_t dims, base::OCLManager& manager, base::ConfigurationParameters parameters) :
