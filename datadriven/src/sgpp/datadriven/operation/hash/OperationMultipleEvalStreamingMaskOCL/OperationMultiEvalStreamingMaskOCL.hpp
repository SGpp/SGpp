...
#include <sgpp/datadriven/operation/hash/OperationMultipleEvalStreamingMaskOCL/OCLKernelImpl.hpp>
...
namespace SGPP {
  namespace datadriven {
    ...
    template<typename T>
    class OperationMultiEvalStreamingMaskOCL: public base::OperationMultipleEval {
      protected:
        size_t dims;
      ...
      public:
        ...
        OperationMultiEvalStreamingMaskOCL(base::Grid& grid, base::DataMatrix& dataset, base::OpenCLConfigurationParameters parameters) :
        ...
        ~OperationMultiEvalStreamingMaskOCL() {
