...
#include <sgpp/datadriven/operation/hash/OperationMultipleEvalStreamingModOCLMaskMultiPlatform/StreamingModOCLMaskMultiPlatformKernelSourceBuilder.hpp>

namespace SGPP {
namespace datadriven {

std::string StreamingModOCLMaskMultiPlatformKernelSourceBuilder::generateSourceMultTrans() {
