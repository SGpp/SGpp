...
class StreamingModOCLMaskMultiPlatformKernelSourceBuilder {
private:
...
public:
    StreamingModOCLMaskMultiPlatformKernelSourceBuilder(std::shared_ptr<base::OCLOperationConfiguration> parameters, size_t dims);
