...
#include <sgpp/datadriven/operation/hash/OperationMultipleEvalStreamingModOCLFast/StreamingModOCLFastKernelImpl.hpp>

namespace SGPP {
namespace datadriven {

template<typename T>
class OperationMultiEvalStreamingModOCLFast: public
 ...
 protected:
  ...
  std::unique_ptr<StreamingModOCLFastKernelImpl<T>> kernel;
 public:

  OperationMultiEvalStreamingModOCLFast(base::Grid& grid,
    ...
    this->kernel = std::unique_ptr<StreamingModOCLFastKernelImpl<T>>
                   (new StreamingModOCLFastKernelImpl<T>(dims, this->manager, parameters));
