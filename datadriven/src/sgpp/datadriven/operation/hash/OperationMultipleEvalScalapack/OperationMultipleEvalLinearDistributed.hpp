 ...
 *
 * OperationMultipleEvalLinearDistributed.hpp
 *
...
/**
 * This class is a distributed version of sgpp::base::OperationMultipleEvalLinear, it uses
 * ScaLAPACK.
 *
 * It implements distributed OperationB for a grid with modified linear ansatzfunctions
 */
class OperationMultipleEvalLinearDistributed : public OperationMultipleEvalDistributed {
 public:
  /**
   * Constructor
   * @param grid
   ...
   * @param result the result vector of the matrix vector multiplication
   */
  void multTransposeDistributed(sgpp::base::DataVector& source,
                                DataVectorDistributed& result) override;
