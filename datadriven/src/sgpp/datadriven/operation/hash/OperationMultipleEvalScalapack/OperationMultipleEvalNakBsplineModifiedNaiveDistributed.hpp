 ...
 *
 * OperationMultipleEvalBsplineBoundaryNaiveDistributed.hpp
 */
...
class OperationMultipleEvalNakBsplineModifiedNaiveDistributed
 ...
 public:
   ...
   * @param dataset
   */
  OperationMultipleEvalNakBsplineModifiedNaiveDistributed(base::Grid& grid, size_t degree,
                                                          DataMatrix& dataset)
   ...
   * Destructor
   */
  ~OperationMultipleEvalNakBsplineModifiedNaiveDistributed() override {}
 ...
 protected:
  ...
  /// 1D B-spline basis
  base::SNakBsplineModifiedBase base;
