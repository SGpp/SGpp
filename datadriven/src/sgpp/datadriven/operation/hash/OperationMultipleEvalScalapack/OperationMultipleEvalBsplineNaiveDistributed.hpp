 ...
 *
 * OperationMultipleEvalBsplineNaiveDistributed.hpp
 */
...
class OperationMultipleEvalBsplineNaiveDistributed : public OperationMultipleEvalDistributed {
 public:
  /**
   * Constructor
   * @param grid
   ...
   * @param dataset
   */
  OperationMultipleEvalBsplineNaiveDistributed(base::Grid& grid, size_t degree, DataMatrix& dataset)
      : OperationMultipleEvalDistributed(grid, dataset), storage(grid.getStorage()), base(degree) {}

  /**
   * Destructor
   */
  ~OperationMultipleEvalBsplineNaiveDistributed() override {}
