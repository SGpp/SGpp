...
void OperationMultipleEvalPartialDerivativeNakBsplineExtendedNaiveDistributed::multDistributed(
...
void OperationMultipleEvalPartialDerivativeNakBsplineExtendedNaiveDistributed::
...
double OperationMultipleEvalPartialDerivativeNakBsplineExtendedNaiveDistributed::getDuration() {
  return 0.0;
}
