...
void OperationMultipleEvalNakBsplineBoundaryNaiveDistributed::multDistributed(
...
void OperationMultipleEvalNakBsplineBoundaryNaiveDistributed::multTransposeDistributed(
    DataVector& alpha, DataVectorDistributed& result) {
  if (!result.isProcessMapped()) {
    return;
  }
...
double OperationMultipleEvalNakBsplineBoundaryNaiveDistributed::getDuration() { return 0.0; }
