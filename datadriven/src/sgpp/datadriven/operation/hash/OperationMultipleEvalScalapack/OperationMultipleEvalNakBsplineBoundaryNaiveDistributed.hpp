...
class OperationMultipleEvalNakBsplineBoundaryNaiveDistributed
 ...
 public:
   ...
   * @param dataset
   */
  OperationMultipleEvalNakBsplineBoundaryNaiveDistributed(base::Grid& grid, size_t degree,
                                                          DataMatrix& dataset)
   ...
   * Destructor
   */
  ~OperationMultipleEvalNakBsplineBoundaryNaiveDistributed() override {}
