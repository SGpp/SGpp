...
/**
 * This class is a distributed version of sgpp::base::OperationMultipleEvalKinkLinear, it uses
 * ScaLAPACK.
 *
 * It implements distributed OperationB for a grid with kinked linear ansatzfunctions
 */
class OperationMultipleEvalKinkLinearDistributed : public OperationMultipleEvalDistributed {
 public:
  /**
   * Constructor
   * @param grid
   * @param dataset
   */
  OperationMultipleEvalKinkLinearDistributed(sgpp::base::Grid& grid, sgpp::base::DataMatrix& dataset)
      : OperationMultipleEvalDistributed(grid, dataset), storage(grid.getStorage()) {}

  /**
   * Destructor
   */
  ~OperationMultipleEvalKinkLinearDistributed() override {}
