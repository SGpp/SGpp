 ...
 *
 * OperationMultipleEvalPartialDerivativeModBsplineNaiveDistributed.cpp
 *
 */
...
void OperationMultipleEvalPartialDerivativeModBsplineNaiveDistributed::multDistributed(
...
void OperationMultipleEvalPartialDerivativeModBsplineNaiveDistributed::multTransposeDistributed(
    DataVector& alpha, DataVectorDistributed& result) {
  if (!result.isProcessMapped()) {
    return;
  }
...
double OperationMultipleEvalPartialDerivativeModBsplineNaiveDistributed::getDuration() {
  return 0.0;
}
