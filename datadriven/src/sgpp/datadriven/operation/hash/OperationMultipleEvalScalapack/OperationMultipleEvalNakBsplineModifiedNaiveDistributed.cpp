...
void OperationMultipleEvalNakBsplineModifiedNaiveDistributed::multDistributed(
...
void OperationMultipleEvalNakBsplineModifiedNaiveDistributed::multTransposeDistributed(
    DataVector& alpha, DataVectorDistributed& result) {
  if (!result.isProcessMapped()) {
    return;
  }
...
double OperationMultipleEvalNakBsplineModifiedNaiveDistributed::getDuration() { return 0.0; }
