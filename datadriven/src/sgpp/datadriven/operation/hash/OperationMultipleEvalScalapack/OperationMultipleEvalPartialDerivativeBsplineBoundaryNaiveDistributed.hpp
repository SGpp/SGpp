 ...
 *
 * OperationMultipleEvalPartialDerivativeBsplineBoundaryNaiveDistributed.hpp
 *
 */
...
class OperationMultipleEvalPartialDerivativeBsplineBoundaryNaiveDistributed
 ...
 public:
   ...
   * @param derivD
   */
  OperationMultipleEvalPartialDerivativeBsplineBoundaryNaiveDistributed(base::Grid& grid,
                                                                        size_t degree,
                                                                        DataMatrix& dataset,
                                                                        size_t derivD)
   ...
   * Destructor
   */
  ~OperationMultipleEvalPartialDerivativeBsplineBoundaryNaiveDistributed() override {}
