...
class OperationMultipleEvalNakBsplineExtendedNaiveDistributed
 ...
 public:
   ...
   * @param dataset
   */
  OperationMultipleEvalNakBsplineExtendedNaiveDistributed(base::Grid& grid, size_t degree,
                                                          DataMatrix& dataset)
   ...
   * Destructor
   */
  ~OperationMultipleEvalNakBsplineExtendedNaiveDistributed() override {}
