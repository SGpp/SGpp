 ...
 *
 * OperationMultipleEvalPartialDerivativeBsplineNaiveDistributed.cpp
 *
 */
...
void OperationMultipleEvalPartialDerivativeBsplineNaiveDistributed::multDistributed(
    base::DataVector& alpha, DataVectorDistributed& result) {
...
void OperationMultipleEvalPartialDerivativeBsplineNaiveDistributed::multTransposeDistributed(
...
double OperationMultipleEvalPartialDerivativeBsplineNaiveDistributed::getDuration() { return 0.0; }
