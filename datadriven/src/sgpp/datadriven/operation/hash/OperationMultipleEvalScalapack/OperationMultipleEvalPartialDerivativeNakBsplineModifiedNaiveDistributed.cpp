...
void OperationMultipleEvalPartialDerivativeNakBsplineModifiedNaiveDistributed::multDistributed(
...
void OperationMultipleEvalPartialDerivativeNakBsplineModifiedNaiveDistributed::
...
double OperationMultipleEvalPartialDerivativeNakBsplineModifiedNaiveDistributed::getDuration() {
  return 0.0;
}
