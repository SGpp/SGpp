...
class OperationMultipleEvalBsplineBoundaryNaiveDistributed
 ...
 public:
   ...
   * @param dataset
   */
  OperationMultipleEvalBsplineBoundaryNaiveDistributed(base::Grid& grid, size_t degree,
                                                       DataMatrix& dataset)
   ...
   * Destructor
   */
  ~OperationMultipleEvalBsplineBoundaryNaiveDistributed() override {}
