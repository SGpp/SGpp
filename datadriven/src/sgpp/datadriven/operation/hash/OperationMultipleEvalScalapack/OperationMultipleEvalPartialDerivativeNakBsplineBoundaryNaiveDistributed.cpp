...
void OperationMultipleEvalPartialDerivativeNakBsplineBoundaryNaiveDistributed::multDistributed(
...
void OperationMultipleEvalPartialDerivativeNakBsplineBoundaryNaiveDistributed::
...
double OperationMultipleEvalPartialDerivativeNakBsplineBoundaryNaiveDistributed::getDuration() {
  return 0.0;
}
