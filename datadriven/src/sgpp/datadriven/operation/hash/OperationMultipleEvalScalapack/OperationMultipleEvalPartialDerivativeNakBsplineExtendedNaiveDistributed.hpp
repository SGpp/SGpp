...
class OperationMultipleEvalPartialDerivativeNakBsplineExtendedNaiveDistributed
 ...
 public:
   ...
   * @param derivD
   */
  OperationMultipleEvalPartialDerivativeNakBsplineExtendedNaiveDistributed(base::Grid& grid,
                                                                           size_t degree,
                                                                           DataMatrix& dataset,
                                                                           size_t derivD)
   ...
   * Destructor
   */
  ~OperationMultipleEvalPartialDerivativeNakBsplineExtendedNaiveDistributed() override {}
 ...
 protected:
  ...
  /// 1D B-spline basis
  base::SNakBsplineExtendedBase base;
