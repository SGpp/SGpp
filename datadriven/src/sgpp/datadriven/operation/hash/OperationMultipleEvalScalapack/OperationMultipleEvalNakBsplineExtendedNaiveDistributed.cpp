...
void OperationMultipleEvalNakBsplineExtendedNaiveDistributed::multDistributed(
...
void OperationMultipleEvalNakBsplineExtendedNaiveDistributed::multTransposeDistributed(
    DataVector& alpha, DataVectorDistributed& result) {
  if (!result.isProcessMapped()) {
    return;
  }
...
double OperationMultipleEvalNakBsplineExtendedNaiveDistributed::getDuration() { return 0.0; }
