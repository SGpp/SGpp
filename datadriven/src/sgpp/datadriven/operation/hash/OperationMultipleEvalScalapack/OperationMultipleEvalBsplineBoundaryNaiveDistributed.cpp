 ...
 *
 * OperationMultipleEvalBsplineBoundaryNaiveDistributed.cpp
 *
 */
...
void OperationMultipleEvalBsplineBoundaryNaiveDistributed::multDistributed(
...
void OperationMultipleEvalBsplineBoundaryNaiveDistributed::multTransposeDistributed(
    DataVector& alpha, DataVectorDistributed& result) {
  if (!result.isProcessMapped()) {
    return;
  }
...
double OperationMultipleEvalBsplineBoundaryNaiveDistributed::getDuration() { return 0.0; }
