...
class OperationMultipleEvalPartialDerivativeNakBsplineModifiedNaiveDistributed
 ...
 public:
   ...
   * @param derivD
   */
  OperationMultipleEvalPartialDerivativeNakBsplineModifiedNaiveDistributed(base::Grid& grid,
                                                                           size_t degree,
                                                                           DataMatrix& dataset,
                                                                           size_t derivD)
   ...
   * Destructor
   */
  ~OperationMultipleEvalPartialDerivativeNakBsplineModifiedNaiveDistributed() override {}
