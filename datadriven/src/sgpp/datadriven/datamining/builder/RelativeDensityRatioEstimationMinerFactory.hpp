...
/**
 * Concrete Factory that builds an instance of #sgpp::datadriven::SparseGridMiner for Relative
 * Density Ratio Estimation
 */
class RelativeDensityRatioEstimationMinerFactory : public MinerFactory {
 public:
  /**
   * Default constructor
   */
  RelativeDensityRatioEstimationMinerFactory() = default;
