 ...
 */
class ModelFittingDensityDerivativeEstimationCG : public ModelFittingDensityEstimation {
 public:
  /**
   * Constructor
   *
   ...
   */
  explicit ModelFittingDensityDerivativeEstimationCG(
  ...
  void resetTraining() override {
    throw sgpp::base::not_implemented_exception(
        "ModelFittingDensityDerivativeEstimationCG::resetTraining() is not implemented!");
  }
  ...
  double computeResidual(DataMatrix& validationData) const override {
    throw sgpp::base::not_implemented_exception(
        "ModelFittingDensityDerivativeEstimationCG::computeResidual() is not "
        "implemented!");
  }
  ...
  void updateRegularization(double lambda) override {
    throw sgpp::base::not_implemented_exception(
        "ModelFittingDensityDerivativeEstimationCG::updateRegularization() is not "
        "implemented!");
  }
