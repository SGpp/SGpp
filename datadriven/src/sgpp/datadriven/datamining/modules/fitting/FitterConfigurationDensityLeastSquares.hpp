...
/**
 * Configuration for fitter scenarios using least squares optimization for solving density
 * estimation problems.
 */
class FitterConfigurationDensityLeastSquares : public FitterConfiguration {
 public:
  FitterConfigurationDensityLeastSquares() = default;
