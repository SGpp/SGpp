...
class ModelFittingRelativeDensityRatioEstimation : public ModelFittingBaseSingleGrid {
 public:
   ...
   */
  double relativeLeastSquaresLossApprox(DataMatrix &samplesP, DataMatrix &samplesQ) override;
   ...
   */
  double relativeKLDivergenceApprox(DataMatrix &samplesP) override;
   ...
   */
  double relativePEDivergenceApprox(DataMatrix &samplesP, DataMatrix &samplesQ) override;
  ...
  double computeResidual(DataMatrix &validationData) const override {
    throw sgpp::base::not_implemented_exception(
        "ModelFittingRelativeDensityRatioEstimation::computeResidual() is not implemented!");
  }
  ...
  void updateRegularization(double lambda) override {
    throw sgpp::base::not_implemented_exception(
        "ModelFittingRelativeDensityRatioEstimation::updateRegularization() is not implemented!");
  }
  ...
  void resetTraining() override {
    throw sgpp::base::not_implemented_exception(
        "ModelFittingRelativeDensityRatioEstimation::resetTraining() is not implemented!");
  }
