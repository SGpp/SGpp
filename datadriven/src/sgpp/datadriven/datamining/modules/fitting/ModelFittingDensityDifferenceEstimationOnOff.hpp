 ...
 *
 * ModelFittingDensityDifferenceEstimationOnOff.hpp
 *
 * Author: Paul Sarbu
 */
 ...
 */
class ModelFittingDensityDifferenceEstimationOnOff : public ModelFittingDensityEstimation {
 public:
  /**
   * Constructor
   *
   ...
   */
  explicit ModelFittingDensityDifferenceEstimationOnOff(
