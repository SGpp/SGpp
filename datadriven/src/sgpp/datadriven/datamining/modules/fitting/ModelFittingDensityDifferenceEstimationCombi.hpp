...
/**
 * Class to add combigrid functionality to density difference estimators.
 */

class ModelFittingDensityDifferenceEstimationCombi : public ModelFittingDensityEstimationCombi {
 public:
  /**
   * Default constructor
   */
  ModelFittingDensityDifferenceEstimationCombi();
   ...
   */
  explicit ModelFittingDensityDifferenceEstimationCombi(
