 ...
 */
class ModelFittingDensityDerivativeRatioEstimation : public ModelFittingBaseSingleGrid {
 public:
  /**
   * Constructor
   *
  ...
  void resetTraining() override {
    throw sgpp::base::not_implemented_exception(
        "ModelFittingDensityDerivativeRatioEstimation::resetTraining() is not implemented!");
  }
