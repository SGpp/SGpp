...
/**
 * SampleProvider is an abstraction for object that provide sample data from various sources e.g.
 * datasets from files (e.g.ARFF, CSV) or synthetic datasets generated by sampling functions (e.g.
 * Friedmann datasets).
 */
class SampleProvider {
 public:
  ...
  /**
   * Clone pattern for polymorphic cloning (e.g. copy constructors).
   *
   * @return SampleProvider* pointer to clone of this class. This object is owned by the caller.
   */
   ...
   * @return Dataset* Pointer to a new #Dataset object containing at most the requested amount of
   ...
   * @return Dataset* Pointer to a new #Dataset object. This object is owned by the caller.
   */
