...
Harmonica::Harmonica(double firstvalue)
...
double Harmonica::mean(base::DataVector knew){
	return knew.dotProduct(transformedOutput);
}

double Harmonica::var(base::DataVector knew, double kself){
...
double Harmonica::acquisitionPI(base::DataVector knew, double kself, double bestsofar){
    if(var(knew,kself)==0){
      return 0;
    }
...
double Harmonica::acquisitionEI(base::DataVector knew, double kself, double bestsofar){
...
void Harmonica::updateGP(base::DataVector knew, base::DataVector y){
...
void Harmonica::CholeskyDecomposition(){
...
void Harmonica::solveCholeskySystem(base::DataVector& x){
  // base::DataVector x(b);
