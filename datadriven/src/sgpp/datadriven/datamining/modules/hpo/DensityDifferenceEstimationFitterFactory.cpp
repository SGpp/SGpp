...
DensityDifferenceEstimationFitterFactory::DensityDifferenceEstimationFitterFactory(
...
ModelFittingBase *DensityDifferenceEstimationFitterFactory::buildFitter() {
  // build config
