 ...
 * #sgpp::datadriven::ModelFittingRelativeDensityRatioEstimation
 */
class RelativeDensityRatioEstimationFitterFactory : public FitterFactory {
 public:
  /**
   * Default constructor
   */
  explicit RelativeDensityRatioEstimationFitterFactory(const DataMiningConfigParser &parser);

  /**
   * Assemble a #sgpp::datadriven::ModelFittingRelativeDensityRatioEstimation object based on the
   * configuration determined by a previous set_() call.
   * @return Fully configured instance of a
   * #sgpp::datadriven::ModelFittingRelativeDensityRatioEstimation object.
   */
