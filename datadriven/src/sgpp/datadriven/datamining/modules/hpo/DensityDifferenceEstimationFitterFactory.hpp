...
/**
 * Concrete factory to build instances of #sgpp::datadriven::ModelFittingDensityDifferenceEstimation
 */
class DensityDifferenceEstimationFitterFactory : public FitterFactory {
 public:
  /**
   * Default constructor
   */
  explicit DensityDifferenceEstimationFitterFactory(const DataMiningConfigParser &parser);

  /**
   * Assemble a #sgpp::datadriven::ModelFittingDensityDifferenceEstimation object based on the
   * configuration determined by a previous set_() call.
   * @return Fully configured instance of a
   * #sgpp::datadriven::ModelFittingDensityDifferenceEstimation object.
   */
