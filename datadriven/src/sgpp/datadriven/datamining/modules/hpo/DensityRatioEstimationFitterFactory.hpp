 ...
 * #sgpp::datadriven::ModelFittingDensityRatioEstimation
 */
class DensityRatioEstimationFitterFactory : public FitterFactory {
 public:
  /**
   * Default constructor
   */
  explicit DensityRatioEstimationFitterFactory(const DataMiningConfigParser &parser);

  /**
   * Assemble a #sgpp::datadriven::ModelFittingDensityRatioEstimation object based on the
   * configuration determined by a previous set_() call.
   * @return Fully configured instance of a
   * #sgpp::datadriven::ModelFittingDensityRatioEstimation object.
   */
