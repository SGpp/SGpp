...
//  // ...
//  // TODO(lettrich): set default values
...
//        config.stringToRegularizationType(config["regularization"]["type"].get());
//
//    // configure learner
...
//  DataVector rhs(gridStorage.getSize());
...
//    std::shared_ptr<OperationMatrix> C = getRegularizationMatrix(regularizationConfig.regType_);
...
//
//      alpha->resize(gridStorage.getSize());
//      rhs.resize(gridStorage.getSize());
//      alpha->setAll(0.0);
//      rhs.setAll(0.0);
//    }
//  }
