...
/**
 * SparseGridMinerSplitting_TwoDatasets models a datamining process that involves two input datasets
...
class SparseGridMinerSplitting_TwoDatasets : public SparseGridMiner {
 public:
   ...
   */
  SparseGridMinerSplitting_TwoDatasets(std::vector<DataSourceSplitting*> dataSource,
   ...
   */
  SparseGridMinerSplitting_TwoDatasets(const SparseGridMinerSplitting_TwoDatasets& rhs) = delete;

  /**
   * Default Move constructor .
   * @param rhs the object to move from
   */
  SparseGridMinerSplitting_TwoDatasets(SparseGridMinerSplitting_TwoDatasets&& rhs) = default;

  /**
   * Default Move assign operator.
   * @param rhs the object to move from
   */
  SparseGridMinerSplitting_TwoDatasets& operator=(SparseGridMinerSplitting_TwoDatasets&& rhs) = default;

  /**
   * Default copy assign operator deleted because not all members can be copied.
   * @param rhs the object to copy from
   */
  SparseGridMinerSplitting_TwoDatasets& operator=(const SparseGridMinerSplitting_TwoDatasets& rhs) = delete;
