...
bool DataMiningConfigParser::getDataSourceConfig(DataSourceConfig &config,
  ...
  if (hasDataSource) {
    ...
    config.testIsCompressed = parseBool(*dataSourceConfig, "testCompression", defaults.testIsCompressed, "dataSource");
    config.testNumBatches = parseUInt(*dataSourceConfig, "testNumBatches", defaults.testNumBatches, "dataSource");
    config.testBatchSize = parseUInt(*dataSourceConfig, "testBatchSize", defaults.testBatchSize, "dataSource");
    config.testHasTargets = parseBool(*dataSourceConfig, "testHasTargets", defaults.testHasTargets, "dataSource");

    config.testReadinCutoff = static_cast<size_t>(parseInt(*dataSourceConfig, "testReadinCutoff", defaults.testReadinCutoff, "dataSource"));
    config.testReadinClasses = parseDoubleArray(*dataSourceConfig, "testReadinClasses", defaults.testReadinClasses, "dataSource");
    config.testReadinColumns = parseUIntArray(*dataSourceConfig, "testReadinColumns", defaults.testReadinColumns, "dataSource");
