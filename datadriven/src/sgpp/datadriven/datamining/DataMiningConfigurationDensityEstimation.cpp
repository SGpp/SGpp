...
std::shared_ptr<SGPP::base::RegularGridConfiguration> DataMiningConfigurationDensityEstimation::getGridConfig() {
  return gridConfig;
}

std::shared_ptr<SGPP::base::AdpativityConfiguration> DataMiningConfigurationDensityEstimation::getRefinementConfig() {
  return adaptivityConfig;
}

std::shared_ptr<SGPP::solver::SLESolverConfiguration> DataMiningConfigurationDensityEstimation::getSolverConfig() {
  return solverConfig;
}

std::shared_ptr<SGPP::datadriven::RegularizationConfiguration> DataMiningConfigurationDensityEstimation::getRegularizationConfig() {
  return regularizationConfig;
}

std::shared_ptr<SGPP::datadriven::DataMiningConfigurationDensityEstimationType> DataMiningConfigurationDensityEstimation::getSGDEConfig() {
  return sgdeConfig;
}
