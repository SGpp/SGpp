      ...
      if (strcmp(grid.getType(), "linear") == 0) {
        ...
        if (configuration.type
          ...
          if (configuration.subType
              == SGPP::datadriven::OperationMultipleEvalSubType::OCL) {
#ifdef USE_OCL
            return datadriven::createStreamingModOCLConfigured(grid,
                   dataset);
#else
            throw base::factory_exception("Error creating function: the library wasn't compiled with OpenCL support");
#endif
...
#ifdef USE_OCL
            return datadriven::createStreamingMod1DOCLConfigured(grid,
                   dataset);
#else
            throw base::factory_exception("Error creating function: the library wasn't compiled with OpenCL support");
#endif
...
#ifdef USE_OCL
            return datadriven::createStreamingModOCLFastConfigured(grid,
                   dataset);
#else
            throw base::factory_exception("Error creating function: the library wasn't compiled with OpenCL support");
#endif
        ...
        if (configuration.type
          ...
          if (configuration.subType
              == SGPP::datadriven::OperationMultipleEvalSubType::OCL) {
#ifdef USE_OCL
            return datadriven::createStreamingBSplineOCLConfigured(grid,
                   dataset);
#else
            throw base::factory_exception("Error creating function: the library wasn't compiled with OpenCL support");
#endif
