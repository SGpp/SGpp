...
# described in @link pysgpp_datadriven.learner.solver.LinearSolver LinearSolver@endlink and function for serialization
# end deserialization.
#
...
class CGSolver(ConjugateGradients, LinearSolver):
    ...
    # # Returns the @link pysgpp_datadriven.learner.solver.CGSolver.CGSolver.max_threshold threshold@endlink parameter
    # @return the @link pysgpp_datadriven.learner.solver.CGSolver.CGSolver.max_threshold threshold@endlink parameter
    def getThreshold(self):
        return self.max_threshold
    
    
    # #Sets the @link pysgpp_datadriven.learner.solver.CGSolver.CGSolver.max_threshold threshold@endlink parameter
    #
    # @param threshold: float value of @link pysgpp_datadriven.learner.solver.CGSolver.CGSolver.max_threshold threshold@endlink parameter
