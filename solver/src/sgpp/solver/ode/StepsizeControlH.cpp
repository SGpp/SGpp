...
StepsizeControlH::StepsizeControlH(std::string odesolver, size_t imax, float_t timestepSize,
...
float_t StepsizeControlH::nextTimestep(float_t tmp_timestepsize, float_t tmp_timestepsize_old,
