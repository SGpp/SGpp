...
StepsizeControlH::StepsizeControlH(std::string odesolver, size_t imax,
                                   float_t timestepSize, float_t eps,
...
float_t StepsizeControlH::nextTimestep(float_t tmp_timestepsize,
