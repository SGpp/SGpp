...
double sin_1D(std::vector<double> coords) { return sin(coords[0]); }
...
double f_3D(std::vector<double> coords) {
  double res =
      exp(-coords[0] * coords[0]) * exp(-coords[1] * coords[1]) * exp(-coords[2] * coords[2]);
...
BOOST_AUTO_TEST_CASE(testQuadratureRule) {
  ...
  combigrid::CombiGrid<double>* grid = new combigrid::SerialCombiGrid<double>(dim, hasbdrypts);
  ...
  combigrid::AbstractQuadratureRule<double>* trapz =
      new combigrid::QuadratureRule<double>(level);

  combigrid::AbstractQuadratureRule<double>* gauss =
      new combigrid::QuadratureRule<double>(level);
  combigrid::AbstractQuadratureRule<double>* clenshaw =
      new combigrid::ClenshawCurtisQuadrature<double>(level);

  // initialize the different stretchings...
  combigrid::AbstractStretchingMaker* chebishev_stretching =
      new combigrid::CombiChebyshevStretching();
  combigrid::AbstractStretchingMaker* legendre_stretching =
      new combigrid::CombiLegendreStretching();
  combigrid::AbstractStretchingMaker* trapz_stretching =
  ...
  scheme = new combigrid::CombiTS_CT<double>(levels);
  grid->attachCombiScheme(scheme);
  grid->re_init();
  grid->createFullGrids();
  ...
  scheme = new combigrid::CombiArbitraryScheme<double>(levels_vector);
  grid->attachCombiScheme(scheme);
  grid->re_init();
  grid->createFullGrids();
  ...
  combigrid::FullGrid<double>* fgrid;
  ...
  trapz = new combigrid::QuadratureRule<double>(level);
  gauss = new combigrid::QuadratureRule<double>(level);
  clenshaw = new combigrid::ClenshawCurtisQuadrature<double>(level);
  combigrid::AbstractQuadratureRule<double>* basu = new combigrid::QuadratureRule<double>(10);

  grid = new combigrid::SerialCombiGrid<double>(dim, hasbdrypts);
  scheme = new combigrid::CombiTS_CT<double>(levels);
  ...
  trapz_stretching = new combigrid::CombiEquidistantStretching();
  grid->initializeActiveGridsDomain(min, max, trapz_stretching);
  ...
  chebishev_stretching = new combigrid::CombiChebyshevStretching();
  grid->initializeActiveGridsDomain(min, max, chebishev_stretching);
  ...
  legendre_stretching = new combigrid::CombiLegendreStretching();
  grid->initializeActiveGridsDomain(min, max, legendre_stretching);
  ...
  combigrid::AbstractStretchingMaker* basu_stretching = new combigrid::CombiBasuStretching();
