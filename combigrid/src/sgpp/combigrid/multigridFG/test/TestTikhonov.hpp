...
class TestTikhonov {
 public:
  ...
  static void test1() {
    ...
    GridDomain* domain = new GridDomain( 1 , levels , min , max ,
                                         (*stretchingMaker) );

    // make the Tikhonov computations
    FullGridD* fg = RunTikhonov::computeFGTikhonov( *domain , levels , 0.01 ,
                    "../../../datasets/regression/1DLine/X.txt" ,
                    "../../../datasets/regression/1DLine/Y.txt");
  ...
  static void test12() {
    ...
    AtanSpecialStretching(); //new UniformStretching();
    GridDomain* domain = new GridDomain( 1 , levels , min , max ,
                                         (*stretchingMaker) );

    // make the Tikhonov computations
    FullGridD* fg = RunTikhonov::computeFGTikhonov( *domain , levels , 3e-5 ,
                    "../../../datasets/regression/1DOption/X.txt" ,
                    "../../../datasets/regression/1DOption/Y.txt");
  ...
  static void test14() {
    ...
    AbstractStretchingMaker* stretchingMaker = new TanStretching(
      0.5); //new AtanSpecialStretching(); //new UniformStretching(); //new AtanSpecialStretching();
    GridDomain* domain = new GridDomain( 1 , levels , min , max ,
                                         (*stretchingMaker) );

    // make the Tikhonov computations
    FullGridD* fg = RunTikhonov::computeFGTikhonov( *domain , levels , 3e-5 ,
                    "../../../datasets/regression/1DOption_1Y/X.txt" ,
                    "../../../datasets/regression/1DOption_1Y/Y.txt");
  ...
  static void test2() {
    ...
    FullGridD* fg = RunTikhonov::computeFGTikhonov( *domain , levels , 0.001 ,
                    "../../../datasets/regression/2DPlane/X.txt" ,
                    "../../../datasets/regression/2DPlane/Y.txt");

    // test the unkowns
    COMBIGRID_ERROR_TEST_EQUAL( fg->getElementVector()[0] , 1.8 , 1e-2 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( fg->getElementVector()[fg->getElementVector().size()
                                - 1] , 2.2 , 1e-5 , "" );
  ...
  static void test21() {
    ...
    FullGridD* fg = RunTikhonov::computeFGTikhonov( *domain , levels , 2e-5 ,
                    "../../../datasets/regression/2DOption/X.txt" ,
                    "../../../datasets/regression/2DOption/Y.txt");
  ...
  static void test22() {
    ...
    // make the Tikhonov computations
    FullGridD* fg = RunTikhonov::computeFGTikhonov( *domain , levels , 2e-5 ,
                    "../../../datasets/regression/2DOption_1Y/X.txt" ,
                    "../../../datasets/regression/2DOption_1Y/Y.txt");
  ...
  static void test2_cross() {
    ...
    RunTikhonov::readInInput( "../../../datasets/regression/2DOption_1Y/X.txt" ,
                              "../../../datasets/regression/2DOption_1Y/Y.txt" ,
  ...
  static void test2_cross_CG() {
    ...
    AbstractStretchingMaker* stretchingMaker = new AtanSpecialStretching();
    GridDomain* domain = new GridDomain( 2 , maxlevels , min , max ,
                                         (*stretchingMaker) );
    ...
    // make the Tikhonov computations
    RunTikhonov::computeTikhonov_CG_crossvalidation( combigrid , lambda, XCoords,
        YPoint);
  ...
  static void test3() {
    ...
    //AbstractStretchingMaker* stretchingMaker = new UniformStretching();
    AbstractStretchingMaker* stretchingMaker = new AtanSpecialStretching();
    GridDomain* domain = new GridDomain( 3 , levels , min , max ,
                                         (*stretchingMaker) );

    // make the Tikhonov computations
    FullGridD* fg = RunTikhonov::computeFGTikhonov( *domain , levels , 0.0001 ,
                    "../../../datasets/regression/3DPlane/X.txt" ,
                    "../../../datasets/regression/3DPlane/Y.txt");
  ...
  static void test31() {
    ...
    FullGridD* fg = RunTikhonov::computeFGTikhonov( *domain , levels , 1e-5 ,
                    "../../../datasets/regression/3DOption/X.txt" ,
                    "../../../datasets/regression/3DOption/Y.txt");
