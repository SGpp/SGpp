...
class TestPoisson {
 public:
  ...
  static void test1() {
    ...
    FullGridD* fg = RunPoisson::computeFGPoisson( *domain , levels , sigma , 1.0 ,
                    rhs );
  ...
  static void test2() {
    ...
    AbstractStretchingMaker* stretchingMaker = new TanStretching(
      0.7); //new UniformStretching(); //new AtanSpecialStretching(); //new UniformStretching();
  ...
  static void test3() {
    ...
    AbstractStretchingMaker* stretchingMaker = new TanStretching(
      0.7); //new UniformStretching(); //new AtanSpecialStretching(); //new UniformStretching();
    GridDomain* domain = new GridDomain( 3 , levelsDom , min , max ,
                                         (*stretchingMaker) );
    ConstRHS* rhs = new ConstRHS(1.0);
  ...
  static void test4() {
    ...
    AbstractStretchingMaker* stretchingMaker = new TanStretching(
      0.7); //new UniformStretching(); //new AtanSpecialStretching(); //new UniformStretching();
    GridDomain* domain = new GridDomain( 4 , levelsDom , min , max ,
                                         (*stretchingMaker) );
    ConstRHS* rhs = new ConstRHS(1.0);
