...
class TestSGppConverter {
 public:
  ...
  static void test1() {
    ...
    coords[0] = 0.0;
    coords[1] = 0.0;
    COMBIGRID_ERROR_TEST_EQUAL( minMin , testfunction2D( coords[0] , coords[1] ) ,
                                1e-10 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( minA , testfunction2D( coords[0] , coords[1] ) ,
                                1e-10 , "" );
    coords[0] = 1.0;
    coords[1] = 1.0;
    COMBIGRID_ERROR_TEST_EQUAL( maxMax , testfunction2D( coords[0] , coords[1] ) ,
                                1e-10 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( maxA , testfunction2D( coords[0] , coords[1] ) ,
                                1e-10 , "" );
    ...
    coords[0] = 1.0 / 3.0;
    coords[1] = 1.0 / 3.0;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
                                testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
    coords[0] = 0.0001;
    coords[1] = 1.0 / 3.0;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
                                testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
  ...
  static void test2() {
    ...
    coords[1] = 0.0;
    coords[2] = 0.0;
    COMBIGRID_ERROR_TEST_EQUAL( minMin , testfunction3D1( coords[0] , coords[1] ,
                                coords[2]) , 1e-10 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( minA , testfunction3D1( coords[0] , coords[1] ,
                                coords[2]) , 1e-10 , "" );
    coords[0] = 1.0;
    coords[1] = 1.0;
    coords[2] = 1.0;
    COMBIGRID_ERROR_TEST_EQUAL( maxMax , testfunction3D1( coords[0] , coords[1] ,
                                coords[2]) , 1e-10 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( maxA , testfunction3D1( coords[0] , coords[1] ,
                                coords[2]) , 1e-10 , "" );
    ...
    coords[2] = 1.0 / 3.0;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
                                testfunction3D1( coords[0] , coords[1] , coords[2] ) , 1e-4 , "" );
    coords[0] = 0.0001;
    coords[1] = 1.0 / 3.0;
    coords[2] = 1.0 / 3.0;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
  ...
  static void test21() {
    ...
    coords[2] = 1.0 / 3.0;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
                                testfunction3D1( coords[0] , coords[1] , coords[2] ) , 1e-3 , "" );
    coords[0] = 0.0001;
    coords[1] = 1.0 / 3.0;
    coords[2] = 1.0 / 3.0;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
  ...
  static void test22() {
    ...
    coords[2] = 0.0001;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
                                testfunction3D1( coords[0] , coords[1] , coords[2] ) , 1e-2 , "" );
    coords[0] = 0.0;
    coords[1] = 0.0;
    coords[2] = 0.0;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
    ...
    coords[2] = 1.0;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
                                testfunction3D1( coords[0] , coords[1] , coords[2] ) , 3e-2 , "" );
    coords[0] = 0.999;
    coords[1] = 0.95;
    coords[2] = 0.95;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
