...
class TestSerialS_CTGrid {
 public:
  ...
  static void test1() {
    ...
    COMBIGRID_ERROR_TEST_EQUAL( combigrid1->eval(coords) ,
                                testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
    ...
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
                                testfunction2D( coords[0] , coords[1] ) , 1e-10 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( combigrid1->eval(coords) ,
                                testfunction2D( coords[0] , coords[1] ) , 1e-6 , "" );
  ...
  static void test12() {
    ...
    coords[1] = 1.0 / 3.0;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
                                testfunction2D1( coords[0] , coords[1] ) , 1e-5 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( combigrid1->eval(coords) ,
                                testfunction2D1( coords[0] , coords[1] ) , 1e-5 , "" );
  ...
  static void test2() {
    ...
    coords[2] = 1.0 / 3.0;
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
                                testfunction3D( coords[0] , coords[1] , coords[2] ) , 1e-10 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( combigrid1->eval(coords) ,
                                testfunction3D( coords[0] , coords[1] , coords[2] ) , 1e-10 , "" );
  ...
  static void test21() {
    ...
    COMBIGRID_ERROR_TEST_EQUAL( combigrid1->eval(coords) ,
                                testfunction3D1( coords[0] , coords[1] , coords[2] ) , 5e-4 , "" );
    ...
    COMBIGRID_ERROR_TEST_EQUAL( combigrid->eval(coords) ,
                                testfunction3D1( coords[0] , coords[1] , coords[2] ) , 1e-4 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( combigrid1->eval(coords) ,
                                testfunction3D1( coords[0] , coords[1] , coords[2] ) , 5e-3 , "" );
