...
class TestFullGrid {
 public:
  ...
  static void test1() {
    ...
    coords[0] = 1.0 / 3.0;
    coords[1] = 1.0 / 3.0;
    COMBIGRID_ERROR_TEST_EQUAL( fg->eval(coords) , testfunction2D( coords[0] ,
                                coords[1] ) , 1e-10 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( fg_wg->eval(coords) , testfunction2D( coords[0] ,
                                coords[1] ) , 1e-10 , "" );
  ...
  static void test2() {
    ...
    for (int i = 0 ; i < fg_wg->getNrElements() ; i++) {
      fg_wg->getCoords( i , coords );
      fg_wg->getElementVector()[i] = testfunction3D( coords[0] , coords[1] ,
                                     coords[2] );
    }
    ...
    coords[1] = 1.0 / 3.0;
    coords[2] = 1.0 / 3.0;
    COMBIGRID_ERROR_TEST_EQUAL( fg->eval(coords) , testfunction3D( coords[0] ,
                                coords[1] , coords[2] ) , 1e-10 , "" );
    COMBIGRID_ERROR_TEST_EQUAL( fg_wg->eval(coords) , testfunction3D( coords[0] ,
                                coords[1] , coords[2] ) , 1e-10 , "" );
