  ...
  switch (level) {
    case 1: {
      ...
      for (int d = 1; d < nr_pts - 1; d++) {
        ...
        jacobian->push_back(transformationJacobian(min, max, abscissas[d], type));
      }
    ...
    case 2: {
      int nr_pts = 5;
      double abscissas[5] = {-1.0, -0.77459666924148337704E+00, 0.0E+00, 0.77459666924148337704E+00,
                             1.0};
    ...
    default: {
      COMBIGRID_OUT_WRN("Grid level > 9 unsupported.\n", __FILE__, __LINE__)
