...
combigrid::GaussPattersonQuadrature<_Tp>::GaussPattersonQuadrature(int max_lvl) {
  if (max_lvl >= 1 && max_lvl <= 9) {
    MAX_LEVELS = max_lvl;
  } else {
    COMBIGRID_OUT_WRN(
        "\n"
...
#pragma omp parallel for schedule(dynamic, 1)
  ...
  for (int d = 1; d <= MAX_LEVELS; d++) {
     ...
     * */
    GaussPattersonQuadrature<_Tp>::calculateCoefficients(d, coefficients + d - 1);
  }
}
...
_Tp combigrid::GaussPattersonQuadrature<_Tp>::integrate(CombiGrid<_Tp>* grids,
  ...
  // all threads check if error has occured before continuing with the
  // computation...
  int error_flag = 0;
    ...
    for (int j = 0; j < nr_fullgrids; j++) {
      ...
      if (grids->getFullGrid(j)->isActive()) {
        if (grids->getFullGrid(j)->getMaxLevel() > MAX_LEVELS) {
          COMBIGRID_OUT_ERR(
              "GAUSS-PATTERSON QUADRATURE FAILED: Active full-grid "
              "has level greater than the currently "
              "supported MAX level. ABORTING",
              __FILE__, __LINE__);
          error_flag++;
        } else {
          result += (_Tp)grids->getCoef(j) *
                    gauss_patterson_fullGrid(dim, f, grids->getFullGrid(j), badstretching);
        }
      }
    }
  }
...
template <typename _Tp>
_Tp combigrid::GaussPattersonQuadrature<_Tp>::gauss_patterson_fullGrid(
...
template <typename _Tp>
void combigrid::GaussPattersonQuadrature<_Tp>::calculateCoefficients(int in_level,
                                                                     _Tp** out_coefs) {
  ...
  *out_coefs = reinterpret_cast<_Tp*>(malloc(N * sizeof(_Tp)));
  ...
  if (in_level == 1) {
    ...
    for (int d = 0; d < N; d++) (*out_coefs)[d] = (_Tp)tmp_coefs[d];
  }

  if (in_level == 2) {
    double tmp_coefs[5] = {0.0, 0.555555555555555555556E+00, 0.888888888888888888889E+00,
                           0.555555555555555555556E+00, 0.0};

    for (int d = 0; d < N; d++) (*out_coefs)[d] = (_Tp)tmp_coefs[d];
  }

  if (in_level == 3) {
    double tmp_coefs[9] = {0.0,
                           0.104656226026467265194E+00,
                           0.268488089868333440729E+00,
                           0.401397414775962222905E+00,
                           0.450916538658474142345E+00,
                           0.401397414775962222905E+00,
                           0.268488089868333440729E+00,
                           0.104656226026467265194E+00,
                           0.0};
  ...
  if (in_level == 5) {
    double tmp_coefs[33] = {0.0,
                            0.00254478079156187441540E+00,
                            0.00843456573932110624631E+00,
                            0.0164460498543878109338E+00,
                            0.0258075980961766535646E+00,
                            0.0359571033071293220968E+00,
                            0.0464628932617579865414E+00,
                            0.0569795094941233574122E+00,
                            0.0672077542959907035404E+00,
                            0.0768796204990035310427E+00,
                            0.0857559200499903511542E+00,
                            0.0936271099812644736167E+00,
                            0.100314278611795578771E+00,
                            0.105669893580234809744E+00,
                            0.109578421055924638237E+00,
                            0.111956873020953456880E+00,
                            0.112755256720768691607E+00,
                            0.111956873020953456880E+00,
                            0.109578421055924638237E+00,
                            0.105669893580234809744E+00,
                            0.100314278611795578771E+00,
  ...
  if (in_level == 6) {
    double tmp_coefs[65] = {0.0,
                            0.000363221481845530659694E+00,
                            0.00126515655623006801137E+00,
                            0.00257904979468568827243E+00,
                            0.00421763044155885483908E+00,
                            0.00611550682211724633968E+00,
                            0.00822300795723592966926E+00,
                            0.0104982469096213218983E+00,
                            0.0129038001003512656260E+00,
                            0.0154067504665594978021E+00,
