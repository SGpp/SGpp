...
class CombiSGppConverter {
 ...
 public:
  ...
  static void createSGpp( SGPP::base::GridStorage* storage ,
  ...
  static void FullGridToSGpp(const FullGridD* fg , double coef ,
                             SGPP::base::GridStorage* storage , SGPP::base::DataVector* alpha);
  ...
  static void SGppToFullGrid( SGPP::base::GridStorage* storage ,
                              SGPP::base::DataVector* alpha , FullGridD* fg );
