 ...
 */
class OperationWeightedQuadratureNakBsplineBoundary : public sgpp::base::OperationQuadrature {
 public:
  /**
   * Constructor of OperationWeightedQuadratureNakBsplineBoundary
   *
   * @param storage Pointer to the grid's GridStorage object
   * @param degree the B-spline degree
   */
  OperationWeightedQuadratureNakBsplineBoundary(sgpp::base::GridStorage& storage, size_t degree,
