...
class LTwoScalarProductHashMapNakBsplineBoundary {
 public:
  LTwoScalarProductHashMapNakBsplineBoundary() {
    degree = 3;
    grid = nullptr;
   ...
   */
  explicit LTwoScalarProductHashMapNakBsplineBoundary(sgpp::base::Grid* grid);
   ...
   * Destructor
   */
  virtual ~LTwoScalarProductHashMapNakBsplineBoundary();
