...
class LTwoScalarProductNakBsplineBoundaryCombigrid {
 public:
   ...
   */
  explicit LTwoScalarProductNakBsplineBoundaryCombigrid(sgpp::base::Grid* grid);
   ...
   * Destructor
   */
  virtual ~LTwoScalarProductNakBsplineBoundaryCombigrid();
