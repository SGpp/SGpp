...
class SerialCombiGrid : public AbstractCombiGrid {
 ...
 public:
  ...
  SerialCombiGrid(const CombiSchemeBasis* combischeme ,
                  const std::vector<bool>& hasBoundaryPts ) : AbstractCombiGrid( combischeme ,
                        hasBoundaryPts) {
    ;
  }
  ...
  /** see superclass for docu */
  virtual void reCompose(SGPP::base::GridStorage* gridstorageSGpp ,
                         SGPP::base::DataVector* alpha,
                         SGPP::base::DataVector* minAlpha = NULL ,
                         SGPP::base::DataVector* maxAlpha = NULL) const ;

  /** see superclass for docu */
  virtual void deCompose(SGPP::base::GridStorage* gridstorageSGpp ,
                         SGPP::base::DataVector* alpha) ;
};
}
